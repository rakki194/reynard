...
class AgentNameManager:
    ...
    def create_agent_with_ecs(
        ...
        try:
            ...
            spirit_str = spirit.value if hasattr(spirit, 'value') else str(spirit) if spirit else "fox"
            style_str = style.value if hasattr(style, 'value') else str(style) if style else "foundation"
    ...
    def roll_agent_spirit(self, weighted: bool = True) -> AnimalSpirit:
        ...
        if weighted:
            ...
            spirits = [
                AnimalSpirit.FOX, AnimalSpirit.FOX, AnimalSpirit.FOX, AnimalSpirit.FOX,
                AnimalSpirit.OTTER, AnimalSpirit.OTTER, AnimalSpirit.OTTER, AnimalSpirit.OTTER, AnimalSpirit.OTTER,
                AnimalSpirit.WOLF, AnimalSpirit.WOLF, AnimalSpirit.WOLF,
            ]
        else:
            # Equal distribution
