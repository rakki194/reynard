...
// Available themes
const themes = [
  "light", "dark", "gray", "banana", 
  "strawberry", "peanut", "high-contrast-black", "high-contrast-inverse"
];
...
<SearchFilters
  ...
  availableFilters={[
    { key: "type", label: "Type", type: "select", options: ["image", "text", "video"] },
...
const {
  ...
  isValid,
  error
} = useSetting("appearance.theme", "light");
...
*Complete API reference for all Reynard packages!* 🦊
