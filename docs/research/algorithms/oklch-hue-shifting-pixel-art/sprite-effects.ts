 ...
 */
export function applyColorFilter(sprite: PixelSprite, filter: (color: OKLCHColor) => OKLCHColor): PixelSprite {
  return {
    ...sprite,
 ...
 */
export function createTintedSprite(sprite: PixelSprite, tintColor: OKLCHColor, intensity: number = 0.5): PixelSprite {
  return applyColorFilter(sprite, color => ({
    l: color.l,
