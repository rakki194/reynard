        ...
        <div class="roguelike-page">
            <div class="page-header">
                ...
                <p class="page-description">
                    Experience a fully functional rogue-like dungeon crawler built with Reynard's ECS system.
                    Features procedural dungeon generation, AI enemies, and pixel-perfect rendering.
                </p>
            </div>
