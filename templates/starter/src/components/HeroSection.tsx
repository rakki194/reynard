...
export const HeroSection: Component = () => {
  ...
  const demos = [
    { icon: "dashboard", title: "Interactive Dashboard", description: "Real-time data visualization" },
    { icon: "chart", title: "Analytics", description: "Comprehensive metrics and insights" },
    { icon: "3d", title: "3D Visualization", description: "Immersive spatial experiences" },
    { icon: "flow", title: "Workflow Builder", description: "Visual process automation" }
  ];
      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <p class="hero-subtitle">
            A cunning SolidJS framework for modern web applications. 
            Built with modularity, performance, and developer experience in mind.
          </p>
