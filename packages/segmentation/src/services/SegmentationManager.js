 ...
 */
import { getServiceRegistry, ServiceError, } from "reynard-ai-shared";
...
export class SegmentationManager {
    constructor(serviceRegistry, annotationServiceRegistry) {
        ...
        Object.defineProperty(this, "annotationServiceRegistry", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "segmentationServices", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    async initialize() {
        ...
        try {
            ...
            throw new ServiceError(`Segmentation manager initialization failed: ${this.lastError}`, "MANAGER_INITIALIZATION_ERROR");
        }
    }
    /**
     ...
     */
    async registerSegmentationService(name, config) {
        await this.ensureInitialized();
     ...
     */
    async unregisterSegmentationService(name) {
        const service = this.segmentationServices.get(name);
        if (!service) {
 ...
 */
export async function initializeSegmentationManager() {
