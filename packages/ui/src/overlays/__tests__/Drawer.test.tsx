...
describe("Drawer", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should not render when closed", () => {
      render(() => <Drawer open={false}>{mockContent}</Drawer>);
    ...
    it("should render with title and footer", () => {
      render(() => (
        <Drawer open={true} title={mockTitle} footer={mockFooter}>
          {mockContent}
        </Drawer>
      ));
    ...
    it("should apply custom class name", () => {
      render(() => (
        <Drawer open={true} class="custom-drawer">
          {mockContent}
        </Drawer>
      ));
  ...
  describe("Positioning", () => {
    ...
    it("should render on the bottom when specified", () => {
      render(() => (
        <Drawer open={true} position="bottom">
          {mockContent}
        </Drawer>
      ));
  ...
  describe("Sizing", () => {
    ...
    it("should apply custom size when specified", () => {
      render(() => (
        <Drawer open={true} customSize="500px">
          {mockContent}
        </Drawer>
      ));
  ...
  describe("Close Button", () => {
    ...
    it("should hide close button when disabled", () => {
      render(() => (
        <Drawer open={true} showCloseButton={false}>
          {mockContent}
        </Drawer>
      ));
  ...
  describe("Accessibility", () => {
    it("should have proper ARIA attributes", () => {
      render(() => (
        <Drawer open={true} title={mockTitle}>
          {mockContent}
        </Drawer>
      ));
