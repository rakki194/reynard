 ...
 */
import { createMemo, createSignal, onMount, onCleanup, splitProps, Component, JSX } from "solid-js";
...
export interface IconProps extends Omit<JSX.ButtonHTMLAttributes<HTMLButtonElement>, "children" | "role"> {
  ...
  variant?: "filled" | "regular" | "outlined";
  class?: string;
...
export const Icon: Component<IconProps> = props => {
  ...
  return (
    <span
      class={iconClasses()}
      style={getGlowStyle()}
      {...(localProps.role && { role: localProps.role })}
      aria-label={getAriaLabel()}
