...
const TagInputControls: Component<{
  customTag: string;
  tagIntensity: number;
  onTagChange: (tag: string) => void;
  onIntensityChange: (intensity: number) => void;
  ...
  <div class="tag-inputs">
    <input
      ...
      onInput={e => props.onTagChange(e.target.value)}
      class="tag-input"
    />
...
const GeneratedTagsDisplay: Component<{
  availableThemes: string[];
  customTag: string;
  tagIntensity: number;
  generatedTagsRef: HTMLDivElement[];
    ...
    <div class="custom-tag-section">
      ...
      <div class="tag-generator">
        <TagInputControls
          ...
          tagIntensity={props.tagIntensity}
        ...
        <GeneratedTagsDisplay
          ...
          customTag={props.customTag}
          tagIntensity={props.tagIntensity}
          generatedTagsRef={generatedTagsRef}
        />
      </div>
    </div>
  );
