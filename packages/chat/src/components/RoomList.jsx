      ...
      <div class="reynard-room-list__items">
        <Show when={props.rooms.length > 0} fallback={<div class="reynard-room-list__empty">
          ...
          <For each={props.rooms}>
            {(room) => (<div class={`reynard-room-list__item ${props.activeRoom?.id === room.id
                ? "reynard-room-list__item--active"
                : ""}`} onClick={() => props.onRoomSelect?.(room)}>
                {/* Room Avatar/Icon */}
                <div class="reynard-room-list__item-avatar">
                  <Show when={room.type === "direct" && room.participants.length === 2} fallback={<span class="reynard-room-list__item-icon">
                ...
                room.participants.length === 2} fallback={room.name}>
