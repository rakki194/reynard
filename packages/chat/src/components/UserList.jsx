      ...
      <div class="reynard-user-list__items">
        <Show when={props.users.length > 0} fallback={<div class="reynard-user-list__empty">
          ...
          <For each={sortedUsers()}>
            {user => (<div class={`reynard-user-list__item ${user.id === props.currentUser.id ? "reynard-user-list__item--current" : ""} ${selectedUser() === user.id ? "reynard-user-list__item--selected" : ""}`} onClick={() => {
