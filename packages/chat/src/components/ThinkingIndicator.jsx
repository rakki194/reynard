...
export const ThinkingIndicator = props => {
    ...
    const renderAnimation = () => {
        switch (props.variant) {
            case "pulse":
                return (<div class="reynard-thinking-indicator__pulse">
            <div class="reynard-thinking-indicator__pulse-dot"></div>
          </div>);
            case "typing":
                return (<div class="reynard-thinking-indicator__typing">
            ...
            case "dots":
            default:
                return (<div class="reynard-thinking-indicator__dots">
            <span></span>
            <span></span>
            <span></span>
          </div>);
    ...
    return (<div class={getVariantClass()}>
      <div class="reynard-thinking-indicator__header">
        ...
        <Show when={props.content}>
          <button class="reynard-thinking-indicator__toggle" onClick={() => setIsExpanded(!isExpanded())} attr:aria-expanded={isExpanded() ? "true" : "false"} aria-label={isExpanded() ? "Hide thinking content" : "Show thinking content"}>
