...
export const MessageInput = (props) => {
    ...
    return (<div class={getClasses()}>
      <div class="reynard-message-input__container">
        ...
        <div class="reynard-message-input__input-wrapper">
          ...
          <div class="reynard-message-input__meta">
            {props.showCounter && getCharacterInfo() && (<div class={`reynard-message-input__counter ${getCharacterInfo().isNearLimit
        ...
        <div class="reynard-message-input__actions">
          {props.submitButton ? (<div class="reynard-message-input__custom-submit" onClick={handleSubmit}>
              {props.submitButton}
            </div>) : (<button type="button" class="reynard-message-input__submit" disabled={!value().trim() ||
                props.disabled ||
                props.isStreaming ||
                getCharacterInfo()?.isOverLimit ||
                false} onClick={handleSubmit} aria-label="Send message" title={props.isStreaming
                ? "Please wait..."
                : props.multiline
      ...
      <div class="reynard-message-input__help">
        {props.multiline ? (<span class="reynard-message-input__shortcut">
            Press Enter for new line, Ctrl+Enter to send
          </span>) : (<span class="reynard-message-input__shortcut">
            Press Enter to send
          </span>)}
      </div>
    </div>);
