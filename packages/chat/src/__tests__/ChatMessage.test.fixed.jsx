...
vi.mock("../components/MarkdownRenderer", () => ({
    MarkdownRenderer: (props) => <div data-testid="markdown-renderer">{props.content}</div>,
}));
vi.mock("../components/ThinkingIndicator", () => ({
    ThinkingIndicator: (props) => <div data-testid="thinking-indicator">{props.content}</div>,
}));
vi.mock("../components/ToolCallDisplay", () => ({
    ToolCallDisplay: (props) => <div data-testid="tool-call">{props.toolCall.name}</div>,
}));
