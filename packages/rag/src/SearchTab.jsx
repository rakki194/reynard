...
export function SearchTab(props) {
    ...
    return (<div class="search-tab-content">
      <Card variant="elevated" padding="lg">
        <SearchForm query={props.query} onQueryChange={props.onQueryChange} onSearch={props.onSearch} onKeyPress={props.onKeyPress} isSearching={props.isSearching} error={props.error}/>
