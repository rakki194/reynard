...
import { getIcon, formatTimestamp, getModalityIcon, getModalityColor, getScoreColor } from "../utils/searchHistoryUtils";
export const SearchHistoryItem = (props) => {
    return (<Card className="history-item">
      <div class="item-header">
        ...
        <div class="item-actions">
          <Button variant="ghost" size="sm" onClick={() => props.onSearchAgain(props.item.query, props.item.modality)} leftIcon={getIcon("search")}>
            Search Again
          </Button>

          <Button variant="ghost" size="sm" onClick={() => props.onRemoveItem(props.item.id)} leftIcon={getIcon("delete")}>
            Remove
          </Button>
        </div>
      </div>
