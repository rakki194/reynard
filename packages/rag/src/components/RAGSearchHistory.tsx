    ...
    <div class="rag-search-history">
      ...
      <Show when={props.showFilters}>
        <div class="history-filters">
          ...
          <Select
            ...
            onChange={(value) =>
              setSelectedModality(value as RAGModality | "all")
            }
            options={[
          ...
          <Select
            value={sortBy()}
            onChange={(value) =>
              setSortBy(value as "timestamp" | "resultCount" | "topScore")
            }
            options={[
                ...
                <div class="item-header">
                  ...
                  <div class="item-actions">
                    <Button
                      ...
                      size="small"
                      onClick={() =>
                        props.onSearchAgain(item.query, item.modality)
                      }
                      icon={getIcon("search")}
                    >
                      Search Again
      ...
      <div class="history-footer">
        <div class="history-stats">
          Showing {filteredHistory().length} of {props.searchHistory.length}{" "}
          items
        </div>

        <Show
          when={props.maxItems && props.searchHistory.length > props.maxItems}
        >
