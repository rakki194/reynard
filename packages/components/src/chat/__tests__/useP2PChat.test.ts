...
describe('useP2PChat', () => {
  ...
  it('should create a new room', async () => {
    ...
    await createRoot(async (dispose) => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('/api/chat/rooms', expect.objectContaining({
        method: 'POST',
        body: JSON.stringify({
          name: 'New Room',
          type: 'group',
  ...
  it('should send message to room', async () => {
    ...
    await createRoot(async (dispose) => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(`/api/chat/rooms/${mockRoom.id}/messages`, expect.objectContaining({
        method: 'POST',
  ...
  it('should handle file uploads', async () => {
    ...
    await createRoot(async (dispose) => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('/api/chat/upload', expect.objectContaining({
        method: 'POST'
      }));
