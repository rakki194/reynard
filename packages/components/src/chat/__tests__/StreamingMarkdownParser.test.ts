...
import { StreamingMarkdownParser, createStreamingMarkdownParser, parseMarkdown } from '../utils/StreamingMarkdownParser';
...
describe('StreamingMarkdownParser', () => {
  ...
  describe('Basic Markdown Parsing', () => {
    ...
    it('should parse tables correctly', () => {
      ...
      expect(result.nodes[0].children).toHaveLength(2); // Header row + data row
    });
  ...
  describe('Inline Formatting', () => {
    ...
    it('should render links correctly', () => {
      ...
      expect(result.html).toContain('<a href="https://example.com" target="_blank" rel="noopener noreferrer">Link text</a>');
    });
    ...
    it('should auto-link URLs', () => {
      ...
      expect(result.html).toContain('<a href="https://example.com" target="_blank" rel="noopener noreferrer">https://example.com</a>');
    });
  });
