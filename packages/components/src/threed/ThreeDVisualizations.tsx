...
export const ThreeDVisualizations: Component<ThreeDVisualizationsProps> = (
  props,
) => {
  return (
    <div class="visualizations-section">
      ...
      <Show when={props.selectedVisualization === "point-cloud"}>
        <div class="viz-card">
          ...
          <p>
            Explore 3D data points with real-time interaction and OKLCH color
            mapping.
          </p>
      ...
      <Show when={props.selectedVisualization === "clusters"}>
        <div class="viz-card">
          ...
          <p>
            Visualize data clusters with OKLCH color mapping and statistical
            information.
          </p>
          <div class="viz-container">
      ...
      <Show when={props.selectedVisualization === "embeddings"}>
        <div class="viz-card">
          ...
          <p>
            Explore embedding spaces with similarity-based color mapping and
