...
> = (props) => {
  ...
  const [serviceSummary, setServiceSummary] = createSignal<ServiceSummary>({
    totalServices: 0,
    runningServices: 0,
    healthyServices: 0,
    failedServices: 0,
  ...
  const [featureSummary, setFeatureSummary] = createSignal<FeatureSummary>({
    total: 0,
    available: 0,
    degraded: 0,
    unavailable: 0,
  ...
  const refreshFeatureData = async () => {
    ...
    const mockSummary: FeatureSummary = {
      total: 12,
      available: 10,
      degraded: 1,
      unavailable: 1,
