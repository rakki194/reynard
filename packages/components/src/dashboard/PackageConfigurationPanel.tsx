...
export const PackageConfigurationPanel: Component<PackageConfigurationPanelProps> = props => {
  ...
  const handleSaveGlobalSettings = async (config: any) => {
  ...
  return (
    <div class="reynard-package-configuration-panel">
        ...
        <Show
          ...
          fallback={
            <PackageList
              ...
              onRefresh={refreshConfigurationData}
            />
          }
        >
          <PackageSettingsForm
            package={selectedPackageData()!}
            onSave={handleSavePackageSettings}
