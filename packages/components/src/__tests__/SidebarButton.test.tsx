...
describe('SidebarButton Component', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render without label when not provided', () => {
      ...
      expect(container.querySelector('.reynard-sidebar-button__label')).toBeNull();
    });
  });
  ...
  describe('Layout Variants', () => {
    ...
    layouts.forEach((layout) => {
      it(`should apply ${layout} layout class`, () => {
        const { container } = render(() => <SidebarButton icon="home" label="Home" layout={layout} />);
        const containerDiv = container.querySelector('.reynard-sidebar-button');
  ...
  describe('State Management', () => {
    it('should apply active class when active is true', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" active />);
      const containerDiv = container.querySelector('.reynard-sidebar-button');
      expect(containerDiv).toHaveClass('reynard-sidebar-button--active');
    });

    it('should apply disabled class when disabled', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" disabled />);
      const containerDiv = container.querySelector('.reynard-sidebar-button');
    ...
    it('should apply loading class when loading', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" loading />);
      const containerDiv = container.querySelector('.reynard-sidebar-button');
  ...
  describe('Secondary Icon', () => {
    it('should render secondary icon when provided', () => {
      render(() => <SidebarButton icon="home" label="Home" secondaryIcon="chevron-right" />);
      expect(screen.getByTestId('icon-chevron-right')).toBeInTheDocument();
    });

    it('should apply secondary icon class', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" secondaryIcon="chevron-right" />);
      // The secondary icon is rendered as a regular Icon component without a specific wrapper class
      const secondaryIcon = container.querySelector('[data-testid="icon-chevron-right"]');
  ...
  describe('Secondary Actions', () => {
    it('should render secondary actions when provided', () => {
      const actions = [
        ...
        { icon: 'delete', onClick: vi.fn(), ariaLabel: 'Delete', tooltip: 'Delete' }
      ];
      
      render(() => <SidebarButton icon="home" label="Home" showSecondaryActions secondaryActions={actions} />);
    ...
    it('should handle secondary action clicks', () => {
      ...
      const actions = [
        { icon: 'edit', onClick: editAction, ariaLabel: 'Edit', tooltip: 'Edit' }
      ];
    ...
    it('should disable secondary actions when disabled', () => {
      const editAction = vi.fn();
      const actions = [
        { icon: 'edit', onClick: editAction, ariaLabel: 'Edit', tooltip: 'Edit', disabled: true }
      ];
  ...
  describe('Content Area', () => {
    ...
    it('should apply content class when content is shown', () => {
      ...
      const contentArea = container.querySelector('.reynard-sidebar-button__content');
  ...
  describe('Progress Bar', () => {
    it('should show progress bar when progress is provided', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" progress={50} />);
      const progressBar = container.querySelector('.reynard-sidebar-button__progress-bar');
    ...
    it('should set correct progress width', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" progress={75} />);
      const progressBar = container.querySelector('.reynard-sidebar-button__progress-bar');
  ...
  describe('Glow Effect', () => {
    it('should apply glow class when glow is true', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" glow />);
      const containerDiv = container.querySelector('.reynard-sidebar-button');
      expect(containerDiv).toHaveClass('reynard-sidebar-button--glow');
    });

    it('should set custom glow color', () => {
      const { container } = render(() => <SidebarButton icon="home" label="Home" glow glowColor="blue" />);
  ...
  describe('Click Events', () => {
    it('should handle main button click events', () => {
      ...
      render(() => <SidebarButton icon="home" label="Home" onClick={handleClick} />);
    ...
    it('should not trigger click when disabled', () => {
      const handleClick = vi.fn();
      render(() => <SidebarButton icon="home" label="Home" disabled onClick={handleClick} />);
  ...
  describe('Accessibility', () => {
    it('should set aria-label from aria-label prop', () => {
      render(() => <SidebarButton icon="home" label="Home" aria-label="Navigate to home" />);
    ...
    it('should set title attribute from tooltip prop', () => {
      render(() => <SidebarButton icon="home" label="Home" tooltip="Navigate to home" />);
