...
describe('BreadcrumbButton Component', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render with children when provided', () => {
      render(() => <BreadcrumbButton icon="folder">Documents</BreadcrumbButton>);
  ...
  describe('Button Variants', () => {
    ...
    variants.forEach((variant) => {
      it(`should apply ${variant} variant class`, () => {
        const { container } = render(() => <BreadcrumbButton icon="folder" variant={variant} />);
        const button = container.querySelector('button');
  ...
  describe('State Management', () => {
    it('should apply active class when active is true', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" active />);
      const button = container.querySelector('button');
      expect(button).toHaveClass('reynard-breadcrumb-button--active');
    });

    it('should apply disabled class when disabled', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" disabled />);
      const button = container.querySelector('button');
    ...
    it('should apply loading class when loading', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" loading />);
      const button = container.querySelector('button');
  ...
  describe('Progress Bar', () => {
    it('should show progress bar when progress is provided', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" progress={50} />);
      const progressBar = container.querySelector('.reynard-breadcrumb-button__progress-bar');
    ...
    it('should set correct progress width', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" progress={75} />);
      const progressBar = container.querySelector('.reynard-breadcrumb-button__progress-bar');
  ...
  describe('Glow Effect', () => {
    it('should apply glow class when glow is true', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" glow />);
      const button = container.querySelector('button');
      expect(button).toHaveClass('reynard-breadcrumb-button--glow');
    });

    it('should set custom glow color', () => {
      const { container } = render(() => <BreadcrumbButton icon="folder" glow glowColor="orange" />);
  ...
  describe('Click Events', () => {
    it('should handle click events', () => {
      ...
      render(() => <BreadcrumbButton icon="folder" onClick={handleClick}>Documents</BreadcrumbButton>);
    ...
    it('should not trigger click when disabled', () => {
      const handleClick = vi.fn();
      render(() => <BreadcrumbButton icon="folder" disabled onClick={handleClick}>Documents</BreadcrumbButton>);
  ...
  describe('Accessibility', () => {
    it('should set aria-label from aria-label prop', () => {
      render(() => <BreadcrumbButton icon="folder" aria-label="Navigate to Documents folder">Documents</BreadcrumbButton>);
...
describe('BreadcrumbActionButton Component', () => {
  ...
  describe('Action Types', () => {
    const actions = ['create', 'delete', 'edit', 'settings', 'refresh', 'upload', 'download', 'search', 'filter', 'sort'] as const;
  ...
  describe('Glow Effect', () => {
    it('should set custom glow color', () => {
      const { container } = render(() => <BreadcrumbActionButton action="create" glow glowColor="purple" />);
      const icon = container.querySelector('.reynard-icon');
  ...
  describe('Click Events', () => {
    it('should handle click events', () => {
      const handleClick = vi.fn();
      render(() => <BreadcrumbActionButton action="create" onClick={handleClick} />);
    ...
    it('should not trigger click when disabled', () => {
      const handleClick = vi.fn();
      render(() => <BreadcrumbActionButton action="create" disabled onClick={handleClick} />);
  ...
  describe('Accessibility', () => {
    it('should set aria-label from aria-label prop', () => {
      render(() => <BreadcrumbActionButton action="create" aria-label="Create new folder" />);
    ...
    it('should set tooltip from tooltip prop', () => {
      render(() => <BreadcrumbActionButton action="create" tooltip="Create new item" />);
