...
export const GoldenSpiralColors: Component = () => {
  ...
  const oklchToRgb = (oklch: OKLCHColor): string => {
    ...
    const lms3 = l_ - 0.0894841775 * a_ - 1.2914855480 * b_;
    ...
    const blue = -0.0041960863 * lms1_ - 0.7034186147 * lms2_ + 1.7076147010 * lms3_;
  ...
  return (
    <section class="golden-spiral-colors">
      <div class="spiral-header">
        ...
        <p>
          Infinite distinct colors using the golden angle (137.507°) with physics-based movement that follows the spiral pattern
        </p>
      </div>
