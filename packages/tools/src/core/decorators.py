...
def tool(
    ...
    def decorator(func: Callable) -> 'FunctionTool':
        ...
        func_description = description or (func.__doc__ or "").strip() or f"Execute {func_name}"
        func_tags = tags or []
...
def _convert_parameter_definitions(param_defs: Dict[str, Dict[str, Any]]) -> List[ToolParameter]:
    """
