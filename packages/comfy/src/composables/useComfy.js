...
export function useComfy() {
    ...
    // Queue workflow
    const queueWorkflow = async (workflow, clientId) => {
        try {
            setIsLoading(true);
            setError(null);
    ...
    // Get status
    const getStatus = async (promptId) => {
        try {
            setError(null);
    ...
    // Get image
    const getImage = async (filename, subfolder = "", type = "output") => {
        try {
            setError(null);
    ...
    // Text to image
    const textToImage = async (params) => {
        try {
            setIsLoading(true);
            setError(null);
    ...
    // Ingest image
    const ingestImage = async (file, promptId, workflow, metadata = {}) => {
        try {
            setIsLoading(true);
            setError(null);
    ...
    // Stream status
    const streamStatus = (promptId, onEvent) => {
        try {
            setError(null);
    ...
    const validateSampler = async (sampler) => {
        try {
            setError(null);
    ...
    const validateScheduler = async (scheduler) => {
        try {
            setError(null);
    ...
    const clearQueueItem = async (promptId) => {
        try {
            setIsLoading(true);
            setError(null);
    ...
    const moveQueueItem = async (promptId, position) => {
        try {
            setIsLoading(true);
            setError(null);
