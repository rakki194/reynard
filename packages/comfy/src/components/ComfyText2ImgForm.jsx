    ...
    return (<form onSubmit={handleSubmit} class={`comfy-text2img-form ${props.class || ""}`}>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input id="seed" type="number" value={formData().seed || ""} onInput={(e) => handleInputChange("seed", e.currentTarget.value
            ? parseInt(e.currentTarget.value)
            : undefined)} min="0" disabled={props.disabled || isGenerating()}/>
        </div>
