...
export const ComfyHealthStatus = props => {
    ...
    return (<div class={`comfy-health-status ${props.class || ""}`}>
      ...
      <div class="health-content">
        {comfy.health() ? (<div class="status-info">
      ...
      <div class="health-actions">
        <button onClick={() => {
            setLastChecked(new Date());
        }} disabled={comfy.isLoading()} class="btn btn-sm btn-secondary">
