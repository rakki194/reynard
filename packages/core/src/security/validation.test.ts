...
describe('HTML Sanitization', () => {
  describe('sanitizeHTML', () => {
    ...
    it('should remove object and embed tags', () => {
      const input = '<object data="malicious.swf"></object><embed src="malicious.swf"></embed>Hello';
      const result = sanitizeHTML(input);
      expect(result).toBe('Hello');
    });

    it('should remove form elements', () => {
      const input = '<form><input type="text"><button>Click</button></form>Hello';
      const result = sanitizeHTML(input);
      expect(result).toBe('Hello');
    });
...
describe('Comprehensive Input Validation', () => {
  describe('validateInput', () => {
    ...
    it('should detect HTML violations', () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('Input contains potentially dangerous HTML');
    });
