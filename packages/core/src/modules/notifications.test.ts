...
describe('Notifications Module', () => {
  ...
  describe('createNotificationsModule', () => {
    ...
    it('should replace grouped notifications', () => {
      ...
      notificationsModule.notify('First message', 'info', { group: 'test-group' });
      notificationsModule.notify('Second message', 'info', { group: 'test-group' });
      
      expect(notificationsModule.notifications).toHaveLength(1);
      expect(notificationsModule.notifications[0].message).toBe('Second message');
    });
    ...
    it('should clear notifications by group', () => {
      ...
      notificationsModule.notify('Group A message', 'info', { group: 'group-a' });
      notificationsModule.notify('Group B message', 'info', { group: 'group-b' });
    ...
    it('should update notification progress', () => {
      ...
      const id = notificationsModule.notify('Upload progress', 'info', { progress: 50 });
