...
export const createI18nModule = (initialTranslations: Translations = {}): I18nModule => {
  const [locale, setLocaleSignal] = createSignal<Locale>(getInitialLocale());
  const [translations, setTranslationsSignal] = createSignal<Translations>(initialTranslations);
