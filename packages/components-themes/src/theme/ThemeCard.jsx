...
const ThemePreview = () => (<div class="theme-preview">
...
const ThemeInfo = props => (<div class="theme-info">
...
export const ThemeCard = props => {
    ...
    return (<div id={cardElementId} class={`theme-card ${props.isActive ? "active" : ""} ${props.isPreviewing ? "previewing" : ""}`} onClick={() => props.onThemeChange(props.themeConfig.name)} onMouseEnter={() => props.onPreviewTheme(props.themeConfig.name)} onMouseLeave={() => props.onStopPreview()}>
      <ThemePreview />
