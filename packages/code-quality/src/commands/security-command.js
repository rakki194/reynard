...
export async function handleSecurityCommand(options) {
    try {
        ...
        const hasCriticalIssues = securityResult.summary.criticalVulnerabilities > 0 || securityResult.summary.highVulnerabilities > 0;
