...
export class BehavioralAnalysisEngine extends EventEmitter {
    constructor(projectRoot, gitHistoryLimit = 100) {
        super();
        ...
        Object.defineProperty(this, "gitHistoryLimit", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    async analyzeBehavior(timeRange) {
        try {
     ...
     */
    calculateFileComplexity(file, lines) {
     ...
     */
    calculateRiskLevel(changeFrequency, complexity, contributors) {
     ...
     */
    calculateTechnicalDebt(changeFrequency, complexity) {
     ...
     */
    generateHotspotRecommendations(changeFrequency, complexity, riskLevel) {
     ...
     */
    async generateInsights(hotspots, commits) {
        const insights = [];
        // Hotspot insights
        ...
        if (criticalHotspots.length > 0) {
            insights.push({
                ...
                evidence: criticalHotspots.map(h => `${h.file}: ${h.changeFrequency.toFixed(2)} changes/commit, complexity ${h.complexity.toFixed(1)}`),
                recommendations: [
     ...
     */
    getFrequentContributors(commits) {
     ...
     * 🦊 Assess technical debt
     */
    assessTechnicalDebt(hotspots, _commits) {
 ...
 */
export function createBehavioralAnalysisEngine(projectRoot, gitHistoryLimit) {
