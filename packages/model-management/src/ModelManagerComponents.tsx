...
export const HealthOverview: Component<{
    ...
    <div class="health-overview">
      <div class="health-status">
        ...
        >
          ...
          <span class="status-text">{props.systemHealth?.isHealthy ? "System Healthy" : "System Issues"}</span>
        </div>
      </div>
  ...
  >
    ...
    <Show when={props.model.usageStats}>
      <div class="model-stats">
        ...
        <div class="stat">
          ...
          <span class="stat-value">{props.model.usageStats?.averageProcessingTime?.toFixed(2) || 0}s</span>
        </div>
      </div>
    </Show>
    ...
    <div class="model-actions">
      ...
      <Show when={props.model.isLoaded && !props.model.isLoading}>
        <button
          type="button"
          class="action-button action-button--unload"
          onClick={() => props.onUnload(props.model.name)}
        >
          Unload Model
        </button>
      </Show>
...
export const ModelsGrid: Component<{
  models: ModelInfo[];
  onLoad: (modelName: string) => void;
  onUnload: (modelName: string) => void;
}> = props => (
