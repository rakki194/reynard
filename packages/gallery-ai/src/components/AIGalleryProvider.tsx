...
export const AIGalleryProvider: ParentComponent<AIGalleryProviderProps> = (props) => {
  ...
  const aiGallery = useGalleryAI({
    get initialConfig() { return props.initialConfig; },
    get callbacks() { return props.callbacks; },
    get persistState() { return props.persistState ?? true; },
    get storageKey() { return props.storageKey ?? 'reynard-gallery-ai'; }
  });
