...
export const BatchProcessingDialog = (props) => {
    ...
    const handleStartProcessing = async () => {
        if (!selectedGenerator() || isProcessing())
            return;
            ...
            <Show when={!isProcessing() && !showResults()}>
              <div class="batch-processing-dialog__config">
                ...
                <div class="batch-processing-dialog__generator-selector">
                  ...
                  <select value={selectedGenerator()} onChange={(e) => setSelectedGenerator(e.currentTarget.value)} class="batch-processing-dialog__select" title="Select caption generator for batch processing">
                ...
                <div class="batch-processing-dialog__actions">
                  <Button variant="primary" onClick={handleStartProcessing} disabled={!selectedGenerator()} class="batch-processing-dialog__start-btn">
                    Start Processing
                  </Button>
                ...
                <Show when={progress()}>
                  <div class="batch-processing-dialog__progress">
                    <div class="batch-processing-dialog__progress-bar">
                      <div class="batch-processing-dialog__progress-fill" 
                  ...
                  <div class="batch-processing-dialog__failures">
                    ...
                    <div class="batch-processing-dialog__failures-list">
                      <For each={results().filter((result) => !result.success)}>
                        {(result) => (<div class="batch-processing-dialog__failure-item">
