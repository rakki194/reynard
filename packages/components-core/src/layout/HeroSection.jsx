        ...
        <div class="hero-text">
          <h1 class="hero-title">
            <span class="hero-logo">
              {fluentIconsPackage.getIcon("fox") && (<div 
        ...
        innerHTML={fluentIconsPackage.getIcon("fox")?.outerHTML}/>)}
          ...
          <div class="hero-actions">
            <button class="button button--primary" onClick={handleGetStarted}>
              {fluentIconsPackage.getIcon("rocket") && (<span 
        // eslint-disable-next-line solid/no-innerhtml
        innerHTML={fluentIconsPackage.getIcon("rocket")?.outerHTML}/>)}
              Get Started
            </button>
            <button class="button button--secondary">
              {fluentIconsPackage.getIcon("open") && (<span 
        // eslint-disable-next-line solid/no-innerhtml
        ...
        <div class="hero-demo">
          <div class="demo-preview">
            ...
            <div class="demo-content">
              <div class="demo-icon">
                {fluentIconsPackage.getIcon(demos[currentDemo()].icon) && (<div 
        // eslint-disable-next-line solid/no-innerhtml
      ...
      <div class="hero-themes">
        ...
        <div class="theme-preview-grid">
          <For each={availableThemes}>
            {themeConfig => (<button class={`theme-preview ${isActiveTheme(themeConfig.name) ? "active" : ""}`} onClick={() => handleThemePreview(themeConfig.name)} title={`Switch to ${themeConfig.displayName}`}>
