...
export const Button = (props) => {
    ...
    return (<button class={getButtonClasses()} disabled={local.disabled || local.loading} {...others}>
      {local.leftIcon && (<span class="reynard-button__icon reynard-button__icon--left">
          {local.leftIcon}
        </span>)}
      ...
      {local.rightIcon && (<span class="reynard-button__icon reynard-button__icon--right">
          {local.rightIcon}
        </span>)}
    </button>);
};
