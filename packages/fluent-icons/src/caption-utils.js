 ...
 */
export function generateCaption(metadata) {
 ...
 */
export function searchIconsByCaption(icons, query) {
 ...
 */
export function getAllCaptions(icons) {
    const captions = {};
    for (const [name, iconData] of Object.entries(icons)) {
        captions[name] =
 ...
 */
export function validateCaption(metadata) {
    if (!metadata.caption) {
        return false;
    }
 ...
 */
export function suggestCaptionImprovements(metadata) {
    const suggestions = [];
    if (!metadata.caption) {
 ...
 */
export function generateMissingCaptions(icons) {
    const generated = {};
    for (const [name, iconData] of Object.entries(icons)) {
 ...
 */
export function exportCaptions(icons, format = "json") {
