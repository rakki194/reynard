  ...
  return (
    <div class={`reynard-room-list ${props.compact ? "reynard-room-list--compact" : ""}`}>
      ...
      <div class="reynard-room-list__header">
        ...
        <button
          class="reynard-room-list__create-button"
      ...
      <Show when={showCreateForm()}>
        <div class="reynard-room-list__create-form">
          ...
          <div class="reynard-room-list__create-actions">
            <button
              class="reynard-room-list__create-confirm"
            ...
            <button
              class="reynard-room-list__create-cancel"
              onClick={() => {
                setShowCreateForm(false);
                setNewRoomName("");
              }}
      ...
      <div class="reynard-room-list__items">
        <Show
          ...
          fallback={
            <div class="reynard-room-list__empty">
        ...
        >
          <For each={props.rooms}>
            {room => (
              <div
                class={`reynard-room-list__item ${props.activeRoom?.id === room.id ? "reynard-room-list__item--active" : ""}`}
