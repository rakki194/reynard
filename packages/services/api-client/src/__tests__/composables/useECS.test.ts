...
describe("useECS", () => {
  ...
  describe("getAgents", () => {
    it("should get all agents", async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(global.fetch).toHaveBeenCalledWith("http://localhost:8000/agents");
    });
  });
  ...
  describe("getAgentPosition", () => {
    it("should get agent position", async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(global.fetch).toHaveBeenCalledWith(`http://localhost:8000/agents/${agentId}/position`);
    });
  });
  ...
  describe("getNearbyAgents", () => {
    it("should get nearby agents within radius", async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(global.fetch).toHaveBeenCalledWith(`http://localhost:8000/agents/${agentId}/nearby?radius=${radius}`);
    });
    ...
    it("should use default radius when not specified", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(`http://localhost:8000/agents/${agentId}/nearby?radius=100`);
    });
  });
