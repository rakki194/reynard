...
import type { HTTPValidationError, MCPToolCall, MCPToolResponse } from "../models/index";
import {
...
export class McpToolsApi extends runtime.BaseAPI implements McpToolsApiInterface {
   ...
   * Call Mcp Tool
   */
  async callMcpToolApiMcpToolsCallPostRaw(
    requestParameters: CallMcpToolApiMcpToolsCallPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MCPToolResponse>> {
   ...
   * Call Mcp Tool
   */
  async callMcpToolApiMcpToolsCallPost(
    requestParameters: CallMcpToolApiMcpToolsCallPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<MCPToolResponse> {
   ...
   * Mcp Health Check
   */
  async mcpHealthCheckApiMcpToolsHealthGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    const queryParameters: any = {};
   ...
   * Mcp Health Check
   */
  async mcpHealthCheckApiMcpToolsHealthGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
