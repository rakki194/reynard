...
import type { HTTPValidationError, SecureChatRequest } from "../models/index";
import {
...
export class SecureOllamaApi extends runtime.BaseAPI implements SecureOllamaApiInterface {
   ...
   * Secure Chat
   */
  async secureChatApiSecureOllamaChatPostRaw(
    requestParameters: SecureChatApiSecureOllamaChatPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
   ...
   * Secure Chat
   */
  async secureChatApiSecureOllamaChatPost(
    requestParameters: SecureChatApiSecureOllamaChatPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Secure Get Config
   */
  async secureGetConfigApiSecureOllamaConfigGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    const queryParameters: any = {};
   ...
   * Secure Get Config
   */
  async secureGetConfigApiSecureOllamaConfigGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Secure Get Models
   */
  async secureGetModelsApiSecureOllamaModelsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    const queryParameters: any = {};
   ...
   * Secure Get Models
   */
  async secureGetModelsApiSecureOllamaModelsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
