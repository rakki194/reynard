...
import { createUpdateItemFunction, createFileUploadActions } from './useFileUploadHelpers';
...
export function useFileUpload(props: FileUploadProps) {
  ...
  const actions = createFileUploadActions(fileOps, uploadOps, state, updateItem, props);
