        ...
        <div class="gallery-item__thumbnail">
          <img
            ...
            onError={(e) => {
              ...
              const iconEl = target.nextElementSibling;
  ...
  const renderMetadata = (item) => {
    ...
    return (
      <div class="gallery-item__metadata">
        ...
        <Show when={item.type !== "folder" && item.metadata?.duration}>
          <span class="gallery-item__duration">{item.metadata?.duration}s</span>
        </Show>
      </div>
    );
  };
