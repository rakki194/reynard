...
export declare const DEFAULT_VIEW_CONFIG: ViewConfiguration;
export declare const DEFAULT_SORT_CONFIG: SortConfiguration;
export declare const DEFAULT_FILTER_CONFIG: FilterConfiguration;
export declare const DEFAULT_UPLOAD_CONFIG: UploadConfiguration;
export declare const DEFAULT_SELECTION_STATE: SelectionState;
export declare const DEFAULT_GALLERY_THEME: GalleryTheme;
