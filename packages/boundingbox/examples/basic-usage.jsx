...
export function BasicUsageExample() {
    ...
    const [initialBoxes] = createSignal([
        {
            id: "example-box-1",
            label: "person",
            x: 100,
    ...
    const eventHandlers = {
        onAnnotationCreate: (annotation) => {
            ...
            if ("x" in annotation &&
                ...
                console.log("Created bounding box:", annotation);
                // Here you would typically save to your backend
            }
        },
        onAnnotationUpdate: (id, annotation) => {
            ...
            if ("x" in annotation &&
                ...
                "width" in annotation &&
                "height" in annotation) {
                console.log("Updated bounding box:", id, annotation);
    ...
    return (<div class="example-container">
      ...
      <BoundingBoxEditor imageInfo={imageInfo} initialBoxes={initialBoxes()} config={{
            enableCreation: true,
            enableEditing: true,
            enableDeletion: true,
        ...
        }} eventHandlers={eventHandlers} containerWidth={800} containerHeight={600} className="example-editor"/>
