/**
 * i18n Tests for boundingbox Package
...
describe("boundingbox i18n Tests", () => {
  it("should pass all i18n validation checks", async () => {
    const config = getPackageI18nConfig("boundingbox");
  ...
  it("should have proper translation namespaces", () => {
    ...
    if (config?.enabled) {
      ...
      expect(config.namespaces).toContain("boundingbox");
