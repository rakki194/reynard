 ...
 * ```
 */
export function applyResizeConstraints(dimensions, constraints) {
 ...
 */
export function calculateAspectRatio(dimensions) {
 ...
 */
export function validateResizeConstraints(dimensions, constraints) {
    if (constraints.minWidth !== undefined &&
