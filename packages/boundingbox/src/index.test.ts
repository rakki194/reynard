...
describe('@reynard/boundingbox', () => {
  ...
  describe('useBoundingBoxes', () => {
    ...
    it('should update a bounding box', () => {
      ...
      const success = updateBox(mockBoundingBox.id, { width: 300, height: 200 });
    ...
    it('should delete a bounding box', () => {
      const { addBox, deleteBox, boxes, boxCount } = useBoundingBoxes({
        imageInfo: mockImageInfo
      });
      ...
      const success = deleteBox(mockBoundingBox.id);
