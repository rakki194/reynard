...
export const LabelSelector = props => {
    ...
    return (<div class={`label-selector ${props.className || ""}`}>
      <select id="label-selector" value={props.selectedLabel} onChange={e => handleLabelSelect(e.currentTarget.value)} aria-label="Select label class for new bounding boxes">
        ...
        <div class="add-label-section">
          ...
          <Show when={showAddForm()}>
            <div class="add-label-form">
              <input type="text" value={newLabel()} onInput={e => setNewLabel(e.currentTarget.value)} placeholder="Enter new label" class="label-input"/>
