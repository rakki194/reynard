 ...
 */
export type { BaseAnnotation, BoundingBox, PolygonAnnotation, Annotation, ImageInfo, DisplayCoordinates, ImageCoordinates, TransformConstraints, ResizeHandle, ResizeHandlePosition, EditingState, AnnotationEventHandlers, EditorConfig, CanvasConfig, AnnotationExportFormat, ExportConfig, } from "./types";
...
export { useBoundingBoxes, type UseBoundingBoxesOptions, type UseBoundingBoxesReturn, } from "./composables/useBoundingBoxes";
export { useBoxResize, type ResizeState, type ResizeOptions, type UseBoxResizeReturn, } from "./composables/useBoxResize";
export { useBoxMove, type MoveConstraints, type MoveState, type MoveOptions, type UseBoxMoveReturn, } from "./composables/useBoxMove";
