 ...
 */
export function validateBoundingBox(box, imageInfo) {
    const errors = [];
 ...
 */
export function validatePolygonAnnotation(polygon, imageInfo) {
    const errors = [];
    // Check required fields
 ...
 */
export function validateTransformConstraints(constraints) {
    const errors = [];
 ...
 */
export function checkBoundingBoxConstraints(box, constraints) {
    const violations = [];
 ...
 */
export function calculateBoundingBoxArea(box) {
 ...
 */
export function calculateBoundingBoxIoU(box1, box2) {
