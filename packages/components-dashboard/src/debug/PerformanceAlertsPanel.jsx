...
export const PerformanceAlertsPanel = props => {
    ...
    const updateAlerts = async () => {
        ...
        try {
            ...
            const newAlerts = props.warnings.map(warning => ({
                ...warning,
                acknowledged: false,
                resolved: false,
    ...
    const getAlertRecommendation = (type, severity) => {
    ...
    return (<div class="performance-alerts-panel">
      {/* Header */}
    ...
    innerHTML={fluentIconsPackage.getIcon("warning")?.outerHTML || ""}/>
      ...
      <div class="alert-filters">
        <div class="filter-group">
          ...
          <select value={selectedSeverity()} onChange={e => setSelectedSeverity(e.currentTarget.value)} title="Filter by severity">
        ...
        <div class="filter-group">
          <label>Status:</label>
          <select value={selectedStatus()} onChange={e => setSelectedStatus(e.currentTarget.value)} title="Filter by status">
      ...
      <div class="alerts-list">
        <For each={getFilteredAlerts()}>
          {alert => (<div class={`alert-item ${getSeverityColor(alert.severity)}`}>
