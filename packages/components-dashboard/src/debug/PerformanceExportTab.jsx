...
export const PerformanceExportTab = props => {
    ...
    const [lastExport, setLastExport] = createSignal(null);
    onMount(() => {
        updateExportSummary();
    });
    ...
    const generateCSV = (data) => {
        ...
        if (data.performanceHistory) {
            data.performanceHistory.forEach((entry) => {
                lines.push([
...
<body>
    ...
    return (<div class="performance-export-panel">
      {/* Header */}
      ...
      <div class="export-options">
        ...
        <div class="options-grid">
          <div class="option-group">
            <label>Format:</label>
            <Select value={exportOptions().format} onChange={value => setExportOptions(prev => ({ ...prev, format: value }))} options={formats}/>
          </div>

          <div class="option-group">
            <label>Time Range:</label>
            <Select value={exportOptions().timeRange} onChange={value => setExportOptions(prev => ({
            ...prev,
            timeRange: value,
        }))} options={timeRanges}/>
          </div>
          ...
          <div class="option-group">
            ...
            <TextField value={exportOptions().filename} onInput={e => setExportOptions(prev => ({
            ...prev,
        ...
        <div class="include-options">
          ...
          <div class="checkbox-group">
            <label>
              <Toggle checked={exportOptions().includeSummary} onChange={checked => setExportOptions(prev => ({
            ...prev,
            ...
            <label>
              <Toggle checked={exportOptions().includeHistory} onChange={checked => setExportOptions(prev => ({
            ...prev,
            ...
            <label>
              <Toggle checked={exportOptions().includeWarnings} onChange={checked => setExportOptions(prev => ({
            ...prev,
