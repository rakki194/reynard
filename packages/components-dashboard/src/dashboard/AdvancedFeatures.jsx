...
export const AdvancedFeatures = () => {
    ...
    return (<div class="dashboard-card">
      <div class="card-header">
        <h3>
          {fluentIconsPackage.getIcon("settings") && (<span class="card-icon">
              <div 
      ...
      <div class="card-content">
        <button class="button button--secondary" onClick={handleAdvancedToggle}>
          {fluentIconsPackage.getIcon(showAdvanced() ? "eye-off" : "eye") && (<span 
        // eslint-disable-next-line solid/no-innerhtml
        innerHTML={fluentIconsPackage.getIcon(showAdvanced() ? "eye-off" : "eye")
                ?.outerHTML}/>)}
          {showAdvanced() ? "Hide" : "Show"} Advanced
        </button>
        {showAdvanced() && (<div class="advanced-features">
