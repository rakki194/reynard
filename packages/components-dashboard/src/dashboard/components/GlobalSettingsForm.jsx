...
export const GlobalSettingsForm = props => {
    ...
    return (<div class="reynard-global-settings-form">
      ...
      <div class="reynard-global-settings-form__content">
        <div class="reynard-settings-section">
          ...
          <div class="reynard-setting-field">
            ...
            <Toggle checked={props.config.autoDiscovery} onChange={checked => handleConfigChange("autoDiscovery", checked)}/>
          ...
          <div class="reynard-setting-field">
            ...
            <Toggle checked={props.config.autoInstall} onChange={checked => handleConfigChange("autoInstall", checked)}/>
        ...
        <div class="reynard-settings-section">
          ...
          <div class="reynard-setting-field">
            ...
            <TextField type="number" value={props.config.maxConcurrentInstalls} onInput={e => handleConfigChange("maxConcurrentInstalls", Number(e.currentTarget.value))} min="1" max="10" size="sm"/>
            <div class="reynard-setting-field__description">
          ...
          <div class="reynard-setting-field">
            ...
            <TextField type="number" value={props.config.memoryLimit} onInput={e => handleConfigChange("memoryLimit", Number(e.currentTarget.value))} min="512" max="8192" step="256" size="sm"/>
        ...
        <div class="reynard-settings-section">
          ...
          <div class="reynard-setting-field">
            ...
            <Toggle checked={props.config.enableAnalytics} onChange={checked => handleConfigChange("enableAnalytics", checked)}/>
          ...
          <div class="reynard-setting-field">
            ...
            <Select value={props.config.logLevel} onChange={value => handleConfigChange("logLevel", value)} options={[
