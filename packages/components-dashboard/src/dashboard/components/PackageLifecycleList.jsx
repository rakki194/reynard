...
export const PackageLifecycleList = props => {
    ...
    return (<div class="reynard-package-lifecycle-list">
      <div class="reynard-package-lifecycle-list__header">
        ...
        <div class="reynard-package-lifecycle-list__controls">
          ...
          <Select value={props.selectedStatus} onChange={e => props.onStatusChange(e.target.value)} options={[
      ...
      <div class="reynard-package-lifecycle-list__content">
        <Show when={filteredPackages().length > 0} fallback={<div class="reynard-package-lifecycle-list__empty">
              <Icon name="package" size="lg" variant="muted"/>
              <p>No packages found</p>
            </div>}>
          <For each={filteredPackages()}>
            {pkg => (<div class="reynard-package-lifecycle-item">
                <div class="reynard-package-lifecycle-item__header">
                  ...
                  <div class="reynard-package-lifecycle-item__actions">
                    ...
                    <Show when={pkg.status === "loaded"}>
                      <Button variant="secondary" size="sm" onClick={() => props.onUnloadPackage(pkg.name)} leftIcon="stop">
                        Unload
                      </Button>
                      <Button variant="secondary" size="sm" onClick={() => props.onReloadPackage(pkg.name)} leftIcon="refresh">
                        Reload
                      </Button>
                    </Show>
                  </div>
