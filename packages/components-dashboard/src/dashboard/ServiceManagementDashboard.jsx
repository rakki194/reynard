...
export const ServiceManagementDashboard = props => {
    ...
    const tabs = [
        ...
        },
        {
            id: "services",
            label: "Services",
            content: (<div class="services-tab">
          <ServiceStatusPanel showDetails={true} showActions={true} showProgress={true} showDependencies={true} showMetrics={true} refreshInterval={props.refreshInterval}/>
        </div>),
        },
        {
            id: "features",
            label: "Features",
            content: (<div class="features-tab">
