...
export const FeatureAvailabilityPanel = (props) => {
    const [selectedCategory, setSelectedCategory] = createSignal(null);
    const [selectedPriority, setSelectedPriority] = createSignal(null);
    // Mock feature data
    ...
    return (<div class="feature-availability-panel">
      {/* Header */}
    ...
    innerHTML={fluentIconsPackage.getIcon("layers")?.outerHTML || ""}/>
      ...
      <div class="feature-filters">
        <Show when={props.showCategories}>
          <div class="filter-group">
            ...
            <select value={selectedCategory() || ""} onChange={(e) => setSelectedCategory(e.currentTarget.value || null)} aria-label="Filter by category">
        ...
        <Show when={props.showPriorities}>
          <div class="filter-group">
            ...
            <select value={selectedPriority() || ""} onChange={(e) => setSelectedPriority(e.currentTarget.value || null)} aria-label="Filter by priority">
      ...
      <div class="features-list">
        <For each={filteredFeatures()}>
          {(feature) => (<div class="feature-item">
              <div class="feature-header">
                <div class="feature-info">
                  <span class="icon">
                    <div 
        // eslint-disable-next-line solid/no-innerhtml
        innerHTML={fluentIconsPackage.getIcon(getStatusIcon(feature))
                ?.outerHTML || ""}/>
                  </span>
                ...
                <div class="feature-status">
                  ...
                  <span class="health-score" classList={{
