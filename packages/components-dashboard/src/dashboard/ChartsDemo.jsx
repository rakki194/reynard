...
export const ChartsDemo = () => {
    ...
    return (<div class="dashboard-card charts-demo">
      <div class="card-header">
        <h3>
          {fluentIconsPackage.getIcon("chart-multiple") && (<span class="card-icon">
              <div 
        ...
        <button class="showcase-button" onClick={goToChartsShowcase}>
          View Full Showcase
        </button>
      </div>
      ...
      <div class="charts-preview">
        <div class="chart-mini">
          <Chart type="line" labels={sampleData().labels} datasets={sampleData().datasets} width={200} height={120} title="Performance"/>
        </div>

        <div class="chart-mini">
          <RealTimeChart type="line" data={realTimeData()} title="Live Data" maxDataPoints={10} updateInterval={2000} autoScroll={true} width={200} height={120}/>
        </div>
      </div>
