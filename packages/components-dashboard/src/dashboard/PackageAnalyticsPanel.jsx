...
export const PackageAnalyticsPanel = (props) => {
    ...
    const refreshAnalyticsData = async () => {
        ...
        try {
            ...
            const averagePerformanceScore = analyticsList.reduce((sum, a) => sum + a.performanceScore, 0) /
    ...
    const filteredAndSortedAnalytics = () => {
        ...
        if (searchQuery()) {
            ...
            filtered = filtered.filter((analytics) => analytics.name.toLowerCase().includes(query) ||
    ...
    return (<div class="package-analytics-panel">
      {/* Header */}
    ...
    innerHTML={fluentIconsPackage.getIcon("chart-multiple")?.outerHTML || ""}/>
      ...
      <div class="analytics-list">
        <For each={filteredAndSortedAnalytics()}>
          {(analytics) => (<div class="analytics-item">
        ...
        innerHTML={fluentIconsPackage.getIcon(getFrequencyIcon(analytics.usageFrequency))?.outerHTML || ""}/>
                ...
                <div class="analytics-status">
                  <span class="frequency-badge" classList={{
                [getFrequencyColor(analytics.usageFrequency)]: true,
            }}>
                    {analytics.usageFrequency}
                  </span>

                  <span class="performance-score" classList={{
