...
export const AudioPlayer = (props) => {
    ...
    return (<div class={`audio-player ${props.className || ""}`}>
      ...
      <audio ref={audioRef} src={currentTrack
            ...
            : ""} loop={playerConfig.loopTrack} preload="metadata" onLoadedMetadata={handleLoadedMetadata} onTimeUpdate={handleTimeUpdate} onPlay={handlePlay} onPause={handlePause} onEnded={handleEnded} onError={handleError}/>
      ...
      <div class="player-content">
        ...
        <div class="main-controls">
          ...
          <div class="control-buttons">
            ...
            <button type="button" class="control-button" onClick={nextTrack} disabled={currentTrackIndex() === playlist().length - 1 &&
            !playerConfig.loopPlaylist} title="Next (N)">
              ⏭️
            </button>
