...
export const LoadingState = () => (<div class="loading-state">
    <div class="loading-spinner"/>
    <span>Loading audio...</span>
  </div>);
// Error State Component
export const ErrorState = props => (<div class="error-state">
    <div class="error-icon">⚠️</div>
    <span>{props.error}</span>
  </div>);
// Waveform Canvas Component
export const WaveformCanvas = props => (<Show when={props.waveformData}>
    <div class="waveform-wrapper">
      <canvas ref={props.canvasRef} class="waveform-canvas" width={800} height={props.waveformConfig().height} onClick={props.onWaveformClick}/>
    </div>
  </Show>);
// Playback Controls Component
export const PlaybackControls = props => (<Show when={props.playbackConfig().showControls}>
    <div class="playback-controls">
      ...
      <div class="volume-control">
        ...
        <Slider min={0} max={1} step={0.1} onChange={e => props.onVolumeChange(parseFloat(e.target.value))} class="volume-slider"/>
      </div>
    </div>
  </Show>);
