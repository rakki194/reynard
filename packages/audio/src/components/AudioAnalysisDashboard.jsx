...
export const AudioAnalysisDashboard = (props) => {
    ...
    return (<div class={`audio-analysis-dashboard ${props.className || ""}`}>
          ...
          <div class="analysis-results">
            ...
            <Show when={analysisConfig().showWaveform}>
              <div class="waveform-section">
                ...
                <AudioWaveformVisualizer audioSrc={props.audioFile} waveformConfig={{
            bars: 150,
            height: 100,
        }} playbackConfig={{
            showControls: true,
              ...
              <div class="metadata-section">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value">
                      {formatFrequency(analysisData()?.metadata.sampleRate || 0)}
                    </span>
                  </div>
                  <div class="info-item">
              ...
              <div class="statistics-section">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value">
                      {((analysisData()?.statistics.rmsAmplitude || 0) * 100).toFixed(1)}
                      %
                    </span>
                  </div>
                  <div class="info-item">
                    ...
                    <span class="info-value">
                      {(analysisData()?.statistics.dynamicRange || 0).toFixed(1)}{" "}
                      dB
                    </span>
                  </div>
                  <div class="info-item">
              ...
              <div class="quality-section">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    <span class="info-label">Sample Rate</span>
                    <span class="info-value">
                      {formatFrequency(analysisData()?.qualityMetrics.sampleRate || 0)}
                    </span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">Bitrate</span>
