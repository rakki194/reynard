...
export function ProgressTracker(props) {
  ...
  const getConnectionStatus = () => {
    if (error()) return { color: "text-red-600", text: "Error", icon: "❌" };
    if (isConnected()) return { color: "text-green-600", text: "Connected", icon: "🟢" };
    return { color: "text-yellow-600", text: "Connecting...", icon: "🟡" };
  };
  return (
    <div class={`progress-tracker ${className}`}>
      {/* Connection Status */}
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="mb-6">
            ...
            <div class="w-full bg-gray-200 rounded-full h-3">
              <div
                class={`h-3 rounded-full transition-all duration-500 ${getProgressColor(currentProgress().progress)}`}
