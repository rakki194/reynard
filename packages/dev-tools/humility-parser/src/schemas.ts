...
export const DetectionCategorySchema = z.enum([
  ...
  "hype_language",
  "exclusivity_claims",
  "other", // Allow for additional categories
]);

export const LinguisticFeaturesSchema = z.object({
  pattern_matched: z.string().optional(),
  word_position: z.number().optional(),
  line_length: z.number().optional(),
  surrounding_words: z.array(z.string()).optional(),
});

export const BehavioralIndicatorsSchema = z.union([z.record(z.string(), z.any()), z.array(z.any())]);

export const CulturalContextSchema = z.union([z.record(z.string(), z.any()), z.array(z.any())]).nullable();
