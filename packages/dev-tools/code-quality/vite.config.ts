  ...
  build: {
    ...
    rollupOptions: {
      external: [
        ...
        "reynard-dev-tools-catalyst/logger",
        "reynard-dev-tools-catalyst/validation",
        "reynard-dev-tools-catalyst/linting",
        "glob",
        "reynard-ui",
        "reynard-charts",
      ...
      output: {
        globals: {
          ...
          "reynard-dev-tools-catalyst": "ReynardDevToolsCatalyst",
