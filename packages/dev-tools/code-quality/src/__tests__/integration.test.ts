...
describe("Integration Tests", () => {
  ...
  describe("Performance and Scalability", () => {
    it("should create multiple systems efficiently", () => {
      ...
      const systems = Array.from({ length: 10 }, (_, i) => createCodeQualitySystem(`/test/project${i}`));
    ...
    it("should handle different system configurations", () => {
      ...
      const systems = configs.map(config => createCodeQualitySystem("/test/project", config));
