...
import { useFeatureAvailable as useFeatureAvailableBase, useFeatureDegraded as useFeatureDegradedBase, useFeatureStatus as useFeatureStatusBase, useFeatureConfig as useFeatureConfigBase, useFeaturesByCategory as useFeaturesByCategoryBase, useFeaturesByPriority as useFeaturesByPriorityBase, useCriticalFeatures as useCriticalFeaturesBase, useFeaturesByService as useFeaturesByServiceBase, } from "./useFeatureHooks";
import { useFeatureAware as useFeatureAwareBase, useFeatureConfiguration as useFeatureConfigurationBase, } from "./useFeatureAware";
...
export function FeatureProvider(props) {
    ...
    return (<FeatureContextProvider.Provider value={context}>
      {props.children}
