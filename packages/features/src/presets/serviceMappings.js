 ...
 */
export const REVERSE_SERVICE_MAPPINGS = Object.fromEntries(Object.entries(SERVICE_MAPPINGS).map(([feature, actual]) => [
    actual,
    feature,
]));
/**
 ...
 */
export function getActualServiceName(featureServiceName) {
    return (SERVICE_MAPPINGS[featureServiceName] ||
        featureServiceName);
}
/**
 * Get the feature system service name for an actual service name
 */
export function getFeatureServiceName(actualServiceName) {
 ...
 */
export function getAllReverseServiceMappings() {
