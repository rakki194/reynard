...
export async function testComponentRendering<T extends Component<any>>(
    ...
    if (providers.length > 0) {
        ...
        renderResult = render(() => {
            return <WrapperComponent><Component {...props} /></WrapperComponent>;
        });
    } else {
...
export {
    setupCoreTest
} from "./setup/core-setup";

export {
    setupConnectionTest
} from "./setup/connection-setup";
