 ...
 * Mock matchMedia
 */
export const mockMatchMedia = vi.fn((query) => ({
    matches: false,
    media: query,
    onchange: null,
    addListener: vi.fn(),
 ...
 */
export const mockRequestAnimationFrame = vi.fn((cb) => {
 ...
 */
export const mockCancelAnimationFrame = vi.fn((id) => clearTimeout(id));
/**
 * Mock fetch
 */
export const mockFetch = vi.fn((_url) => Promise.resolve({
    ok: true,
    status: 200,
 ...
 * Mock Headers
 */
export const mockHeaders = vi.fn().mockImplementation((init) => {
