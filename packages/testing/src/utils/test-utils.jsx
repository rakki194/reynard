 ...
 */
export function renderWithTestProviders(ui, options) {
    return render(() => <TestAppProvider children={ui()}/>, options);
}
/**
 * Helper to create mock resources
 */
export function createMockTestResource(data) {
    const resource = (() => data);
...
export const mockFns = {
    saveCaption: Object.assign(vi.fn(async () => new Response()), { mockClear: vi.fn() }),
    deleteCaption: Object.assign(vi.fn(async () => new Response()), { mockClear: vi.fn() }),
    saveWithHistory: Object.assign(vi.fn(async () => new Response()), { mockClear: vi.fn() }),
    undo: Object.assign(vi.fn(async () => new Response()), { mockClear: vi.fn() }),
};
/**
