...
describe('Render Utilities', () => {
  ...
  describe('renderWithAllProviders', () => {
    ...
    it('should accept render options', () => {
      const result = renderWithAllProviders(() => <TestComponent />, {}, {
        container: document.createElement('div'),
      });
  ...
  describe('renderWithWrapper', () => {
    it('should render component with custom wrapper', () => {
      ...
      renderWithWrapper(() => <TestComponent />, CustomWrapper, { customProp: 'test' });
      
      expect(screen.getByTestId('wrapper')).toHaveAttribute('data-custom', 'test');
      expect(screen.getByTestId('test-component')).toHaveTextContent('Hello World');
    });
    ...
    it('should accept render options', () => {
      ...
      const result = renderWithWrapper(() => <TestComponent />, CustomWrapper, {}, {
        container: document.createElement('div'),
      });
  ...
  describe('renderWithPerformanceMonitoring', () => {
    ...
    it('should accept render options', () => {
      ...
      const result = renderWithPerformanceMonitoring(() => <TestComponent />, onRender, {
        container: document.createElement('div'),
      });
