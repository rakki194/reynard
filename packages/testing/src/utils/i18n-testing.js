 ...
 */
export function detectHardcodedStrings(filePath, content, config) {
    const results = [];
...
function findMissingKeys(reference, target) {
    const missing = [];
    function compareObjects(ref, tar, path = "") {
 ...
 */
function findUnusedKeys(reference, target) {
    const unused = [];
    function findUnusedInObject(ref, tar, path = "") {
 ...
 */
function findIncompleteTranslations(translations) {
    const incomplete = [];
 ...
 */
function hasProperPluralForms(obj, key, rules) {
 ...
 * Test RTL support
 */
export function testRTLSupport(config) {
    const issues = [];
 ...
 */
async function scanPackageForHardcodedStrings(packagePath, config) {
    const results = [];
 ...
 */
export async function runI18nTests(config) {
 ...
 */
export function generateI18nReport(result) {
