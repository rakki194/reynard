            ...
            return {
                JSXText(node) {
                    ...
                    if (text.length < minLength)
                        return;
                    if (ignorePatterns.some((pattern) => text.match(new RegExp(pattern))))
                        return;
                ...
                Literal(node) {
                    ...
                    if (node.value.length < minLength)
                        return;
                    if (ignorePatterns.some((pattern) => node.value.match(new RegExp(pattern))))
                        return;
                    if (isTechnicalTerm(node.value))
                        return;
