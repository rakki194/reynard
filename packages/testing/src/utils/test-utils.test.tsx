...
describe('Test Utilities', () => {
  describe('TestAppProvider and useTestAppContext', () => {
    ...
    it('should provide all required context properties', () => {
      const TestComponent: Component = () => {
        ...
        return (
          <div>
            ...
            <div data-testid="instant-delete">{context.instantDelete.toString()}</div>
            <div data-testid="disable-animations">{context.disableAnimations.toString()}</div>
          </div>
        );
      };
      ...
      expect(screen.getByTestId('disable-animations')).toHaveTextContent('false');
    });
  ...
  describe('renderWithTestProviders', () => {
    it('should render component with test providers', () => {
      const TestComponent: Component = () => <div data-testid="test">Hello World</div>;
