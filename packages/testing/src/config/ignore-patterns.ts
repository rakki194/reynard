...
export const DOMAIN_SPECIFIC_PATTERNS = {
  ...
  core: ['core', 'base', 'foundation', 'utility', 'util', 'common', 'shared', 'base', 'client', 'composable', 'module', 'executor', 'security', 'validation', 'crypto', 'storage', 'cache', 'lazy', 'export', 'registry']
} as const;
