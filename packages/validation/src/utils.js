 ...
 * Validate file size
 */
export function validateFileSize(fileSize, fieldName = "fileSize", maxSize = 100 * 1024 * 1024 // 100MB default
) {
 ...
 */
export function validatePasswordStrength(password, rules = {
    minLength: 8,
 ...
 */
export function validateUrlSecurity(url) {
