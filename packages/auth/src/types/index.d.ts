...
export declare const DEFAULT_AUTH_CONFIG: AuthConfiguration;
export declare const DEFAULT_VALIDATION_RULES: ValidationRules;
export declare const PASSWORD_STRENGTH_LABELS: string[];
export declare const PASSWORD_STRENGTH_COLORS: string[];
