 ...
 */
export const DocsSearch: Component<{
  placeholder?: string;
 ...
 */
export const DocsSearchResults: Component<{
  results: Array<{
    id: string;
    title: string;
    description?: string;
                      ...
                      <Show when={result.tags && result.tags.length > 0}>
                        <div class="docs-search-result-tags">
                          <For each={result.tags}>
                            {(tag) => (
                              <span class="docs-search-result-tag">{tag}</span>
                            )}
                          </For>
                        </div>
                      </Show>
 ...
 */
export const DocsSearchSuggestions: Component<{
  suggestions: string[];
 ...
 */
export const DocsAdvancedSearch: Component<{
  onSearch: (filters: {
    query: string;
    category?: string;
    tags?: string[];
 ...
 */
export const DocsSearchModal: Component<{
  isOpen: boolean;
  onClose: () => void;
  onSearch: (query: string) => void;
  results: any[];
