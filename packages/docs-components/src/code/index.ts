 ...
 */
export const DocsCodeBlock: Component<{
  code: string;
  language: string;
  title?: string;
        ...
        <div class="docs-code-block-header">
          ...
          <div class="docs-code-block-actions">
            ...
            <Button 
              ...
              className="docs-code-block-expand"
            >
 ...
 */
export const DocsCodeEditor: Component<{
  code: string;
  language: string;
    ...
    <div class={`docs-code-editor ${props.className || ''}`}>
      <div class="docs-code-editor-header">
        ...
        <Button 
          ...
          variant="primary"
          onClick={handleRun}
          className="docs-code-editor-run"
        >
          Run Code
        </Button>
      </div>
 ...
 */
export const DocsCodeExample: Component<{
  title: string;
  description?: string;
  code: string;
  language: string;
 ...
 */
export const DocsCodeComparison: Component<{
  left: {
    title: string;
    code: string;
    language: string;
 ...
 */
export const DocsCodeSnippet: Component<{
  code: string;
  language?: string;
  copyable?: boolean;
  className?: string;
 ...
 */
export const DocsTerminal: Component<{
  commands: Array<{
    command: string;
    output?: string;
    error?: string;
