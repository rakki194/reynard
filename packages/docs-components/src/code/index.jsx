      ...
      <Show when={props.title}>
        <div class="docs-code-block-header">
          ...
          <div class="docs-code-block-actions">
            ...
            <Button size="sm" variant="secondary" onClick={() => setIsExpanded(!isExpanded())} class="docs-code-block-expand">
...
export const DocsCodeEditor = props => {
    ...
    return (<div class={`docs-code-editor ${props.className || ""}`}>
      ...
      <div class="docs-code-editor-content">
        <textarea value={code()} onInput={e => handleCodeChange(e.currentTarget.value)} readOnly={props.readOnly} class="docs-code-editor-textarea" spellcheck={false}/>
      </div>
...
export const DocsCodeExample = props => {
    ...
    return (<Card class={`docs-code-example ${props.className || ""}`}>
      ...
      <div class="docs-code-example-tabs">
        <button class={`docs-code-example-tab ${activeTab() === "preview" ? "active" : ""}`} onClick={() => setActiveTab("preview")}>
          Preview
        </button>
        <button class={`docs-code-example-tab ${activeTab() === "code" ? "active" : ""}`} onClick={() => setActiveTab("code")}>
          Code
        </button>
      </div>
    ...
    return (<div class={`docs-terminal ${props.className || ""}`}>
      ...
      <div class="docs-terminal-content">
        <For each={props.commands}>
          {cmd => (<div class="docs-terminal-line">
