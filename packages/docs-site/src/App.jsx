...
const App = () => {
    ...
    return (<Router>
      ...
      <DocsSearchModal isOpen={isSearchModalOpen()} onClose={() => setIsSearchModalOpen(false)} onSearch={handleSearch} results={searchResults()} onResultClick={handleSearchResultClick} suggestions={[
            "Getting Started",
            "API Reference",
            "Components",
            "Themes",
