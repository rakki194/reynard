    ...
    return (<DocsPage>
      ...
      <DocsSection>
        <div class="docs-search-form">
          <DocsSearch onSearch={handleSearch} onClear={() => handleSearch("")} placeholder="Search documentation..." class="docs-search-input-large"/>
        </div>
      </DocsSection>

      <DocsSection>
        {isSearching() && (<div class="docs-search-loading">
            <div class="docs-loading-spinner"/>
            <p>Searching...</p>
          </div>)}

        {!isSearching() && searchQuery() && (<DocsSearchResults results={searchResults()} query={searchQuery()} onResultClick={handleResultClick}/>)}

        {!isSearching() && !searchQuery() && (<div class="docs-search-empty">
