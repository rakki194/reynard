...
import { useTheme } from 'reynard-themes';`,
  ...
  return (
    ...
    return (<DocsPage>
      <DocsHero title="Reynard Framework" subtitle="Build beautiful web applications with SolidJS" description="A modern, modular framework for building fast, accessible, and maintainable web applications. Built with SolidJS and TypeScript." actions={<div class="docs-hero-actions">
      ...
      <DocsSection title="Quick Start">
        <div class="docs-quick-start">
          <For each={quickStartSteps}>
            {step => (<div class="docs-quick-start-step">
