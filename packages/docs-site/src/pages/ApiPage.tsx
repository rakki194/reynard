      ...
      <DocsSection>
        ...
        <DocsTabPanel tabId="functions" activeTab={activeTab()}>
          <div class="docs-api-functions">
            <h2>Functions</h2>
            <div class="docs-api-list">{/* Render function APIs */}</div>
          </div>
        </DocsTabPanel>
        ...
        <DocsTabPanel tabId="classes" activeTab={activeTab()}>
          <div class="docs-api-classes">
            <h2>Classes</h2>
            <div class="docs-api-list">{/* Render class APIs */}</div>
          </div>
        </DocsTabPanel>
        ...
        <DocsTabPanel tabId="types" activeTab={activeTab()}>
          <div class="docs-api-types">
            <h2>Types</h2>
            <div class="docs-api-list">{/* Render type APIs */}</div>
          </div>
        </DocsTabPanel>
        ...
        <DocsTabPanel tabId="interfaces" activeTab={activeTab()}>
          <div class="docs-api-interfaces">
            <h2>Interfaces</h2>
            <div class="docs-api-list">{/* Render interface APIs */}</div>
          </div>
        </DocsTabPanel>
      </DocsSection>
    </DocsPage>
