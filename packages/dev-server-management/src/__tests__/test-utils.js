...
export const expectEventEmitted = (emitter, event, data) => {
...
export const expectNoEventEmitted = (emitter, event) => {
    const events = emitter.eventNames();
    expect(events).not.toContain(event);
};
export const expectConfigValid = (config) => {
    expect(config).toBeDefined();
    expect(config.projects).toBeDefined();
    expect(typeof config.projects).toBe("object");
};
export const expectProjectConfigValid = (project) => {
