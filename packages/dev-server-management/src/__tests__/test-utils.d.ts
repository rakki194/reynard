...
export declare const createMockNetwork: () => {
    ...
    setPortInUse: import("vitest").Mock<(...args: any[]) => any>;
    isPortInUse: import("vitest").Mock<(...args: any[]) => any>;
};
...
export declare const waitForEvent: (emitter: any, event: string, timeout?: number) => Promise<any>;
export declare const waitForEvents: (emitter: any, events: string[], timeout?: number) => Promise<any[]>;
export declare const expectEventEmitted: (emitter: any, event: string, data?: any) => void;
export declare const expectNoEventEmitted: (emitter: any, event: string) => void;
export declare const expectConfigValid: (config: any) => void;
export declare const expectProjectConfigValid: (project: any) => void;
