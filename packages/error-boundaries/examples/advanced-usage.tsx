...
const networkRetryStrategy = createRecoveryStrategy(
  ...
  'Retry the failed network request with exponential backoff',
...
const authRedirectStrategy = createRecoveryStrategy(
  'auth-redirect',
  'Redirect to Login',
  'Redirect to login page for authentication errors',
  (error, context) => context.category === 'authentication',
  async (error, context) => {
...
const ErrorDemoComponent: Component = () => {
...
const ErrorDashboard: Component = () => {
...
// Main demo component
const AdvancedErrorBoundaryDemo: Component = () => {
  return (
    <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      <h1>🦊 Advanced Error Boundary Demo</h1>
      <p>This demonstrates advanced error boundary features including custom recovery strategies and error reporting.</p>
