 ...
 */
export function analyzeError(error, errorInfo) {
 ...
 */
function determineErrorCategory(_error, message, name, stack) {
    // Network errors
 ...
 */
function determineErrorSeverity(category, error, _errorInfo) {
 ...
 */
function isErrorRecoverable(category, severity, _error) {
 ...
 */
function extractErrorMetadata(_error, errorInfo, stack) {
    const metadata = {};
 ...
 */
export function createErrorContext(error, _errorInfo, additionalContext) {
 ...
 */
function generateErrorBoundaryId() {
