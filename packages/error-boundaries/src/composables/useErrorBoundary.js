...
export function useErrorBoundary(options = {}) {
    ...
    const handleError = (error, errorInfo) => {
        ...
        const actions = strategies.map((strategy) => ({
            id: strategy.id,
            name: strategy.name,
