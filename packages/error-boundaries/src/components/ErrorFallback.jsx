...
export const ErrorFallback = (props) => {
    ...
    return (<div class="reynard-error-fallback">
      <div class="reynard-error-fallback__content">
        ...
        {/* Error Message */}
        <p class="reynard-error-fallback__message">
          {props.error.message || "An unexpected error occurred"}
        </p>

        {/* Primary Actions */}
        <div class="reynard-error-fallback__actions">
          <button class="reynard-error-fallback__button reynard-error-fallback__button--primary" onClick={handleRetry} disabled={props.isRecovering}>
            {props.isRecovering ? "Recovering..." : "Try Again"}
          </button>

          <button class="reynard-error-fallback__button reynard-error-fallback__button--secondary" onClick={handleReset}>
            Reset
          </button>
        </div>
        ...
        <Show when={props.recoveryActions.length > 0}>
          <div class="reynard-error-fallback__recovery">
            <h3 class="reynard-error-fallback__recovery-title">
              Recovery Options
            </h3>
            <div class="reynard-error-fallback__recovery-actions">
              <For each={props.recoveryActions}>
                {(action) => (<button class="reynard-error-fallback__recovery-button" onClick={() => handleRecovery(action)} disabled={props.isRecovering} title={action.description}>
                    {action.name}
                  </button>)}
              </For>
            </div>
        ...
        <div class="reynard-error-fallback__report">
          ...
          <p class="reynard-error-fallback__report-description">
            This error has been automatically reported. You can also send
            additional details:
          </p>
          <textarea class="reynard-error-fallback__report-textarea" placeholder="Describe what you were doing when this error occurred..." value={userReport()} onInput={(e) => setUserReport(e.target.value)}/>
        ...
        <details class="reynard-error-fallback__details">
          <summary class="reynard-error-fallback__details-summary">
            Technical Details
          </summary>
