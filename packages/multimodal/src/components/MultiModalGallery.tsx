...
import type { MultiModalGalleryProps } from "../types/MultiModalTypes";
...
export const MultiModalGallery: Component<MultiModalGalleryProps> = props => {
  ...
  const handleFileUploadWithMax = (event: Event) => {
    handleFileUpload(event, setFiles, props.maxFiles);
  };

  return (
    <MultiModalGalleryView
      class={props.class}
      ...
      onFileUpload={handleFileUploadWithMax}
      isLoading={isLoading()}
      error={error()}
