...
export const MultiModalFileCard = props => {
    const { t } = useI18n();
    return (<div class="multi-modal-file-card" classList={{
            selected: props.isSelected,
            [`size-${props.size || "medium"}`]: true,
            [`type-${props.file.fileType}`]: true,
        }} onClick={() => props.onSelect()} style={{ "--type-color": getTypeColor(props.file.fileType) }}>
