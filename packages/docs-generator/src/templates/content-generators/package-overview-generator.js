...
export class PackageOverviewGenerator {
    constructor() {
        Object.defineProperty(this, "readmeProcessor", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    generateInstallationSection(packageInfo) {
     ...
     */
    generateQuickStartSection(packageInfo) {
        if (!packageInfo.readme)
            return "";
     ...
     */
    generateFeaturesSection(packageInfo) {
     ...
     */
    generateApiSection(packageInfo) {
     ...
     */
    generateExamplesSection(packageInfo) {
     ...
     */
    generateLinksSection(packageInfo) {
        let content = `## Links\n\n`;
