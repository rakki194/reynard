...
describe("useCaptionGeneratorState", () => {
  ...
  describe("Error State", () => {
    ...
    it("should handle long error messages", () => {
      const longError =
        "This is a very long error message that might contain detailed information about what went wrong during the caption generation process and could potentially wrap to multiple lines in the UI.";
