...
export interface AuthenticationApiInterface {
     ...
     */
    changePasswordApiAuthChangePasswordPostRaw(requestParameters: ChangePasswordApiAuthChangePasswordPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>>;

    /**
     * Change current user\'s password.  Args:     current_password: Current password     new_password: New password     current_user: Current authenticated user     auth_manager: Authentication manager instance  Returns:     dict: Success message  Raises:     HTTPException: If password change fails
     * Change Password
     */
    changePasswordApiAuthChangePasswordPost(requestParameters: ChangePasswordApiAuthChangePasswordPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }>;
     ...
     * @memberof AuthenticationApiInterface
     */
    cleanupExpiredTokensApiAuthCleanupPostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>>;

    /**
     * Clean up expired tokens (admin only).  Args:     current_user: Current authenticated user (must be admin)     auth_manager: Authentication manager instance  Returns:     dict: Success message
     * Cleanup Expired Tokens
     */
    cleanupExpiredTokensApiAuthCleanupPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }>;
     ...
     * @memberof AuthenticationApiInterface
     */
    deleteUserApiAuthUsersUsernameDeleteRaw(requestParameters: DeleteUserApiAuthUsersUsernameDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>>;

    /**
     * Delete user by username (admin only).  Args:     username: Username to delete     current_user: Current authenticated user (must be admin)     auth_manager: Authentication manager instance  Returns:     dict: Success message  Raises:     HTTPException: If user not found or deletion fails
     * Delete User
     */
    deleteUserApiAuthUsersUsernameDelete(requestParameters: DeleteUserApiAuthUsersUsernameDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }>;
     ...
     * @memberof AuthenticationApiInterface
     */
    getAuthStatsApiAuthStatsGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>>;
     ...
     * @memberof AuthenticationApiInterface
     */
    logoutApiAuthLogoutPostRaw(requestParameters: LogoutApiAuthLogoutPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>>;

    /**
     * Logout user by revoking their token.  Args:     token: The access token to revoke     auth_manager: Authentication manager instance  Returns:     dict: Success message
     * Logout
     */
    logoutApiAuthLogoutPost(requestParameters: LogoutApiAuthLogoutPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }>;
     ...
     * @memberof AuthenticationApiInterface
     */
    revokeUserTokensApiAuthUsersUsernameRevokeTokensPostRaw(requestParameters: RevokeUserTokensApiAuthUsersUsernameRevokeTokensPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>>;

    /**
     * Revoke all tokens for a user (admin only).  Args:     username: Username whose tokens should be revoked     current_user: Current authenticated user (must be admin)     auth_manager: Authentication manager instance  Returns:     dict: Success message
     * Revoke User Tokens
     */
    revokeUserTokensApiAuthUsersUsernameRevokeTokensPost(requestParameters: RevokeUserTokensApiAuthUsersUsernameRevokeTokensPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }>;
...
export class AuthenticationApi extends runtime.BaseAPI implements AuthenticationApiInterface {
     ...
     * Change Password
     */
    async changePasswordApiAuthChangePasswordPostRaw(requestParameters: ChangePasswordApiAuthChangePasswordPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>> {
     ...
     * Change Password
     */
    async changePasswordApiAuthChangePasswordPost(requestParameters: ChangePasswordApiAuthChangePasswordPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }> {
     ...
     * Cleanup Expired Tokens
     */
    async cleanupExpiredTokensApiAuthCleanupPostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>> {
        const queryParameters: any = {};
     ...
     * Cleanup Expired Tokens
     */
    async cleanupExpiredTokensApiAuthCleanupPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }> {
     ...
     * Delete User
     */
    async deleteUserApiAuthUsersUsernameDeleteRaw(requestParameters: DeleteUserApiAuthUsersUsernameDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>> {
     ...
     * Delete User
     */
    async deleteUserApiAuthUsersUsernameDelete(requestParameters: DeleteUserApiAuthUsersUsernameDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }> {
     ...
     * Get Auth Stats
     */
    async getAuthStatsApiAuthStatsGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        const queryParameters: any = {};
     ...
     * Get Current User Info
     */
    async getCurrentUserInfoApiAuthMeGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
        const queryParameters: any = {};
     ...
     * Get Current User Info
     */
    async getCurrentUserInfoApiAuthMeGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
     ...
     * Get User
     */
    async getUserApiAuthUsersUsernameGetRaw(requestParameters: GetUserApiAuthUsersUsernameGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
        if (requestParameters['username'] == null) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Get User
     */
    async getUserApiAuthUsersUsernameGet(requestParameters: GetUserApiAuthUsersUsernameGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
     ...
     * List Users
     */
    async listUsersApiAuthUsersGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<UserPublic>>> {
        const queryParameters: any = {};
     ...
     * List Users
     */
    async listUsersApiAuthUsersGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<UserPublic>> {
     ...
     * Login
     */
    async loginApiAuthLoginPostRaw(requestParameters: LoginApiAuthLoginPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenResponse>> {
        if (requestParameters['username'] == null) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Login
     */
    async loginApiAuthLoginPost(requestParameters: LoginApiAuthLoginPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenResponse> {
     ...
     * Logout
     */
    async logoutApiAuthLogoutPostRaw(requestParameters: LogoutApiAuthLogoutPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>> {
     ...
     * Logout
     */
    async logoutApiAuthLogoutPost(requestParameters: LogoutApiAuthLogoutPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }> {
     ...
     * Refresh Tokens
     */
    async refreshTokensApiAuthRefreshPostRaw(requestParameters: RefreshTokensApiAuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenResponse>> {
     ...
     * Refresh Tokens
     */
    async refreshTokensApiAuthRefreshPost(requestParameters: RefreshTokensApiAuthRefreshPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenResponse> {
     ...
     * Register
     */
    async registerApiAuthRegisterPostRaw(requestParameters: RegisterApiAuthRegisterPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
     ...
     * Register
     */
    async registerApiAuthRegisterPost(requestParameters: RegisterApiAuthRegisterPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
     ...
     * Revoke User Tokens
     */
    async revokeUserTokensApiAuthUsersUsernameRevokeTokensPostRaw(requestParameters: RevokeUserTokensApiAuthUsersUsernameRevokeTokensPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string | null; }>> {
        if (requestParameters['username'] == null) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Revoke User Tokens
     */
    async revokeUserTokensApiAuthUsersUsernameRevokeTokensPost(requestParameters: RevokeUserTokensApiAuthUsersUsernameRevokeTokensPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string | null; }> {
     ...
     * Update Current User
     */
    async updateCurrentUserApiAuthMePutRaw(requestParameters: UpdateCurrentUserApiAuthMePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
     ...
     * Update Current User
     */
    async updateCurrentUserApiAuthMePut(requestParameters: UpdateCurrentUserApiAuthMePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
     ...
     * Update User
     */
    async updateUserApiAuthUsersUsernamePutRaw(requestParameters: UpdateUserApiAuthUsersUsernamePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserPublic>> {
        if (requestParameters['username'] == null) {
            throw new runtime.RequiredError(
                'username',
     ...
     * Update User
     */
    async updateUserApiAuthUsersUsernamePut(requestParameters: UpdateUserApiAuthUsersUsernamePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserPublic> {
