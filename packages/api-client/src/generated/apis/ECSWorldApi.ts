...
export class ECSWorldApi extends runtime.BaseAPI implements ECSWorldApiInterface {
   ...
   * Analyze Compatibility
   */
  async analyzeCompatibilityApiEcsAgentsAgent1IdCompatibilityAgent2IdGetRaw(
    requestParameters: AnalyzeCompatibilityApiEcsAgentsAgent1IdCompatibilityAgent2IdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
   ...
   * Analyze Compatibility
   */
  async analyzeCompatibilityApiEcsAgentsAgent1IdCompatibilityAgent2IdGet(
    requestParameters: AnalyzeCompatibilityApiEcsAgentsAgent1IdCompatibilityAgent2IdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
    const response = await this.analyzeCompatibilityApiEcsAgentsAgent1IdCompatibilityAgent2IdGetRaw(
      requestParameters,
      initOverrides
    );
   ...
   * Create Offspring
   */
  async createOffspringApiEcsAgentsOffspringPostRaw(
    requestParameters: CreateOffspringApiEcsAgentsOffspringPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AgentResponse>> {
   ...
   * Create Offspring
   */
  async createOffspringApiEcsAgentsOffspringPost(
    requestParameters: CreateOffspringApiEcsAgentsOffspringPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AgentResponse> {
   ...
   * Enable Breeding
   */
  async enableBreedingApiEcsBreedingEnablePostRaw(
    requestParameters: EnableBreedingApiEcsBreedingEnablePostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
    const queryParameters: any = {};
   ...
   * Enable Breeding
   */
  async enableBreedingApiEcsBreedingEnablePost(
    requestParameters: EnableBreedingApiEcsBreedingEnablePostRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
   ...
   * Find Compatible Mates
   */
  async findCompatibleMatesApiEcsAgentsAgentIdMatesGetRaw(
    requestParameters: FindCompatibleMatesApiEcsAgentsAgentIdMatesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
   ...
   * Find Compatible Mates
   */
  async findCompatibleMatesApiEcsAgentsAgentIdMatesGet(
    requestParameters: FindCompatibleMatesApiEcsAgentsAgentIdMatesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
   ...
   * Get Agent Lineage
   */
  async getAgentLineageApiEcsAgentsAgentIdLineageGetRaw(
    requestParameters: GetAgentLineageApiEcsAgentsAgentIdLineageGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
    if (requestParameters["agentId"] == null) {
   ...
   * Get Agent Lineage
   */
  async getAgentLineageApiEcsAgentsAgentIdLineageGet(
    requestParameters: GetAgentLineageApiEcsAgentsAgentIdLineageGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
   ...
   * Get Breeding Stats
   */
  async getBreedingStatsApiEcsBreedingStatsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
    const queryParameters: any = {};
   ...
   * Get Breeding Stats
   */
  async getBreedingStatsApiEcsBreedingStatsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
