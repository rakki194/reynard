...
import type { HTTPValidationError, SecureUserCreate, SecureUserLogin } from "../models/index";
import {
...
export class SecureAuthenticationApi extends runtime.BaseAPI implements SecureAuthenticationApiInterface {
   ...
   * Secure Login
   */
  async secureLoginApiSecureAuthLoginPostRaw(
    requestParameters: SecureLoginApiSecureAuthLoginPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
   ...
   * Secure Login
   */
  async secureLoginApiSecureAuthLoginPost(
    requestParameters: SecureLoginApiSecureAuthLoginPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Secure Logout
   */
  async secureLogoutApiSecureAuthLogoutPostRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    const queryParameters: any = {};
   ...
   * Secure Logout
   */
  async secureLogoutApiSecureAuthLogoutPost(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Secure Register
   */
  async secureRegisterApiSecureAuthRegisterPostRaw(
    requestParameters: SecureRegisterApiSecureAuthRegisterPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
   ...
   * Secure Register
   */
  async secureRegisterApiSecureAuthRegisterPost(
    requestParameters: SecureRegisterApiSecureAuthRegisterPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
