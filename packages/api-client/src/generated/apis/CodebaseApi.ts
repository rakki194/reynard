...
export class CodebaseApi extends runtime.BaseAPI implements CodebaseApiInterface {
   ...
   * Get Codebase Stats
   */
  async getCodebaseStatsApiRagApiRagCodebaseStatsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
   ...
   * Get Codebase Stats
   */
  async getCodebaseStatsApiRagApiRagCodebaseStatsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Health Check
   */
  async healthCheckApiRagApiRagCodebaseHealthGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    const queryParameters: any = {};
   ...
   * Health Check
   */
  async healthCheckApiRagApiRagCodebaseHealthGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
   ...
   * Index Codebase
   */
  async indexCodebaseApiRagApiRagCodebaseIndexPostRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
    const queryParameters: any = {};
   ...
   * Index Codebase
   */
  async indexCodebaseApiRagApiRagCodebaseIndexPost(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
   ...
   * Scan Codebase
   */
  async scanCodebaseApiRagApiRagCodebaseScanPostRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<any>> {
    const queryParameters: any = {};
   ...
   * Scan Codebase
   */
  async scanCodebaseApiRagApiRagCodebaseScanPost(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<any> {
