...
export class CaptionUploadApi extends runtime.BaseAPI implements CaptionUploadApiInterface {
     ...
     * Upload And Generate Caption
     */
    async uploadAndGenerateCaptionApiCaptionUploadPostRaw(requestParameters: UploadAndGenerateCaptionApiCaptionUploadPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CaptionResponse>> {
     ...
     * Upload And Generate Caption
     */
    async uploadAndGenerateCaptionApiCaptionUploadPost(requestParameters: UploadAndGenerateCaptionApiCaptionUploadPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CaptionResponse> {
