 ...
 */
export function instanceOfTTSConfigRequest(value) {
    return true;
}
export function TTSConfigRequestFromJSON(json) {
    return TTSConfigRequestFromJSONTyped(json, false);
}
export function TTSConfigRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TTSConfigRequestToJSON(json) {
    return TTSConfigRequestToJSONTyped(json, false);
}
export function TTSConfigRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
