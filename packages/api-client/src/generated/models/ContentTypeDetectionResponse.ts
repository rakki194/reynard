...
export function ContentTypeDetectionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentTypeDetectionResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentTypeDetectionResponseToJSONTyped(value?: ContentTypeDetectionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
