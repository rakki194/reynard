 ...
 */
export function instanceOfOllamaChatResponse(value) {
...
export function OllamaChatResponseFromJSON(json) {
    return OllamaChatResponseFromJSONTyped(json, false);
}
export function OllamaChatResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function OllamaChatResponseToJSON(json) {
    return OllamaChatResponseToJSONTyped(json, false);
}
export function OllamaChatResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
