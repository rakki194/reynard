 ...
 */
export function instanceOfNLWebPerformanceStats(value) {
    return true;
}
export function NLWebPerformanceStatsFromJSON(json) {
    return NLWebPerformanceStatsFromJSONTyped(json, false);
}
export function NLWebPerformanceStatsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NLWebPerformanceStatsToJSON(json) {
    return NLWebPerformanceStatsToJSONTyped(json, false);
}
export function NLWebPerformanceStatsToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
