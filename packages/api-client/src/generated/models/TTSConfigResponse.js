 ...
 */
import { TTSBackendInfoFromJSON, TTSBackendInfoToJSON, } from "./TTSBackendInfo";
/**
 * Check if a given object implements the TTSConfigResponse interface.
 */
export function instanceOfTTSConfigResponse(value) {
...
export function TTSConfigResponseFromJSON(json) {
    return TTSConfigResponseFromJSONTyped(json, false);
}
export function TTSConfigResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        backends: json["backends"].map(TTSBackendInfoFromJSON),
    };
}
export function TTSConfigResponseToJSON(json) {
    return TTSConfigResponseToJSONTyped(json, false);
}
export function TTSConfigResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
        ...
        backends: value["backends"].map(TTSBackendInfoToJSON),
    };
}
