 ...
 */
export function instanceOfImageProcessingServiceInfoResponse(value: object): value is ImageProcessingServiceInfoResponse {
...
export function ImageProcessingServiceInfoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImageProcessingServiceInfoResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ImageProcessingServiceInfoResponseToJSONTyped(value?: ImageProcessingServiceInfoResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
