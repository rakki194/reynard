 ...
 */
export function instanceOfExecutorStatsResponse(value) {
...
export function ExecutorStatsResponseFromJSON(json) {
    return ExecutorStatsResponseFromJSONTyped(json, false);
}
export function ExecutorStatsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ExecutorStatsResponseToJSON(json) {
    return ExecutorStatsResponseToJSONTyped(json, false);
}
export function ExecutorStatsResponseToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
