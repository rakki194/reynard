 ...
 */
import { IdFromJSON, IdToJSON } from "./Id";
/**
 * Check if a given object implements the RAGQueryHit interface.
 */
export function instanceOfRAGQueryHit(value) {
    if (!("score" in value) || value["score"] === undefined)
        return false;
    return true;
}
export function RAGQueryHitFromJSON(json) {
    return RAGQueryHitFromJSONTyped(json, false);
}
export function RAGQueryHitFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function RAGQueryHitToJSON(json) {
    return RAGQueryHitToJSONTyped(json, false);
}
export function RAGQueryHitToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
