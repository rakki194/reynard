...
export function ComfyText2ImgRequestFromJSON(json: any): ComfyText2ImgRequest {
...
export function ComfyText2ImgRequestToJSON(json: any): ComfyText2ImgRequest {
    return ComfyText2ImgRequestToJSONTyped(json, false);
}

export function ComfyText2ImgRequestToJSONTyped(value?: ComfyText2ImgRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
