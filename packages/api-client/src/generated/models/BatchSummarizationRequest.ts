...
export function BatchSummarizationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchSummarizationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function BatchSummarizationRequestToJSONTyped(value?: BatchSummarizationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
