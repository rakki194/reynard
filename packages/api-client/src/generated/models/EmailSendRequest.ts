...
export function EmailSendRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailSendRequest {
    ...
    return {
        ...
        'attachments': json['attachments'] == null ? undefined : ((json['attachments'] as Array<any>).map(EmailAttachmentModelFromJSON)),
...
export function EmailSendRequestToJSONTyped(value?: EmailSendRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'attachments': value['attachments'] == null ? undefined : ((value['attachments'] as Array<any>).map(EmailAttachmentModelToJSON)),
