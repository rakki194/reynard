...
export function NLWebToolFromJSONTyped(json: any, ignoreDiscriminator: boolean): NLWebTool {
    ...
    return {
        ...
        'parameters': json['parameters'] == null ? undefined : ((json['parameters'] as Array<any>).map(NLWebToolParameterFromJSON)),
...
export function NLWebToolToJSONTyped(value?: NLWebTool | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'path': value['path'],
        'method': value['method'],
        'parameters': value['parameters'] == null ? undefined : ((value['parameters'] as Array<any>).map(NLWebToolParameterToJSON)),
