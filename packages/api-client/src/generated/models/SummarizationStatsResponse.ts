...
export function SummarizationStatsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SummarizationStatsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SummarizationStatsResponseToJSONTyped(value?: SummarizationStatsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
