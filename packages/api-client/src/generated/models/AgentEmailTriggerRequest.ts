...
export function AgentEmailTriggerRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentEmailTriggerRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentEmailTriggerRequestToJSONTyped(value?: AgentEmailTriggerRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
