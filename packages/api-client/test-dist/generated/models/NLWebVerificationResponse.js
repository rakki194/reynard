...
function NLWebVerificationResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'checks': json['checks'] == null ? undefined : (json['checks'].map(NLWebVerificationCheck_1.NLWebVerificationCheckFromJSON)),
...
function NLWebVerificationResponseToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'checks': value['checks'] == null ? undefined : (value['checks'].map(NLWebVerificationCheck_1.NLWebVerificationCheckToJSON)),
