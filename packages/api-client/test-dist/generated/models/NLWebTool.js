...
function NLWebToolFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'parameters': json['parameters'] == null ? undefined : (json['parameters'].map(NLWebToolParameter_1.NLWebToolParameterFromJSON)),
...
function NLWebToolToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'path': value['path'],
        'method': value['method'],
        'parameters': value['parameters'] == null ? undefined : (value['parameters'].map(NLWebToolParameter_1.NLWebToolParameterToJSON)),
