...
function SecureChatRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return __assign(__assign({}, json), { 'message': json['message'], 'model': json['model'] == null ? undefined : (0, Model_1.ModelFromJSON)(json['model']), 'systemPrompt': json['system_prompt'] == null ? undefined : (0, SystemPrompt_1.SystemPromptFromJSON)(json['system_prompt']), 'temperature': json['temperature'] == null ? undefined : json['temperature'], 'maxTokens': json['max_tokens'] == null ? undefined : (0, MaxTokens_1.MaxTokensFromJSON)(json['max_tokens']) });
}
...
function SecureChatRequestToJSONTyped(value, ignoreDiscriminator) {
    ...
    return __assign(__assign({}, value), { 'message': value['message'], 'model': (0, Model_1.ModelToJSON)(value['model']), 'system_prompt': (0, SystemPrompt_1.SystemPromptToJSON)(value['systemPrompt']), 'temperature': value['temperature'], 'max_tokens': (0, MaxTokens_1.MaxTokensToJSON)(value['maxTokens']) });
}
