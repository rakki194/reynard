...
var SystemApi = /** @class */ (function (_super) {
     ...
     * Get Configuration
     */
    SystemApi.prototype.getConfigurationApiConfigGetRaw = function (initOverrides) {
     ...
     * Get Configuration
     */
    SystemApi.prototype.getConfigurationApiConfigGet = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getConfigurationApiConfigGetRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
