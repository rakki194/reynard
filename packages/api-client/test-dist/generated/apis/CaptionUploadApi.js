...
var CaptionUploadApi = /** @class */ (function (_super) {
   ...
   */
  CaptionUploadApi.prototype.uploadAndGenerateCaptionApiCaptionUploadPostRaw = function (
    requestParameters,
    initOverrides
  ) {
   ...
   * Upload And Generate Caption
   */
  CaptionUploadApi.prototype.uploadAndGenerateCaptionApiCaptionUploadPost = function (
    requestParameters,
    initOverrides
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.uploadAndGenerateCaptionApiCaptionUploadPostRaw(requestParameters, initOverrides),
            ];
          case 1:
            response = _a.sent();
