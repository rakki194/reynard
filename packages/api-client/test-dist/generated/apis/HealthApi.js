...
var HealthApi = /** @class */ (function (_super) {
     ...
     */
    HealthApi.prototype.detailedHealthCheckApiHealthDetailedGetRaw = function (initOverrides) {
     ...
     * Detailed Health Check
     */
    HealthApi.prototype.detailedHealthCheckApiHealthDetailedGet = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.detailedHealthCheckApiHealthDetailedGetRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Health Check
     */
    HealthApi.prototype.healthCheckApiHealthGetRaw = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Health Check
     */
    HealthApi.prototype.healthCheckApiHealthGet = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.healthCheckApiHealthGetRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
