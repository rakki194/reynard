...
exports.handleApiError = exports.createAuthFetch = void 0;
var createAuthFetch = function (token) {
    return function (url_1) {
        ...
        return __awaiter(void 0, __spreadArray([url_1], args_1, true), void 0, function (url, options) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(url, __assign(__assign({}, options), { headers: __assign(__assign({}, options.headers), { Authorization: "Bearer ".concat(token) }) }))];
            });
        });
    };
};
