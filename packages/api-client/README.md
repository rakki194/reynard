...
// Send emails
await client.email.sendSimpleEmail(
  'user@example.com',
  'Test Subject',
  'Hello from Reynard!'
);
...
*The evergreen system ensures your Reynard API client stays synchronized with your evolving backend, providing a seamless development experience and reducing manual maintenance overhead.*
