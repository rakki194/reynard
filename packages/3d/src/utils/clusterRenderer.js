export class ClusterRenderer {
    constructor(config) {
        ...
        Object.defineProperty(this, "hullMeshes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "textSprites", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    async renderClusters(clusters, onHover) {
    ...
    createConvexHull(cluster, onHover) {
        if (!cluster.points || cluster.points.length < 3 || !this.THREE)
            return;
