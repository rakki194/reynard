 ...
 */
export function applyColorMapping(points, colorMapping) {
    switch (colorMapping) {
        case "similarity":
 ...
 */
export function applySizeMapping(points, sizeMapping, baseSize) {
    switch (sizeMapping) {
        case "importance":
            points.forEach((point) => {
                if (point.importance !== undefined) {
 ...
 */
export function filterPoints(points, config) {
    let filtered = [...points];
 ...
 */
export function generateMaterialCacheKey(config) {
 ...
 */
export function generateGeometryCacheKey(points, config) {
    return JSON.stringify({
