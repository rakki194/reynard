 ...
 */
export function calculatePointColors(points, strategy = "similarity") {
 ...
 */
function calculateSimilarityColor(point) {
    if (point.similarity !== undefined) {
        ...
        const center = [0, 0, 0];
        const distance = Math.sqrt(Math.pow(point.position[0] - center[0], 2) +
 ...
 */
function calculateClusterColor(point) {
    if (point.clusterId) {
 ...
 */
function calculateImportanceColor(point) {
 ...
 */
function calculateConfidenceColor(point) {
