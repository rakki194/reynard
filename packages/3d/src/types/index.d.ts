...
export type EasingType = "linear" | "easeInQuad" | "easeOutQuad" | "easeInOutQuad" | "easeInCubic" | "easeOutCubic" | "easeInOutCubic" | "easeInElastic" | "easeOutElastic" | "easeInOutElastic";
...
export interface PointCloudVisualizationProps extends ThreeJSVisualizationProps {
    ...
    onPointClick?: (point: Point3D, event: any) => void;
    onPointHover?: (point: Point3D | null, event: any) => void;
    onSelectionChange?: (selectedPoints: Point3D[]) => void;
    onSearchIntegrationReady?: (data: any) => void;
}
