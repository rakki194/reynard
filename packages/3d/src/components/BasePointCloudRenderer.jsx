...
export const BasePointCloudRenderer = (props) => {
    ...
    return (<RendererUI props={props} pointCloudRenderer={initialization.pointCloudRenderer} onConfigChange={updateConfiguration}/>);
};
