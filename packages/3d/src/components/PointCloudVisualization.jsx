      ...
      <Show when={!pointCloud.isLoading() && !pointCloud.error()}>
        ...
        <div class="point-cloud-controls">
          ...
          <label class="control-item">
            <Toggle size="sm" checked={instancingEnabled()} onChange={checked => {
          ...
          <label class="control-item">
            <Toggle size="sm" checked={lodEnabled()} onChange={checked => {
          ...
          <label class="control-item">
            <Toggle size="sm" checked={cullingEnabled()} onChange={checked => {
          ...
          <label class="control-item">
            <Toggle size="sm" checked={highlightingEnabled()} onChange={checked => {
          ...
          <div class="point-tooltip point-tooltip-positioned">
            ...
            <Show when={pointCloud.hoveredPoint()?.imageThumbnail || pointCloud.hoveredPoint()?.imageUrl}>
              <div class="tooltip-image">
                <img src={pointCloud.hoveredPoint()?.imageThumbnail || pointCloud.hoveredPoint()?.imageUrl} alt="Point thumbnail" class="tooltip-thumbnail"/>
              </div>
            </Show>
