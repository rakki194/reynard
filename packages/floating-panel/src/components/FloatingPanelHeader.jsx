...
export const FloatingPanelHeader = (props) => {
    return (<div class="floating-panel-header">
      {props.config.draggable ? (<div class="floating-panel-drag-handle">
        ...
        </div>) : (<h3 class="floating-panel-title" id={`panel-title-${props.id}`}>
          Panel {props.id}
        </h3>)}

      {props.config.closable && (<div class="floating-panel-controls">
