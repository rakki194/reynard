...
export const FloatingPanelAdvanced = props => {
    ...
    return (<div ref={panel.ref} class={`floating-panel-advanced theme-${config.theme} ${panel.isDragging() ? "dragging" : ""} ${panel.isResizing() ? "resizing" : ""}`} style={{
            position: "absolute",
      ...
      <div class="floating-panel-content">
        <div class="floating-panel-header">
          ...
          <div class="floating-panel-controls">
            {config.closable && (<button class="floating-panel-control-btn" onClick={handlers.handleHide} title={t("floatingPanel.close")}>
                {getIcon("Dismiss")}
              </button>)}
          </div>
        </div>
