...
export const FloatingPanelOverlay = (props) => {
    ...
    return (<div class={`floating-panel-overlay ${props.isActive ? "active" : ""} ${props.class || ""}`} data-transition-phase={props.transitionPhase || "idle"} tabIndex={-1} onPointerDown={props.onPointerDown} onPointerMove={props.onPointerMove} onPointerUp={props.onPointerUp} onMouseMove={props.onMouseMove} onMouseLeave={props.onMouseLeave} aria-label="Floating panel overlay" aria-hidden={!props.isActive}>
      {props.children}
    </div>);
};
