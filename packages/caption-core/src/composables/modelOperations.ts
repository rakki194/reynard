 ...
 */
export const updateModelLoadingState = (models: ModelInfo[], modelName: string, isLoading: boolean): ModelInfo[] => {
 ...
 */
export const createModelErrorMessage = (operation: string, modelName: string, error: unknown): string => {
