 ...
 */
export declare function useCaptionGeneratorHandlers(state: CaptionGeneratorState, manager: any | null, onCaptionGenerated?: (result: any) => void, onGenerationError?: (error: Error) => void): CaptionGeneratorHandlers;
