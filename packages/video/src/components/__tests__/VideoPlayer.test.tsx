...
describe("VideoPlayer", () => {
  ...
  describe("Video Configuration", () => {
    it("should apply autoplay configuration", () => {
      render(() => <VideoPlayer videoSrc={mockVideoFile} autoplay={true} />);
    ...
    it("should apply loop configuration", () => {
      render(() => <VideoPlayer videoSrc={mockVideoFile} loop={true} />);
    ...
    it("should apply muted configuration", () => {
      render(() => <VideoPlayer videoSrc={mockVideoFile} muted={true} />);
    ...
    it("should apply controls configuration", () => {
      render(() => <VideoPlayer videoSrc={mockVideoFile} controls={true} />);
  ...
  describe("Event Handling", () => {
    it("should call onPlay when video plays", () => {
      const onPlay = vi.fn();
      render(() => <VideoPlayer videoSrc={mockVideoFile} onPlay={onPlay} />);
    ...
    it("should call onPause when video pauses", () => {
      const onPause = vi.fn();
      render(() => <VideoPlayer videoSrc={mockVideoFile} onPause={onPause} />);
  ...
  describe("Error Handling", () => {
    it("should handle video load errors", () => {
      const onError = vi.fn();
      render(() => <VideoPlayer videoSrc={mockVideoFile} onError={onError} />);
