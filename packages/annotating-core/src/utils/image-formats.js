...
export const BASE_IMAGE_FORMATS = {
    ".jpg": {
        extension: ".jpg",
        mimeType: "image/jpeg",
        supported: true,
...
export const PLUGIN_IMAGE_FORMATS = {
    ".jxl": {
        extension: ".jxl",
        mimeType: "image/jxl",
        supported: false,
...
export class ImageFormatUtils {
     ...
     */
    static async updatePluginSupport() {
        try {
            // Check cache first
            const now = Date.now();
            if (this.pluginSupportCache.lastChecked &&
     ...
     */
    static async isSupportedFormat(extension) {
     ...
     */
    static async getFormatInfo(extension) {
        const normalizedExt = extension.toLowerCase();
        // For plugin formats, check runtime availability
        if (normalizedExt in PLUGIN_IMAGE_FORMATS) {
            await this.updatePluginSupport();
     ...
     */
    static async validateImagePath(filePath) {
     ...
     */
    static requiresPlugin(extension) {
     ...
     */
    static supportsTransparency(extension) {
     ...
     */
    static generateFilename(baseName, extension, suffix) {
...
Object.defineProperty(ImageFormatUtils, "pluginSupportCache", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
...
Object.defineProperty(ImageFormatUtils, "CACHE_DURATION", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 5 * 60 * 1000
