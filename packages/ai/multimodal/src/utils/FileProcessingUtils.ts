 ...
 */
export function getTypeColor(fileType: MediaType): string {
 ...
 * @returns Icon name
 */
export function getTypeIcon(fileType: MediaType): string {
 ...
 */
export function getTypeName(fileType: MediaType): string {
 ...
 */
export function supportsThumbnails(fileType: MediaType): boolean {
 ...
 */
export function supportsPreview(fileType: MediaType): boolean {
 ...
 */
export function supportsEditing(fileType: MediaType): boolean {
