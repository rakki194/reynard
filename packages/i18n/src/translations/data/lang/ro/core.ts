...
export const coreTranslations = {
  ...
  security: {
    "at-least-one-character-type-must-be-included":
      "Cel puțin un tip de caracter trebuie inclus",
    "input-contains-potentially-dangerous-html":
      "Intrarea conține HTML potențial periculos",
    "input-contains-potentially-dangerous-sql-patterns":
      "Intrarea conține modele SQL potențial periculoase",
    "input-contains-potentially-dangerous-xss-patterns":
      "Intrarea conține modele XSS potențial periculoase",
    "input-contains-path-traversal-patterns":
      "Intrarea conține modele de traversare a căii",
    "input-contains-windows-reserved-names":
      "Intrarea conține nume rezervate Windows",
    "input-contains-executable-file-extensions":
      "Intrarea conține extensii de fișiere executabile",
    ...
    "input-contains-javascript-file-extensions":
      "Intrarea conține extensii de fișiere JavaScript",
  },
  ...
  async: {
    ...
    "concurrency-must-be-greater-than-0":
      "Concurrența trebuie să fie mai mare decât 0",
  ...
  storage: {
    ...
    "failed-to-parse-json-from-localstorage":
      "Nu s-a putut analiza JSON din localStorage:",
    "error-parsing-storage-event":
      "Eroare la analizarea evenimentului de stocare pentru cheie",
  },
  ...
  integration: {
    ...
    "authentication-and-input-validation-integration":
      "Integrarea autentificării și validării intrării",
