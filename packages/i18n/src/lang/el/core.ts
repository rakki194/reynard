...
export const coreTranslations = {
  ...
  password: {
    ...
    "must-contain-at-least-one-uppercase-letter": "Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον ένα κεφαλαίο γράμμα",
    ...
    "must-contain-at-least-one-special-character": "Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον έναν ειδικό χαρακτήρα",
  },
