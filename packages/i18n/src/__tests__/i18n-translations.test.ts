...
describe('Translation Logic', () => {
  ...
  describe('Translation with Parameters', () => {
    ...
    it('should handle multiple parameters', () => {
      expect(i18n.t('templates.greeting', { name: 'Alice', count: 3 }))
        .toBe('Hello Alice, you have 3 items');
    });

    it('should handle nested parameter access', () => {
      expect(i18n.t('templates.nested', { level: 2, value: 'test' }))
        .toBe('Level 2 with test');
    });
  });
  ...
  describe('Function-based Translations', () => {
    ...
    it('should handle function values with multiple parameters', () => {
      ...
      expect(i18nWithComplex.t('common.complex', { 
        name: 'Bob', 
        count: 7, 
  ...
  describe('Translation Value Helper', () => {
    ...
    it('should interpolate parameters in strings', () => {
      ...
      expect(getTranslationValue(obj, 'template', { name: 'John', count: 5 }))
  ...
  describe('Complex Translation Scenarios', () => {
    it('should handle mixed parameter types', () => {
      ...
      expect(i18nComplex.t('complex.mixed', { 
        name: 'Alice', 
        id: 123, 
        count: 5, 
        amount: 99.99 
    ...
    it('should handle special characters in parameters', () => {
      expect(i18n.t('common.welcome', { name: 'José & María' }))
        .toBe('Welcome, José & María!');
    });
