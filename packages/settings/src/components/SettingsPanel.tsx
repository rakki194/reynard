...
import { Button, TextField, Select, Modal, Tabs } from "@reynard/components";
import type { 
  SettingDefinition, 
  SettingCategory, 
  SettingsSearch,
...
export const SettingsPanel: Component<SettingsPanelProps> = (props) => {
  ...
  // Settings management
  const settings = useSettings({ config: local.config });
  ...
  const settingsByCategory = createMemo(() => {
    const grouped: Record<SettingCategory, SettingDefinition[]> = {} as any;
    ...
    for (const category of Object.keys(grouped)) {
      grouped[category as SettingCategory].sort((a, b) => 
