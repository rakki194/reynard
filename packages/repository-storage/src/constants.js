...
export const DEFAULT_THUMBNAIL_SIZE = [300, 300];
 ...
 */
export function getModalityFromFileType(fileType) {
 ...
 */
export function isFileTypeSupported(extension) {
 ...
 */
export function getExtensionsForModality(modality) {
