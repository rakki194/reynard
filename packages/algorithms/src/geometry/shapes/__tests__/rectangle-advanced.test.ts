...
describe('RectangleAdvanced', () => {
  describe('intersects', () => {
    it('should return true for intersecting rectangles', () => {
      const rect1 = RectangleAdvanced.create ? RectangleAdvanced.create(0, 0, 100, 100) : { x: 0, y: 0, width: 100, height: 100 };
      const rect2 = RectangleAdvanced.create ? RectangleAdvanced.create(50, 50, 100, 100) : { x: 50, y: 50, width: 100, height: 100 };
      expect(RectangleAdvanced.intersects(rect1, rect2)).toBe(true);
    });

    it('should return false for non-intersecting rectangles', () => {
      const rect1 = RectangleAdvanced.create ? RectangleAdvanced.create(0, 0, 50, 50) : { x: 0, y: 0, width: 50, height: 50 };
      const rect2 = RectangleAdvanced.create ? RectangleAdvanced.create(100, 100, 50, 50) : { x: 100, y: 100, width: 50, height: 50 };
  ...
  describe('union', () => {
    it('should return union of two rectangles', () => {
      const rect1 = RectangleAdvanced.create ? RectangleAdvanced.create(0, 0, 50, 50) : { x: 0, y: 0, width: 50, height: 50 };
      const rect2 = RectangleAdvanced.create ? RectangleAdvanced.create(25, 25, 50, 50) : { x: 25, y: 25, width: 50, height: 50 };
  ...
  describe('expand', () => {
    it('should expand rectangle by given amount', () => {
      const rect = RectangleAdvanced.create ? RectangleAdvanced.create(10, 20, 100, 50) : { x: 10, y: 20, width: 100, height: 50 };
  ...
  describe('scale', () => {
    it('should scale rectangle from origin', () => {
      const rect = RectangleAdvanced.create ? RectangleAdvanced.create(0, 0, 100, 50) : { x: 0, y: 0, width: 100, height: 50 };
