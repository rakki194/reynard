/**
 * Geometric Shapes Algorithm Module
 *
 * Comprehensive algorithms for 2D geometric shapes including points, lines,
 * circles, rectangles, and polygons.
 *
 * Features:
 * - Point operations and calculations
 * - Line algorithms and intersections
 * - Circle operations and properties
 * - Rectangle algorithms (basic and advanced)
 * - Polygon operations and transformations
 * - Shape utilities and helpers
 *
 * @module algorithms/geometry/shapes
 */
