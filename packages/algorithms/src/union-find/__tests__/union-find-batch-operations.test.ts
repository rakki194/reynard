...
import { BatchUnionFind, BatchOperation } from '../union-find-batch-operations';
...
describe('BatchUnionFind', () => {
  ...
  it('should perform batch union operations', () => {
    const operations: [number, number][] = [[0, 1], [1, 2], [3, 4]];
  ...
  it('should perform batch connected checks', () => {
    ...
    const pairs: [number, number][] = [[0, 1], [2, 3], [0, 3]];
  ...
  it('should use caching in optimized batch union', () => {
    const operations: [number, number][] = [[0, 1], [0, 1], [1, 2]];
