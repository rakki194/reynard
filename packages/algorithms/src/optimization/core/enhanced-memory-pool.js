...
export class EnhancedMemoryPool {
    constructor(config = {}) {
        Object.defineProperty(this, "spatialHashPool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "unionFindPool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "collisionArrayPool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "processedSetPool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
