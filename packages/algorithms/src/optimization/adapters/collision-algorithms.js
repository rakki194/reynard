 ...
 */
export function createCollisionResult(a, b) {
 ...
 */
export function executeNaiveCollisionDetection(aabbs) {
    const collisions = [];
 ...
 */
export function executeSpatialCollisionDetection(aabbs, memoryPool) {
 ...
 */
export function executeOptimizedCollisionDetection(aabbs, memoryPool) {
