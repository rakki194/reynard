 ...
 */
export function analyzeWorkload(aabbs) {
 ...
 */
export function calculateSpatialDensity(aabbs) {
    if (aabbs.length === 0)
        return 0;
 ...
 */
export function calculateOverlapRatio(aabbs) {
    if (aabbs.length < 2)
        return 0;
    let overlapCount = 0;
    let totalPairs = 0;
 ...
 */
export function analyzeQueryPattern(aabbs) {
    if (aabbs.length < 3)
        return "random";
 ...
 */
export function getAlgorithmRecommendation(characteristics) {
