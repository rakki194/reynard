...
export { AlgorithmSelector, type WorkloadCharacteristics, type AlgorithmSelection } from './core/algorithm-selector';
...
export { OptimizedCollisionAdapter, type OptimizedCollisionConfig, type CollisionPerformanceStats } from './adapters/optimized-collision-adapter';

// Legacy optimizations (from previous implementation)
export { PAWMemoryPool, globalPAWMemoryPool } from './memory-pool';
export { OptimizedSpatialCollisionDetector, createOptimizedCollisionDetector } from './optimized-spatial-collision';
