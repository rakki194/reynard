 ...
 */
export declare const JTP2_CONFIG_SCHEMA: {
    type: string;
    properties: {
        threshold: {
            type: string;
...
export declare const JTP2_DEFAULT_CONFIG: {
    threshold: number;
    force_cpu: boolean;
    batch_size: number;
    max_tags: number;
...
export declare const JTP2_METADATA: {
    name: string;
    description: string;
    version: string;
    caption_type: string;
...
export declare const JTP2_FEATURES: string[];
