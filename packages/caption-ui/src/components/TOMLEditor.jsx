...
export const TOMLEditor = (props) => {
    ...
    return (<div class={`toml-editor ${props.className || ""}`} onKeyDown={handleKeyDown}>
      <div class="editor-header">
        ...
        <div class="editor-actions">
          <button type="button" class="format-button" onClick={() => {
            const formatted = formatTOML(content());
            setContent(formatted);
            props.onChange(formatted);
      ...
      <div class="editor-container">
        <MonacoEditor value={content()} language="ini" // Monaco uses 'ini' for TOML syntax highlighting
     onChange={handleContentChange} onValidate={handleValidation} options={{
            fontSize: 14,
        ...
        }} height={props.height || "400px"} width={props.width || "100%"} theme={props.theme || "light"}/>
      </div>
