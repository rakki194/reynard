...
export function TagBubble(props) {
    ...
    return (<TagBubbleView props={props} isEditing={isEditing} isHovered={isHovered} isFocused={isFocused} tagBubbleRef={tagBubbleRef} inputRef={inputRef} suggestionsList={suggestionsList} autocomplete={autocomplete} handlers={{
            ...handlers,
