 ...
 */
import { CaptionType, splitAndCleanTags } from "reynard-caption-core";
...
export const CaptionInput = props => {
    ...
    const handleTagEdit = (index, newTag) => {
    ...
    return (<div ref={containerRef} class="caption-input" classList={{
      ...
      <div class="caption-editor">
        <div class="caption-input-wrapper">
          <Show when={isTextareaInput()} fallback={<Show when={isTagInput()} fallback={<div class="caption-placeholder">
                ...
                <div class="tags-container">
                  <div class="tags-list">
                    <For each={tags()}>
                      {(tag, index) => (<TagBubble tag={tag} index={index()} onEdit={newTag => handleTagEdit(index(), newTag)} onRemove={() => handleTagRemove(index())} editable={!props.readonly} removable={!props.readonly}/>)}
                    </For>
                  </div>
            ...
            <textarea ref={textareaRef} class="caption-textarea" value={captionContent()} placeholder={props.placeholder || "Enter caption..."} maxLength={props.maxLength} disabled={props.disabled} readonly={props.readonly} onInput={handleTextareaInput} onKeyDown={handleTextareaKeyDown} rows={3}/>
          </Show>

          <div class="caption-icons">
            <Show when={isDirty() && !props.readonly}>
              <button class="caption-icon caption-icon--save" onClick={handleSave} disabled={isSaving()} title="Save caption (Ctrl+S)">
