...
export function createTagBubbleComposables(config) {
    const { props, isEditing, setIsEditing, isHovered, setIsHovered, isFocused, setIsFocused, inputRef, suggestionsList, tagBubbleRef, } = config;
