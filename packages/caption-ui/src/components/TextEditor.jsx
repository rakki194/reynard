 ...
 */
import { getFileExtension } from "reynard-caption-core";
...
export const TextEditor = props => {
    ...
    return (<div class="text-editor-modal">
      <div class="text-editor-content">
        ...
        <div class="text-editor-container">
          <MonacoEditor value={content()} language={getLanguageFromExtension(props.file.name)} onChange={handleContentChange} options={{
            fontSize: 14,
