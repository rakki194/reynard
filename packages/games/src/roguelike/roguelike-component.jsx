...
export const RoguelikeGameComponent = (props) => {
    ...
    return (<div class={`roguelike-game-container ${props.className || ""}`}>
      ...
      <div class="game-canvas-container">
        {isLoading() && (<div class="loading-overlay">
            <div class="loading-spinner"></div>
            <p>Loading dungeon...</p>
          </div>)}

        {error() && (<div class="error-overlay">
        ...
        <canvas ref={canvasRef} class="game-canvas" style={{
