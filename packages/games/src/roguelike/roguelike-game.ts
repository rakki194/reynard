...
export class RoguelikeGame {
    ...
    private createEnemies(): void {
        ...
        const enemyTypes = [
            { char: "g", fg: "#ff0000", bg: "#000000", health: 30, ai: "wander" as const },
            { char: "o", fg: "#ff8800", bg: "#000000", health: 50, ai: "aggressive" as const },
            { char: "T", fg: "#8800ff", bg: "#000000", health: 80, ai: "guard" as const }
        ];
    ...
    private createItems(): void {
        ...
        const itemTypes = [
            { name: "Health Potion", char: "!", fg: "#ff0000", bg: "#000000", type: "potion" as const },
            { name: "Magic Scroll", char: "?", fg: "#00ff00", bg: "#000000", type: "scroll" as const },
            { name: "Gold Coin", char: "$", fg: "#ffff00", bg: "#000000", type: "food" as const },
            { name: "Iron Sword", char: ")", fg: "#888888", bg: "#000000", type: "weapon" as const }
        ];
