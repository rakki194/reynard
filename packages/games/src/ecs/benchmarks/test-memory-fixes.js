 ...
 */
async function testEnhancedMemoryTracker() {
    ...
    try {
        ...
        console.log(`   Peak memory: ${((finalStats.peakMemory - finalStats.initialMemory) / (1024 * 1024)).toFixed(2)} MB`);
 ...
 */
async function testECSBenchmarkMemoryTracking() {
 ...
 */
async function testGarbageCollectionHandling() {
