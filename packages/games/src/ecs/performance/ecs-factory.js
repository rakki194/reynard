...
export class ECSFactory {
    constructor() {
        Object.defineProperty(this, "detectionCache", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
     ...
     */
    async selectBestImplementation(config) {
     ...
     */
    async createImplementation(implementation, config) {
     ...
     */
    logImplementationSuccess(ecs, implementation) {
     ...
     */
    logFallbackSuccess(ecs, failedImplementation) {
...
Object.defineProperty(ECSFactory, "instance", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: null
 ...
 * ```
 */
export const createECSSystem = async (config) => {
 ...
 * ```
 */
export const createTypeScriptECSSystem = async (config) => {
 ...
 * ```
 */
export const createWASMSIMDECSSystem = async (config) => {
 ...
 * ```
 */
export const isWASMSIMDAvailable = async () => {
    const factory = ECSFactory.getInstance();
 ...
 * ```
 */
export const getECSDiagnostics = () => {
    const factory = ECSFactory.getInstance();
