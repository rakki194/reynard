...
describe('Query System', () => {
  ...
  beforeEach(() => {
    ...
    RenderableType = world.getComponentRegistry().register('Renderable', StorageType.Table, () => new Renderable('circle'));
  ...
  describe('Query Filters', () => {
    ...
    it('should filter entities without specific components', () => {
      const query = world.queryFiltered([PositionType], { without: [PlayerType] });
      const results: any[] = [];
    ...
    it('should filter entities with multiple required components', () => {
      const query = world.queryFiltered([PositionType], { with: [EnemyType, VelocityType] });
      const results: any[] = [];
    ...
    it('should filter entities without multiple components', () => {
      const query = world.queryFiltered([PositionType], { without: [EnemyType, BulletType] });
      const results: any[] = [];
    ...
    it('should combine with and without filters', () => {
      const query = world.queryFiltered([PositionType], { with: [VelocityType], without: [PlayerType] });
      const results: any[] = [];
  ...
  describe('Query Iteration', () => {
    ...
    it('should handle empty query results', () => {
      const query = world.queryFiltered([PositionType], { with: [PlayerType, EnemyType] });
      const results: any[] = [];
