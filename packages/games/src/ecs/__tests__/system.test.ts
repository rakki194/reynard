...
describe('System System', () => {
  ...
  describe('System Dependencies', () => {
    ...
    it('should handle complex dependency chains', () => {
      ...
      const systems = {
        input: system((world: World) => { executionOrder.push('input'); }),
        physics: system((world: World) => { executionOrder.push('physics'); }),
        ai: system((world: World) => { executionOrder.push('ai'); }),
        collision: system((world: World) => { executionOrder.push('collision'); }),
        render: system((world: World) => { executionOrder.push('render'); })
      };
  ...
  describe('System Conditions', () => {
    ...
    it('should handle multiple conditions', () => {
      ...
      const conditionalSystem = system((world: World) => {
        executionCount++;
      }).withCondition(condition1).withCondition(condition2);
