  ...
  describe('Shape', () => {
    it('should allow all valid shape types', () => {
      const shapes: Shape[] = [
        ...
        { id: 2, type: 'line', data: { x1: 0, y1: 0, x2: 100, y2: 100 }, color: '#00ff00' },
        { id: 3, type: 'rectangle', data: { x: 0, y: 0, width: 50, height: 30 }, color: '#0000ff' },
        { id: 4, type: 'circle', data: { x: 25, y: 25, radius: 15 }, color: '#ffff00' },
        { id: 5, type: 'polygon', data: { points: [{ x: 0, y: 0 }, { x: 10, y: 0 }, { x: 5, y: 10 }] }, color: '#ff00ff' },
      ];
