...
interface CollisionGameProps {
  config?: GameConfig;
}

export function CollisionGame(props: CollisionGameProps = {}) {
  const [balls, setBalls] = createSignal<Ball[]>([]);
  const [collisions, setCollisions] = createSignal<Collision[]>([]);
