...
export const CodeEditor = (props) => {
    ...
    return (<div class={`code-editor ${props.className || ""}`}>
      <div class="editor-container">
        ...
        <Show when={!error() && !isLoading()} fallback={<div class="loading">Loading...</div>}>
          <div ref={editorContainerRef} class={`monaco-editor-container ${props.height ? "monaco-editor-container--custom-height" : ""} ${props.width ? "monaco-editor-container--custom-width" : ""}`}>
            <MonacoEditor value={props.value || ""} language={getMonacoLanguage(props.language || "javascript")} theme={getMonacoTheme()} onChange={props.onChange} height={props.height} width={props.width} options={reynardMonaco.getMonacoOptions({
