...
export class LanguageDetectionService {
    constructor() {
        Object.defineProperty(this, "isNaturalLanguageDetectionAvailableFlag", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "isProgrammingLanguageDetectionAvailableFlag", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        }); // Always available via file extension
        Object.defineProperty(this, "isLoadingFlag", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
     ...
     */
    async detectNaturalLanguage(text) {
     ...
     */
    detectProgrammingLanguageFromFile(fileName) {
        if (!fileName)
            return "unknown";
