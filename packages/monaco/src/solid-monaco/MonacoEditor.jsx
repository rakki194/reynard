...
export const MonacoEditor = (props) => {
    ...
    return (<div ref={setContainerRef} class={`monaco-editor-wrapper ${props.height ? "monaco-editor-wrapper--custom-height" : ""} ${props.width ? "monaco-editor-wrapper--custom-width" : ""} ${props.className || ""}`} style={{
