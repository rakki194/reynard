 ...
 */
export const getCustomMonacoTheme = (reynardTheme) => {
    switch (reynardTheme) {
        case "strawberry":
 ...
 */
export const registerCustomMonacoTheme = (monaco, reynardTheme) => {
 ...
 */
export const getMonacoThemeName = (reynardTheme) => {
    const customTheme = getCustomMonacoTheme(reynardTheme);
    if (customTheme) {
