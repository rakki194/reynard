...
const LANGUAGE_MAP: Record<string, LanguageInfo> = {
  ...
  markdown: { monacoLanguage: 'markdown', displayName: 'Markdown', isCode: false },
  ...
  ps1: { monacoLanguage: 'powershell', displayName: 'PowerShell', isCode: true },

  // Configuration Files
  dockerfile: { monacoLanguage: 'dockerfile', displayName: 'Dockerfile', isCode: true },
  gitignore: { monacoLanguage: 'plaintext', displayName: 'Git Ignore', isCode: false },
  gitattributes: { monacoLanguage: 'plaintext', displayName: 'Git Attributes', isCode: false },
  dockerignore: { monacoLanguage: 'plaintext', displayName: 'Docker Ignore', isCode: false },
  editorconfig: { monacoLanguage: 'plaintext', displayName: 'EditorConfig', isCode: false },
  eslintrc: { monacoLanguage: 'json', displayName: 'ESLint Config', isCode: true },
  prettierrc: { monacoLanguage: 'json', displayName: 'Prettier Config', isCode: true },
  babelrc: { monacoLanguage: 'json', displayName: 'Babel Config', isCode: true },

  // Package Managers
  'webpack.config.js': { monacoLanguage: 'javascript', displayName: 'Webpack Config', isCode: true },
  'package.json': { monacoLanguage: 'json', displayName: 'Package.json', isCode: true },
  'requirements.txt': { monacoLanguage: 'plaintext', displayName: 'Requirements.txt', isCode: false },
  'setup.py': { monacoLanguage: 'python', displayName: 'Setup.py', isCode: true },
  'pyproject.toml': { monacoLanguage: 'ini', displayName: 'PyProject.toml', isCode: true },
  'cargo.toml': { monacoLanguage: 'ini', displayName: 'Cargo.toml', isCode: true },
  'go.mod': { monacoLanguage: 'go', displayName: 'Go.mod', isCode: true },
  'composer.json': { monacoLanguage: 'json', displayName: 'Composer.json', isCode: true },
  gemfile: { monacoLanguage: 'ruby', displayName: 'Gemfile', isCode: true },
  rakefile: { monacoLanguage: 'ruby', displayName: 'Rakefile', isCode: true },

  // Build Systems
  makefile: { monacoLanguage: 'makefile', displayName: 'Makefile', isCode: true },
  ...
  'build.xml': { monacoLanguage: 'xml', displayName: 'Build.xml', isCode: true },
  ...
  'build.sbt': { monacoLanguage: 'scala', displayName: 'Build.sbt', isCode: true },
  ...
  settings: { monacoLanguage: 'properties', displayName: 'Settings', isCode: true },
  ...
  profile: { monacoLanguage: 'properties', displayName: 'Profile', isCode: true },
  ...
  'tmux.conf': { monacoLanguage: 'shell', displayName: 'Tmux Config', isCode: true },
  screenrc: { monacoLanguage: 'shell', displayName: 'Screen Config', isCode: true },
  ...
  // Plain Text Files
  txt: { monacoLanguage: 'plaintext', displayName: 'Plain Text', isCode: false },
  ...
  properties: { monacoLanguage: 'properties', displayName: 'Properties', isCode: true },
  ...
  // Git Files
  gitmodules: { monacoLanguage: 'plaintext', displayName: 'Git Modules', isCode: false },
  gitconfig: { monacoLanguage: 'ini', displayName: 'Git Config', isCode: true },
  gitkeep: { monacoLanguage: 'plaintext', displayName: 'Git Keep', isCode: false },
};
 ...
 */
export function getDisplayNameFromLanguage(language: string): string {
