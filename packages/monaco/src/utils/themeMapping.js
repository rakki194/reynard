 ...
 */
export const REYNARD_TO_MONACO_THEME_MAP = {
    light: "vs",
    dark: "vs-dark",
    gray: "vs-dark",
    banana: "vs",
 ...
 */
export const REYNARD_TO_SHIKI_THEME_MAP = {
    light: "github-light",
    dark: "github-dark",
    gray: "github-dark",
    banana: "github-light",
 ...
 */
export const getMonacoThemeFromReynard = (reynardTheme) => {
 ...
 */
export const getShikiThemeFromReynard = (reynardTheme) => {
 ...
 */
export const isReynardThemeDark = (reynardTheme) => {
    const darkThemes = [
        "dark",
        "gray",
        "peanut",
 ...
 */
export const getAvailableMonacoThemes = () => {
 ...
 */
export const getAvailableShikiThemes = () => {
