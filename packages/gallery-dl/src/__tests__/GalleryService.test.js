...
describe("GalleryService", () => {
    ...
    describe("downloadGallery", () => {
        it("should download gallery successfully", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/download", expect.objectContaining({
                method: "POST",
                headers: {
    ...
    describe("validateUrl", () => {
        it("should validate URL successfully", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/validate", expect.objectContaining({
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    describe("cancelDownload", () => {
        it("should cancel download successfully", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/download/test-download-123/cancel", expect.objectContaining({
                method: "POST",
            }));
        });
    ...
    describe("batch download methods", () => {
        it("should create batch download", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/batch", expect.objectContaining({
                method: "POST",
        ...
        it("should cancel batch download", async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/batch/batch-123/cancel", expect.objectContaining({
                method: "POST",
            }));
        });
        it("should retry batch download", async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/batch/batch-123/retry", expect.objectContaining({
                method: "POST",
            }));
        });
    });
    describe("AI metadata methods", () => {
        it("should start metadata extraction", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/metadata/extract", expect.objectContaining({
                method: "POST",
                body: JSON.stringify(request),
            }));
        });
        ...
        it("should export metadata results", async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockFetch).toHaveBeenCalledWith("/api/gallery/metadata/export/download-123", expect.objectContaining({
                method: "POST",
            }));
        });
    });
