...
export function AIMetadataExtractor() {
    ...
    return (<div class="ai-metadata-extractor space-y-6">
      ...
      <Card class="p-6">
        ...
        <div class="space-y-4">
          <div>
            ...
            <select value={selectedDownload()} onChange={e => setSelectedDownload(e.currentTarget.value)} class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
          ...
          <div>
            ...
            <select value={contentType()} onChange={e => setContentType(e.currentTarget.value)} class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-2">
              ...
              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractTags()} onChange={e => setExtractTags(e.currentTarget.checked)} class="rounded"/>
                <span class="text-sm">Extract Tags</span>
              </label>

              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractCaptions()} onChange={e => setExtractCaptions(e.currentTarget.checked)} class="rounded"/>
                <span class="text-sm">Generate Captions</span>
              </label>

              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractObjects()} onChange={e => setExtractObjects(e.currentTarget.checked)} class="rounded"/>
                <span class="text-sm">Detect Objects</span>
              </label>

              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractText()} onChange={e => setExtractText(e.currentTarget.checked)} class="rounded"/>
                <span class="text-sm">Extract Text (OCR)</span>
              </label>

              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractColors()} onChange={e => setExtractColors(e.currentTarget.checked)} class="rounded"/>
                <span class="text-sm">Analyze Colors</span>
              </label>

              <label class="flex items-center space-x-2">
                <input type="checkbox" checked={extractEmotions()} onChange={e => setExtractEmotions(e.currentTarget.checked)} class="rounded"/>
          ...
          <div>
            ...
            <textarea value={customPrompts()} onInput={e => setCustomPrompts(e.currentTarget.value)} placeholder="Enter custom analysis prompts..." rows={3} class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
          </div>
        ...
        <Card class="p-6">
          ...
          <div class="space-y-3">
            <For each={extractionJobs}>
              {job => (<div class="border border-gray-200 rounded-lg p-4">
        ...
        <Card class="p-6">
          ...
          <div class="space-y-4">
            <For each={metadataResults}>
              {result => (<div class="border border-gray-200 rounded-lg p-4">
