 ...
 */
export const SPECIAL_MIME_TYPES: Record<string, string> = {
  // LoRA models
 ...
 */
export function getSpecialMimeType(extension: string): string {
 ...
 */
export function isLoRAExtension(extension: string): boolean {
 ...
 */
export function isOCRExtension(extension: string): boolean {
 ...
 */
export function isCaptionExtension(extension: string): boolean {
 ...
 */
export function isMetadataExtension(extension: string): boolean {
