...
async function generateAndVerifyDetailedDiagrams() {
  ...
  try {
    ...
    const verificationResult = await verifier.verifyDiagramAccuracy(
      detailedResult.mermaidContent,
      analysis
    );
    ...
    console.log(`📦 Packages: ${verificationResult.statistics.verifiedPackages}/${verificationResult.statistics.totalPackages}`);
    console.log(`🔗 Dependencies: ${verificationResult.statistics.verifiedDependencies}/${verificationResult.statistics.totalDependencies}`);
    console.log(`📤 Exports: ${verificationResult.statistics.verifiedExports}/${verificationResult.statistics.totalExports}`);
    console.log(`📥 Imports: ${verificationResult.statistics.verifiedImports}/${verificationResult.statistics.totalImports}`);
