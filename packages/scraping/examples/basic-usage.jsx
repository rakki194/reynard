...
export function BasicScrapingExample() {
    ...
    return (<div class="min-h-screen bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center py-6">
            ...
            <div class="flex items-center space-x-4">
              <button onClick={() => setIsFullscreen(!isFullscreen())} class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
      ...
      {/* Quick Start Guide */}
      {!isFullscreen() && (<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
