...
import type { ScrapingJob, ScrapingType } from "reynard-scraping";
import {
  ConfigurationPanel,
  ...
  useContentQuality,
  useScrapingJobs,
  useScrapingStatistics,
} from "reynard-scraping";
...
export function AdvancedScrapingExample() {
  ...
  const handleCustomScrape = async (url: string, type: ScrapingType) => {
    try {
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Enter content to assess quality..."
                  />
                </div>
                <button
                  onClick={handleAssessCustomContent}
