...
export function ConfigurationPanel(props: ConfigurationPanelProps) {
  ...
  const [selectedScraper, setSelectedScraper] = createSignal<ScrapingType>("general");
  ...
  const scraperTypes: ScrapingType[] = [
    "general",
    "hackernews",
    "github",
    "stackoverflow",
  ...
  const getScraperDisplayName = (type: ScrapingType) => {
    const names: Record<ScrapingType, string> = {
  ...
  return (
    <div class={`configuration-panel ${className}`}>
      {/* Header */}
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-3">
          ...
          <button
            ...
            disabled={isLoading()}
            class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Reset
          </button>
          <button
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          <For each={scraperTypes}>
            {type => (
              <button
                onClick={() => setSelectedScraper(type)}
      ...
      {/* Configuration Form */}
      {configs() && configs()[selectedScraper()] && (
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={configs()[selectedScraper()].name}
                    onInput={e => {
                ...
                <div>
                  ...
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      checked={configs()[selectedScraper()].enabled}
                      onChange={e => {
                        const newConfigs = { ...configs() };
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="1000"
                    value={configs()[selectedScraper()].rateLimit.requestsPerMinute}
                    onInput={e => {
                      const newConfigs = { ...configs() };
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="10000"
                    value={configs()[selectedScraper()].rateLimit.requestsPerHour}
                    onInput={e => {
                      const newConfigs = { ...configs() };
            ...
            <div>
              ...
              <div class="space-y-3">
                <div class="flex items-center">
                  <input
                    type="checkbox"
                    checked={configs()[selectedScraper()].extraction.extractImages}
                    onChange={e => {
                      const newConfigs = { ...configs() };
                ...
                <div class="flex items-center">
                  <input
                    type="checkbox"
                    checked={configs()[selectedScraper()].extraction.extractLinks}
                    onChange={e => {
                      const newConfigs = { ...configs() };
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    min="0"
                    max="100"
                    value={configs()[selectedScraper()].quality.minScore}
                    onInput={e => {
                      const newConfigs = { ...configs() };
                ...
                <div>
                  ...
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      checked={configs()[selectedScraper()].quality.enableFiltering}
                      onChange={e => {
                        const newConfigs = { ...configs() };
