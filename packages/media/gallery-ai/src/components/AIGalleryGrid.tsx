    ...
    <div class="ai-gallery-grid">
      ...
      <div class="ai-gallery-grid__items">
        <For each={props.items}>
          {item => (
            <div
              class={`ai-gallery-grid__item ${selectedItems().some(selected => selected.id === item.id) ? "ai-gallery-grid__item--selected" : ""}`}
      ...
      <BatchProcessingDialog
        visible={batchDialog()}
        items={selectedItems().filter(item => item.type !== "folder")}
        availableGenerators={ai.getAvailableGenerators()}
