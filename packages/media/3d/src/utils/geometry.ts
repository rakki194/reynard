 ...
 */
export function createBoundingBox(points: Vector3[]): BoundingBox {
  if (points.length === 0) {
    return {
      min: createVector3(),
      max: createVector3(),
 ...
 */
export function centerBoundingBox(box: BoundingBox): Vector3 {
  return {
 ...
 */
export function sizeBoundingBox(box: BoundingBox): Vector3 {
  return {
