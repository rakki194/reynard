  ...
  const renderBasicSettings = () => (
    <div class="config-section">
      ...
      <div class="config-group">
        ...
        />
        <small>
          Available variables: {"{title}"}, {"{id}"}, {"{date}"}, {"{ext}"}
        </small>
      </div>
      ...
      <Card class="config-card">
        <div class="config-header">
          ...
          <div class="header-actions">
            <Button onClick={saveConfig} disabled={!isDirty() || saveStatus() === "saving"} variant="primary">
        ...
        <div class="config-tabs">
          <Button onClick={() => setActiveTab("basic")} variant={activeTab() === "basic" ? "primary" : "secondary"}>
            <Icon name="Download" />
            Basic
          </Button>
          <Button
        ...
        <div class="config-content">
          <Show when={activeTab() === "basic"}>{renderBasicSettings()}</Show>
          <Show when={activeTab() === "advanced"}>{renderAdvancedSettings()}</Show>
          <Show when={activeTab() === "extractors"}>{renderExtractorSettings()}</Show>
        </div>
      </Card>
    </div>
  );
