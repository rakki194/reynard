    ...
    <div class={`image-grid ${props.class || ""}`}>
      ...
      <Show when={selectedFile()}>
        <ImageViewer
          ...
          onGenerateCaption={() => selectedFile() && handleGenerateCaption(selectedFile()!)}
          isGenerating={props.isGenerating}
        />
      </Show>
    </div>
...
const ImageFileCard = (props: ImageFileCardProps) => {
  ...
  return (
    <div class="image-file-card" classList={{ selected: props.isSelected }} onClick={props.onSelect}>
            ...
            <div class="image-metadata-panel">
              ...
              <div class="metadata-grid">
                ...
                <div class="metadata-item">
                  ...
                  <span class="value">
                    {props.file.size ? (props.file.size / (1024 * 1024)).toFixed(2) + " MB" : "Unknown"}
                  </span>
                </div>
              </div>
            </div>
