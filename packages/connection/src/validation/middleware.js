...
export class ValidationMiddlewareSystem {
     ...
     */
    validate(value, schema, fieldName, data) {
        const context = {
            fieldName,
            schema,
            value,
 ...
 */
export function createCrossFieldMiddleware(validator) {
    return {
 ...
 */
export function createConditionalMiddleware(condition, schema) {
    return {
 ...
 */
export function createSanitizationMiddleware(sanitizer) {
    return {
 ...
 */
export function createBusinessRuleMiddleware(rule) {
    return {
        before: (value, schema, fieldName) => {
