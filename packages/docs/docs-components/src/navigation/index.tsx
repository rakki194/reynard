 ...
 */
export const DocsNav = (props: any) => {
  return (
 ...
 */
export const DocsBreadcrumbs = (props: any) => {
 ...
 */
export const DocsTOC = (props: any) => {
  return (
 ...
 */
export const DocsPagination = (props: any) => {
 ...
 */
export const DocsTabs = (props: any) => {
  return (
 ...
 * Tab panel component
 */
export const DocsTabPanel = (props: any) => {
