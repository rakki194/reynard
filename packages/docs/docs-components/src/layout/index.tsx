 ...
 */
export const DocsFooter = (props: any) => {
  return (
 ...
 */
export const DocsPage = (props: any) => {
  return (
 ...
 */
export const DocsGrid = (props: any) => {
  const style = () => ({
 ...
 */
export const DocsCardGrid = (props: any) => {
  return (
 ...
 */
export const DocsHero = (props: any) => {
  return (
