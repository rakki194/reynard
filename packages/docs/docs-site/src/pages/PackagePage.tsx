  ...
  return (
    <DocsPage>
      ...
      <DocsSection title="Installation">
        <DocsCodeBlock
          code={`npm install ${packageInfo.metadata.name || params.package}`}
          language="bash"
      ...
      <DocsSection title="Features">
        <div class="docs-package-features">
          {<For each={packageInfo.metadata.tags}>{tag => <span class="docs-package-feature">{tag}</span>}</For>}
        </div>
      </DocsSection>

      <DocsSection title="Links">
        <div class="docs-package-links">
          {packageInfo.metadata.homepage && (
            <a href={packageInfo.metadata.homepage} class="docs-package-link">
              Homepage
            </a>
          )}
          ...
          {packageInfo.metadata.bugs?.url && (
            <a href={packageInfo.metadata.bugs.url} class="docs-package-link">
              Report Issues
            </a>
          )}
        </div>
