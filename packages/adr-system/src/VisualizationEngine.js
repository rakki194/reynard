...
export class ADRVisualizationEngine {
     ...
     */
    async generateInteractiveVisualization(nodes, edges, outputPath) {
     ...
     */
    async generateSVGVisualization(nodes, edges, outputPath) {
     ...
     */
    generateRelationshipMatrix(nodes, edges) {
        const matrix = [];
     ...
     */
    generateNetworkStatistics(metrics) {
     ...
     */
    createInteractiveHTML(nodes, edges) {
