...
export class RealTimeArchitectureMonitor extends EventEmitter {
    constructor(codebasePath, monitoringInterval = 30000) {
        super();
        ...
        Object.defineProperty(this, "monitoringTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "modularityChecker", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "dependencyAnalyzer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "interfaceValidator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "typeSafetyCompliance", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "performanceDetector", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    setAlertThreshold(metricName, warning, critical) {
    ...
    async checkThresholdViolations(metrics) {
    ...
    calculateTrends() {
        ...
        for (const [metricName, history] of this.metricsHistory) {
            ...
            if (metricName.includes("modularity") ||
    ...
    async createInitialMetrics(modularityReport, dependencyReport, interfaceReport, typeSafetyReport, performanceReport) {
        const metrics = await this.collectMetrics();
        this.updateMetricsHistory(metrics);
    }
    async discoverFiles() {
    ...
    determineSeverity(analysisResult) {
        if (analysisResult.violations) {
            const criticalViolations = analysisResult.violations.filter((v) => v.severity === "critical").length;
            const highViolations = analysisResult.violations.filter((v) => v.severity === "high").length;
        ...
        if (Array.isArray(analysisResult)) {
            const criticalIssues = analysisResult.filter((issue) => issue.severity === "critical").length;
            const highIssues = analysisResult.filter((issue) => issue.severity === "high").length;
            if (criticalIssues > 0)
                return "critical";
            if (highIssues > 0)
                return "error";
