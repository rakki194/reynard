...
export class ADRKnowledgeGraph {
    constructor(dataPath) {
        ...
        Object.defineProperty(this, "reverseAdjacencyList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
     ...
     */
    findAllPaths(sourceId, targetId, maxDepth = 5) {
        const paths = [];
