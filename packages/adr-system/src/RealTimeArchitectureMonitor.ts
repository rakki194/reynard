...
export class RealTimeArchitectureMonitor extends EventEmitter {
  ...
  private async performInitialAnalysis(): Promise<void> {
    ...
    try {
      ...
      await this.createInitialMetrics(modularityReport, dependencyReport, interfaceReport, typeSafetyReport, performanceReport);
  ...
  private async collectMetrics(): Promise<ArchitectureMetric[]> {
    ...
    try {
      ...
      metrics.push({
        ...
        threshold: this.alertThresholds.get('modularity-compliance') || { warning: 70, critical: 50 },
        metadata: {
      ...
      metrics.push({
        ...
        threshold: this.alertThresholds.get('dependency-health') || { warning: 80, critical: 60 },
        metadata: {
          description: 'Overall dependency health score',
          impact: 'Affects security and maintenance',
          recommendations: ['Update outdated dependencies', 'Fix security vulnerabilities', 'Remove unused dependencies']
        }
      });
      ...
      metrics.push({
        ...
        threshold: this.alertThresholds.get('interface-consistency') || { warning: 85, critical: 70 },
        metadata: {
      ...
      metrics.push({
        ...
        threshold: this.alertThresholds.get('type-safety') || { warning: 90, critical: 75 },
        metadata: {
      ...
      metrics.push({
        ...
        threshold: this.alertThresholds.get('performance-score') || { warning: 80, critical: 60 },
        metadata: {
  ...
  private initializeAlertThresholds(): void {
    this.alertThresholds.set('modularity-compliance', { warning: 70, critical: 50 });
    this.alertThresholds.set('dependency-health', { warning: 80, critical: 60 });
    this.alertThresholds.set('interface-consistency', { warning: 85, critical: 70 });
    this.alertThresholds.set('type-safety', { warning: 90, critical: 75 });
    this.alertThresholds.set('performance-score', { warning: 80, critical: 60 });
  }
