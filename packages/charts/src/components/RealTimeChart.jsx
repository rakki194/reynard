...
export const RealTimeChart = (props) => {
    ...
    return (<div class={`reynard-realtime-chart ${local.class || ""}`}>
      ...
      <Show when={!local.loading && processedData()}>
        <Chart type={local.type} labels={processedData().labels} datasets={processedData().datasets} width={others.width} height={others.height} title={others.title} xAxisLabel={others.xAxisLabel || "Time"} yAxisLabel={others.yAxisLabel || "Value"} showGrid={others.showGrid} showLegend={others.showLegend} useOKLCH={true} colorTheme={local.theme} enablePerformanceMonitoring={local.enablePerformanceMonitoring}/>
      </Show>
