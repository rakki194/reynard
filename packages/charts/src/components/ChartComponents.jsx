...
export const LoadingOverlay = props => (<Show when={props.loading}>
...
export const EmptyState = props => {
    ...
    return (<Show when={!props.loading && isEmpty()}>
      <div class="chart-empty-state chart-empty-state-height">{props.emptyMessage || t("noData")}</div>
    </Show>);
};
export const PerformanceOverlay = props => (<Show when={props.enablePerformanceMonitoring && props.performanceStats && props.performanceStats.activeVisualizations > 0}>
