 ...
 */
function isValidToolRequestBody(body) {
    ...
    return (typeof obj.name === "string" &&
        ...
        ["GET", "POST", "PUT", "DELETE"].includes(obj.method) &&
 ...
 */
export function createGetToolsHandler(service, basePath, enableCORS) {
    return async (req) => {
        try {
 ...
 */
export function createRegisterToolHandler(service, basePath, enableCORS) {
    return async (req) => {
        try {
 ...
 */
export function createUnregisterToolHandler(service, basePath, enableCORS) {
    return async (req) => {
        try {
