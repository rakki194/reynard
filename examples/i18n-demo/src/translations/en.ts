export const enTranslations = {
  ...
  counterDemo: "Counter Demo",
  packageTranslations: "Package Translations",
  ...
  featuresList: {
    ...
    culturalAdaptations: "Cultural adaptations (dates, numbers, currency)",
    packageSpecific: "Package-specific translations",
    fallbackSystem: "Fallback system for missing translations",
  },
} as const;
