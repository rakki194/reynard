  ...
  const components = (): ComponentData[] => [
    {
      ...
      icon: "🎵",
      description: "Converts input tokens to vectors",
      type: "input",
      position: { x: 0, y: 0 },
    },
    {
    ...
    },
    {
      ...
      icon: "🎭",
      description: "Masked self-attention for decoder",
      type: "decoder",
      position: { x: 2, y: 0 },
    },
    {
      ...
      icon: "👀",
      description: "Attention over encoder outputs",
      type: "decoder",
      position: { x: 2, y: 1 },
    },
    {
  ...
  return (
    <div class="animation-card">
      ...
      >
        ...
        {/* Title */}
        <div class="transformer-title">🕺 TRANSFORMER DANCE CLUB 💃</div>
