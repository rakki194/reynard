...
class DatabaseService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "pool_size": self.connection_pool.get("pool_size", 0) if self.connection_pool else 0,
            "max_overflow": self.connection_pool.get("max_overflow", 0) if self.connection_pool else 0
        }
