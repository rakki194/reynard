  ...
  const streamingDemos = [
    {
      ...
      content: "This is a demonstration of **streaming text** that appears character by character. Notice how the text flows naturally with appropriate pauses at punctuation marks and line breaks.",
      ...
      tools: [
        {
          ...
          result: "Found comprehensive documentation for Reynard framework including components, theming, and utilities."
        }
      ]
    }
  ];
                    ...
                    {message.thinking && (
                      <div class="message-thinking">
                        <div class="thinking-indicator">
                          <span innerHTML={getIcon("brain") || ""}></span> {message.thinking}
                        </div>
                      </div>
                    )}
                    {message.tools && (
            ...
            <div class="feature-demo">
              ...
              <div class="streaming-info">
                ...
                <span class="streaming-status">
                  {stream.state().isStreaming ? "Streaming" : 
                   stream.state().isPaused ? "Paused" : 
                   stream.state().isComplete ? "Complete" : "Stopped"}
                </span>
                <span class="progress">
      ...
      <Card class="demo-section">
        ...
        <div class="config-options">
          <div class="config-section">
            ...
            <ul>
              <li><strong>endpoint:</strong> API endpoint for chat messages</li>
              <li><strong>height:</strong> Chat container height</li>
              <li><strong>placeholder:</strong> Input placeholder text</li>
              <li><strong>maxMessages:</strong> Maximum messages to display</li>
            </ul>
          </div>
          ...
          <div class="config-section">
            ...
            <ul>
              <li><strong>enableThinking:</strong> Show thinking indicators</li>
              <li><strong>enableTools:</strong> Enable tool integration</li>
              <li><strong>showTimestamps:</strong> Display message timestamps</li>
              <li><strong>enableMarkdown:</strong> Render markdown content</li>
            </ul>
          </div>
          ...
          <div class="config-section">
            ...
            <ul>
              <li><strong>roomId:</strong> Unique room identifier</li>
              <li><strong>username:</strong> User display name</li>
              <li><strong>enableVideo:</strong> Video call support</li>
              <li><strong>enableAudio:</strong> Audio call support</li>
            </ul>
          </div>
        </div>
      </Card>
