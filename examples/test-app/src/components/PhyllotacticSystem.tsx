...
export const usePhyllotacticSystem = (config: SystemConfig) => {
  console.log("🦊 PhyllotacticSystem: Initializing with config", config);
  ...
  const generatePattern = () => {
    console.log("🦊 PhyllotacticSystem: Generating pattern");
    ...
    console.log("🦊 PhyllotacticSystem: Pattern generated", points.length, "points");
  };
  ...
  const startAnimation = () => {
    console.log("🦊 PhyllotacticSystem: Starting animation");
    setIsRunning(true);
    ...
    animationCore.start({
      ...
      onRender: () => {
        ...
        console.log("🦊 PhyllotacticSystem: Rendering", currentPoints().length, "points");
      },
    });
  };
  ...
  // Stop animation
  const stopAnimation = () => {
    console.log("🦊 PhyllotacticSystem: Stopping animation");
    setIsRunning(false);
    animationCore.stop();
  };
  ...
  const updateConfig = (newConfig: Partial<SystemConfig>) => {
    console.log("🦊 PhyllotacticSystem: Updating config", newConfig);
    ...
    if (newConfig.rotationSpeed !== undefined) {
      stroboscopicEngine.updateConfig({
        rotationSpeed: newConfig.rotationSpeed,
      });
    }
  ...
  // Lifecycle
  onMount(() => {
    console.log("🦊 PhyllotacticSystem: onMount - initializing system");
    generatePattern();
  });

  onCleanup(() => {
    console.log("🦊 PhyllotacticSystem: onCleanup - stopping animation");
    stopAnimation();
  });
