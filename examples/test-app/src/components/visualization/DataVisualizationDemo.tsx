      ...
      <Card class="demo-container">
        ...
        <div class="demo-info">
          <div class="info-section">
            ...
            <ul>
              <li><strong>Shared Data Processing:</strong> Both 2D and 3D visualizations use the same data processing pipeline</li>
              <li><strong>OKLCH Color Management:</strong> Consistent, perceptually uniform colors across all visualizations</li>
              <li><strong>Real-time Clustering:</strong> Automatic K-means clustering with visual cluster representation</li>
              <li><strong>Interactive Controls:</strong> Zoom, pan, and camera controls for both 2D and 3D views</li>
              <li><strong>Performance Optimization:</strong> Efficient rendering with animation engines and LOD</li>
              <li><strong>Modular Architecture:</strong> Reusable components that can be shared between packages</li>
            </ul>
          </div>
          ...
          <div class="info-section">
            ...
            <ul>
              <li><strong>By Value:</strong> Colors based on data point values</li>
              <li><strong>By Cluster:</strong> Colors assigned to clusters using golden angle distribution</li>
              <li><strong>By Category:</strong> Colors based on categorical metadata</li>
              <li><strong>Gradient:</strong> Radial gradient from center based on distance</li>
            </ul>
          </div>
        </div>
      </Card>
