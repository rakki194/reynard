    ...
    <Card class="performance-panel">
      ...
      <div class="performance-info">
        <div class="performance-item">
          ...
          <span class="performance-value">{props.performanceMetrics()?.currentFPS?.toFixed(1) || "0.0"}</span>
        </div>
        <div class="performance-item">
          <span class="performance-label">Frame Time:</span>
          <span class="performance-value">{props.performanceMetrics()?.frameTime?.toFixed(2) || "0.00"}ms</span>
        </div>
        <div class="performance-item">
          <span class="performance-label">Render Time:</span>
          <span class="performance-value">{props.performanceMetrics()?.renderTime?.toFixed(2) || "0.00"}ms</span>
        </div>
      </div>
    </Card>
  );
