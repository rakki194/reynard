...
export function NotificationsDemo() {
  ...
  const notificationTypes = [
    ...
    { type: "warning", label: "Warning", message: "Please review your input before proceeding." },
    { type: "info", label: "Info", message: "Here's some useful information for you." },
  ] as const;
  ...
  const showCustomNotification = () => {
    notify("This is a custom notification with a longer message that demonstrates how notifications can handle more complex content.", "info", {
      duration: autoClose() ? duration() : 0
    });
  };
        ...
        <div class="demo-subsection">
          ...
          <div class="notification-buttons">
            <For each={notificationTypes}>
              {(config) => (
                <Button 
                  variant={config.type === "error" ? "danger" : config.type === "warning" ? "warning" : config.type === "success" ? "success" : "primary"}
