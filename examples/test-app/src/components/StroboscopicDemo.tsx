...
export const StroboscopicDemo: Component = () => {
  ...
  const animate = (deltaTime: number) => {
    ...
    if (stroboscopicState.isStroboscopic) {
      transformedPoints = stroboscopicEngine.applyStroboscopicTransform(points, deltaTime).map((point, index) => ({ ...point, index }));
    }
    ...
    <div class="stroboscopic-demo">
          ...
          <Card class="status-panel">
            ...
            <div class="status-info">
              ...
              <div class="status-item">
                ...
                <span class="status-value">
                  {stroboscopicState()?.stroboscopicPhase?.toFixed(3) || '0.000'}
                </span>
              </div>
              <div class="status-item">
      ...
      <div class="demo-info">
        <Card class="info-panel">
          ...
          <ul>
            <li><strong>Temporal Aliasing:</strong> Mathematical model for stroboscopic effects</li>
            <li><strong>Morphing Effects:</strong> Advanced pattern transformations</li>
            <li><strong>Golden Angle Sync:</strong> 137.5° synchronization for optimal effects</li>
