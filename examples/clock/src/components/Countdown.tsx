...
export const Countdown: Component = () => {
  const { countdown, target, isActive, isCompleted, setTarget, startCountdown, stopCountdown, resetCountdown } =
    useCountdown();

  return (
    <div class="countdown-container">
      <Card class="countdown-card">
        <CountdownDisplay countdown={countdown()} target={target()} isActive={isActive()} isCompleted={isCompleted()} />
