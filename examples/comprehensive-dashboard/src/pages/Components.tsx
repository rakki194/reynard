                ...
                <div>
                  ...
                  <div class="flex flex-wrap gap-4">
                    <Button variant="primary" onClick={() => addNotification({
                      type: 'success',
                      message: t('components.primitives.buttons.clicked', { variant: 'Primary' })
                    })}>
                      {t('components.primitives.buttons.primary')}
                    </Button>
                    <Button variant="secondary" onClick={() => addNotification({
                      type: 'info',
                      message: t('components.primitives.buttons.clicked', { variant: 'Secondary' })
                    })}>
                      {t('components.primitives.buttons.secondary')}
                    </Button>
                    <Button variant="tertiary" onClick={() => addNotification({
                      type: 'info',
                      message: t('components.primitives.buttons.clicked', { variant: 'Tertiary' })
                    })}>
                      {t('components.primitives.buttons.tertiary')}
                    </Button>
                    <Button variant="ghost" onClick={() => addNotification({
                      type: 'info',
                      message: t('components.primitives.buttons.clicked', { variant: 'Ghost' })
                    })}>
                      {t('components.primitives.buttons.ghost')}
                    </Button>
                    <Button variant="danger" onClick={() => addNotification({
                      type: 'warning',
                      message: t('components.primitives.buttons.clicked', { variant: 'Danger' })
                    })}>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
                    ...
                    <Select
                      ...
                      options={[
                        { value: 'option1', label: t('components.primitives.inputs.option1') },
                        { value: 'option2', label: t('components.primitives.inputs.option2') },
                        { value: 'option3', label: t('components.primitives.inputs.option3') }
                      ]}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <DataTable
                    ...
                    onRowClick={(row) => addNotification({
                      type: 'info',
                      message: t('components.data.table.rowClicked', { name: row.name })
                    })}
                  />
                </div>
              </div>
              ...
              <div class="space-y-8">
                <div>
                  ...
                  <div class="max-w-xs">
                    <NavMenu
                      items={navMenuItems}
                      onItemClick={(item) => addNotification({
                        type: 'info',
                        message: t('components.navigation.menu.clicked', { label: item.label })
                      })}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Breadcrumb
                    ...
                    onItemClick={(item) => addNotification({
                      type: 'info',
                      message: t('components.navigation.breadcrumb.clicked', { label: item.label })
                    })}
                  />
                </div>
              </div>
