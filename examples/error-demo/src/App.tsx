          ...
          >
            <div class="demo-grid">
              <div class="demo-card">
                ...
                <p>
                  Comprehensive error boundary system with automatic error classification, 
              ...
              <div class="demo-card">
                ...
                <p>
                  Built-in recovery mechanisms including retry, reset, fallback UI, 
                  redirect, and reload strategies with priority-based execution.
                </p>
                <div class="demo-actions">
              ...
              <div class="demo-card">
                ...
                <p>
                  Automatic error categorization by type (network, rendering, validation, 
                  auth, permission, resource, timeout) and severity levels.
                </p>
                <div class="demo-actions">
              ...
              <div class="demo-card">
                ...
                <p>
                  Highly configurable error boundaries with custom recovery strategies, 
                  error reporting endpoints, and user-defined error handling.
                </p>
                <div class="demo-actions">
            ...
            <Show when={backendStatus() === "disconnected"}>
              <div class="status-message status-error">
                <Warning size={20} />
                <span>Backend disconnected. Error simulation features will not work. Make sure to start the backend server.</span>
              </div>
            </Show>
