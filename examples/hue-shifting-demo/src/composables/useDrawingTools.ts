...
export interface DrawingActions {
  ...
  handleMouseDown: (x: number, y: number, selectedColor: OKLCHColor, drawPixel: (x: number, y: number, color: PixelData) => void) => void;
  handleMouseMove: (x: number, y: number, selectedColor: OKLCHColor, drawPixel: (x: number, y: number, color: PixelData) => void) => void;
  handleMouseUp: () => void;
  handleFill: (x: number, y: number, selectedColor: OKLCHColor, pixels: PixelData[][], drawPixel: (x: number, y: number, color: PixelData) => void) => void;
}
