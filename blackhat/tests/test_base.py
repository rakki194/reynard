...
*splashes with enthusiasm* Base classes and utilities for testing our blackhat security framework!
"""
...
class BlackhatTestBase:
    """
    *otter enthusiasm bubbles* Base class for all blackhat security tests
