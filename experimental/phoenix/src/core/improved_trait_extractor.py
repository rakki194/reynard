...
class ImprovedTraitExtractor:
    ...
    def _initialize_enhanced_trait_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "analytical_thinking": {
                ...
                "semantic_indicators": ["analysis", "evaluation", "assessment", "reasoning", "logic", "systematic"],
                "contextual_cues": ["data", "evidence", "facts", "metrics", "statistics", "patterns"],
                "confidence_boosters": ["thoroughly", "carefully", "systematically", "methodically", "rigorously"],
                "quality_indicators": ["detailed", "comprehensive", "thorough", "rigorous", "precise"],
            ...
            "creative_thinking": {
                ...
                "semantic_indicators": ["creativity", "innovation", "design", "artistry", "imagination", "originality"],
                "contextual_cues": ["ideas", "concepts", "solutions", "approaches", "possibilities", "alternatives"],
                "confidence_boosters": ["brilliant", "inspired", "original", "groundbreaking", "revolutionary"],
                "quality_indicators": ["breakthrough", "cutting-edge", "pioneering", "transformative", "disruptive"],
            ...
            "leadership": {
                ...
                "semantic_indicators": ["leadership", "management", "guidance", "direction", "authority", "influence"],
                "contextual_cues": ["team", "group", "project", "initiative", "organization", "community"],
                "confidence_boosters": ["confidently", "authoritatively", "decisively", "strategically", "visionarily"],
                "quality_indicators": ["transformational", "inspirational", "strategic", "visionary", "charismatic"],
            ...
            "collaboration": {
                ...
                "semantic_indicators": ["collaboration", "cooperation", "teamwork", "partnership", "synergy", "unity"],
                "contextual_cues": ["team", "group", "together", "collective", "shared", "mutual"],
                "confidence_boosters": ["enthusiastically", "willingly", "actively", "positively", "constructively"],
                "quality_indicators": ["seamless", "effective", "productive", "harmonious", "synergistic"],
            ...
            "problem_solving": {
                ...
                "semantic_indicators": ["problem-solving", "troubleshooting", "debugging", "resolution", "optimization"],
                "contextual_cues": ["issue", "problem", "challenge", "obstacle", "difficulty", "complexity"],
                "confidence_boosters": ["effectively", "efficiently", "successfully", "systematically", "creatively"],
                "quality_indicators": ["elegant", "robust", "scalable", "comprehensive", "innovative"],
                "category": TraitCategory.COGNITIVE,
                "priority": "high"
            },
            ...
            "adaptability": {
                ...
                "semantic_indicators": ["adaptability", "flexibility", "versatility", "responsiveness", "resilience"],
                "contextual_cues": ["change", "environment", "circumstances", "requirements", "conditions"],
                "confidence_boosters": ["quickly", "easily", "seamlessly", "naturally", "effortlessly"],
                "quality_indicators": ["seamless", "effortless", "natural", "intuitive", "smooth"],
            ...
            "communication": {
                ...
                "semantic_indicators": ["communication", "explanation", "clarity", "understanding", "dialogue"],
                "contextual_cues": ["message", "information", "ideas", "concepts", "feedback", "response"],
                "confidence_boosters": ["clearly", "effectively", "precisely", "concisely", "persuasively"],
                "quality_indicators": ["crystal-clear", "compelling", "persuasive", "engaging", "inspiring"],
                "category": TraitCategory.SOCIAL,
                "priority": "medium"
            },
            ...
            "technical_expertise": {
                ...
                "semantic_indicators": ["technical", "engineering", "implementation", "optimization", "architecture"],
                "contextual_cues": ["system", "technology", "solution", "implementation", "architecture"],
                "confidence_boosters": ["expertly", "professionally", "systematically", "efficiently", "reliably"],
                "quality_indicators": ["enterprise-grade", "production-ready", "scalable", "robust", "efficient"],
                "category": TraitCategory.COGNITIVE,
                "priority": "high"
            },
            ...
            "emotional_intelligence": {
                ...
                "semantic_indicators": ["empathy", "emotional intelligence", "compassion", "understanding", "support"],
                "contextual_cues": ["emotions", "feelings", "mood", "atmosphere", "relationships", "well-being"],
                "confidence_boosters": ["genuinely", "deeply", "sincerely", "warmly", "compassionately"],
                "quality_indicators": ["profound", "genuine", "authentic", "deep", "meaningful"],
                "category": TraitCategory.SOCIAL,
                "priority": "medium"
            }
        }
    ...
    def extract_traits_from_output(self, agent_output: str, agent_state: AgentState) -> List[SubliminalTrait]:
        ...
        for trait_name, pattern_data in self.trait_inference_patterns.items():
            trait_score = self._calculate_enhanced_trait_score(agent_output, pattern_data)
            ...
            if trait_score > self.quality_thresholds['minimum_strength']:
                trait = SubliminalTrait(
                    ...
                    confidence=self._calculate_enhanced_confidence(agent_output, pattern_data, trait_score)
                )
        ...
        self.logger.info(f"Extracted {len(validated_traits)} high-quality traits from {len(all_traits)} candidates")
        return validated_traits

    def _calculate_enhanced_trait_score(self, text: str, pattern_data: Dict[str, Any]) -> float:
        ...
        # Quality analysis
        quality_score = self._analyze_quality_indicators(text, pattern_data["quality_indicators"])
    ...
    def _analyze_quality_indicators(self, text: str, quality_indicators: List[str]) -> float:
    ...
    def _apply_quality_filtering(self, traits: List[SubliminalTrait]) -> List[SubliminalTrait]:
        """Apply quality-based filtering to traits."""
        # Filter by minimum confidence
        filtered_traits = [t for t in traits if t.confidence >= self.quality_thresholds['minimum_confidence']]

        # Filter by minimum strength
        filtered_traits = [t for t in filtered_traits if t.strength >= self.quality_thresholds['minimum_strength']]
        ...
        for trait in filtered_traits:
            ...
            if category_counts[category] < self.quality_thresholds['maximum_traits_per_category']:
    ...
    def _validate_trait_consistency(self, traits: List[SubliminalTrait]) -> List[SubliminalTrait]:
        ...
        for trait in traits:
            ...
            for other_trait in consistent_traits:
                if self._are_contradictory(trait, other_trait):
                    ...
                    if trait.strength * trait.confidence > other_trait.strength * other_trait.confidence:
    ...
    def _analyze_syntactic_patterns(self, text: str, patterns: List[str]) -> float:
        ...
        return min(1.0, math.sqrt(matches) / math.sqrt(total_patterns)) if total_patterns > 0 else 0.0
    ...
    def _calculate_enhanced_confidence(self, text: str, pattern_data: Dict[str, Any], trait_score: float) -> float:
        ...
        quality_matches = sum(1 for indicator in pattern_data.get("quality_indicators", [])
                            if indicator.lower() in text.lower())
    ...
    def analyze_trait_correlations(self, traits: List[SubliminalTrait]) -> Dict[str, float]:
        ...
        for i, trait1 in enumerate(traits):
            for j, trait2 in enumerate(traits[i+1:], i+1):
                ...
                confidence_correlation = 1.0 - abs(trait1.confidence - trait2.confidence)
    ...
    def calculate_trait_quality_score(self, traits: List[SubliminalTrait]) -> float:
        ...
        quality_score = (avg_strength * 0.4 + avg_confidence * 0.4 + trait_diversity * 0.2)
