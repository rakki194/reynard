...
class MetricsCalculator:
    ...
    def calculate_knowledge_fidelity(
        ...
        if (
            "domain_expertise" in target_knowledge
            and "domain_expertise" in reconstructed_knowledge
        ):
        ...
        if (
            "specializations" in target_knowledge
            and "specializations" in reconstructed_knowledge
        ):
