...
import { PROJECT_ROOT, getBackendDir, getPackagePath } from "./scripts/utils/project-root.js";
...
export default {
  ...
  packages: [
    {
      name: "core",
      path: getPackagePath("core"),
      category: "Core",
      priority: 1,
    },
    {
      name: "components",
      path: getPackagePath("components"),
      category: "UI Components",
      priority: 2,
    },
    {
      name: "themes",
      path: getPackagePath("themes"),
      category: "Styling",
      priority: 3,
    },
    {
      name: "auth",
      path: getPackagePath("auth"),
      category: "Authentication",
      priority: 4,
    },
    {
      name: "charts",
      path: getPackagePath("charts"),
      category: "Data Visualization",
      priority: 5,
    },
    {
      name: "testing",
      path: getPackagePath("testing"),
      category: "Testing",
      priority: 6,
    },
    {
      name: "i18n",
      path: getPackagePath("core/i18n"),
      category: "Internationalization",
      priority: 7,
    },
    {
      name: "3d",
      path: getPackagePath("3d"),
      category: "3D Graphics",
      priority: 8,
    },
    {
      name: "algorithms",
      path: getPackagePath("algorithms"),
      category: "Algorithms",
      priority: 9,
    },
    {
      name: "annotating",
      path: getPackagePath("annotating"),
      category: "Annotation",
      priority: 10,
    },
    {
      name: "boundingbox",
      path: getPackagePath("boundingbox"),
      category: "Computer Vision",
      priority: 11,
    },
    {
      name: "caption",
      path: getPackagePath("ai/caption"),
      category: "Computer Vision",
      priority: 12,
    },
    {
      name: "chat",
      path: getPackagePath("chat"),
      category: "Communication",
      priority: 13,
    },
    {
      name: "colors",
      path: getPackagePath("colors"),
      category: "Media Processing",
      priority: 14,
    },
    {
      name: "composables",
      path: getPackagePath("composables"),
      category: "Core",
      priority: 15,
    },
    {
      name: "connection",
      path: getPackagePath("connection"),
      category: "Networking",
      priority: 16,
    },
    {
      name: "error-boundaries",
      path: getPackagePath("error-boundaries"),
      category: "Error Handling",
      priority: 17,
    },
    {
      name: "features",
      path: getPackagePath("features"),
      category: "Feature Management",
      priority: 18,
    },
    {
      name: "file-processing",
      path: getPackagePath("file-processing"),
      category: "File Processing",
      priority: 19,
    },
    {
      name: "fluent-icons",
      path: getPackagePath("fluent-icons"),
      category: "UI Components",
      priority: 20,
    },
    {
      name: "gallery",
      path: getPackagePath("gallery"),
      category: "Media Display",
      priority: 21,
    },
    {
      name: "games",
      path: getPackagePath("games"),
      category: "Gaming",
      priority: 22,
    },
    {
      name: "model-management",
      path: getPackagePath("model-management"),
      category: "AI/ML",
      priority: 23,
    },
    {
      name: "monaco",
      path: getPackagePath("monaco"),
      category: "Code Editing",
      priority: 24,
    },
    {
      name: "rag",
      path: getPackagePath("rag"),
      category: "AI/ML",
      priority: 25,
    },
    {
      name: "service-manager",
      path: getPackagePath("service-manager"),
      category: "Service Management",
      priority: 26,
    },
    {
      name: "settings",
      path: getPackagePath("settings"),
      category: "Configuration",
      priority: 27,
    },
    {
      name: "tools",
      path: getPackagePath("tools"),
      category: "Development Tools",
      priority: 28,
    },
    {
      name: "ui",
      path: getPackagePath("ui"),
      category: "UI Components",
      priority: 29,
    },
    {
