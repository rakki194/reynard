...
def create_default_categories(db):
    ...
    categories = [
        (
            "AGENT",
            "Agent Tools",
            "Tools for agent management and naming",
            "🤖",
            "#FF6B6B",
            1,
        ),
        ...
        (
            "ECS",
            "ECS World Tools",
            "Entity Component System world simulation tools",
            "🌍",
            "#45B7D1",
            3,
        ),
        (
            "SOCIAL",
            "Social Tools",
            "Tools for agent social interactions",
            "👥",
            "#96CEB4",
            4,
        ),
        ...
        (
            "VISUALIZATION",
            "Visualization Tools",
            "Diagram and image visualization tools",
            "📊",
            "#F7DC6F",
            8,
        ),
        ...
        (
            "VERSION",
            "Version Tools",
            "Version and environment information tools",
            "📋",
            "#F8C471",
            11,
        ),
        (
            "VSCODE",
            "VS Code Tools",
            "VS Code integration and task tools",
            "💻",
            "#82E0AA",
            12,
        ),
        ...
        (
            "MONOLITH",
            "Monolith Detection",
            "Code complexity and monolith detection tools",
            "🏗️",
            "#D7BDE2",
            14,
        ),
        ...
        (
            "RESEARCH",
            "Research Tools",
            "Academic and research paper tools",
            "📚",
            "#AED6F1",
            17,
        ),
    ...
    for name, display_name, description, icon, color, sort_order in categories:
        existing = (
            ...
            .filter(ToolCategory.name == ToolCategoryEnum(name))
            .first()
        )
        if not existing:
...
def create_default_tools(db):
    ...
    tools_data = [
        ...
        (
            ...
            "AGENT",
            "Complete initialization with ECS integration",
        ),
        (
            "get_agent_persona",
            "AGENT",
        ...
        (
            "restart_mcp_server",
            "UTILITY",
            "Restart the MCP server with different methods",
        ),
        # ECS Tools
        ...
        (
            ...
            "ECS",
            "Create offspring agent from two parent agents using ECS",
        ),
        ...
        (
            ...
            "VISUALIZATION",
            "Validate mermaid diagram syntax and check for errors",
        ),
        (
        ...
        (
            ...
            "PLAYWRIGHT",
            "Take screenshots using Playwright browser automation",
        ),
        (
            "playwright_navigate",
            "PLAYWRIGHT",
        ...
        (
            "detect_monoliths",
            "MONOLITH",
            "Detect large monolithic files that violate the 140-line axiom",
        ),
        (
    ...
    for tool_name, category_name, description in tools_data:
        ...
        if not existing:
            category = (
                db.query(ToolCategory)
                .filter(ToolCategory.name == ToolCategoryEnum(category_name))
                .first()
            )
            if category:
                tool = Tool(
