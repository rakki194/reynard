...
from app.services.pdf_processor import pdf_processor, PDF_PROCESSING_ENABLED, MARKER_PACKAGE_ENABLED
...
async def get_processing_status():
    ...
    try:
        status = {
            ...
            "models_initialized": pdf_processor._models_initialized if PDF_PROCESSING_ENABLED else False,
            "converter_available": pdf_processor.models is not None if PDF_PROCESSING_ENABLED else False
        }
...
async def process_research_papers(use_llm: bool = False, max_papers: Optional[int] = None):
    """
