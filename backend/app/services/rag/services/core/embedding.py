...
class EmbeddingService(IEmbeddingService):
    ...
    async def embed_text(
        ...
        try:
            ...
            logger.debug(
                f"Generated embedding for text (length: {len(text)}) in {processing_time:.2f}ms"
            )
            return embedding
    ...
    async def embed_batch(
        ...
        try:
            ...
            tasks = [
                self._generate_embedding_via_ai_service(text, model) for text in texts
            ]
    ...
    async def _generate_embedding_via_ai_service(
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_processing_time_ms": self.metrics.get(
                "average_processing_time_ms", 0.0
            ),
            "total_processing_time_ms": self.metrics.get(
                "total_processing_time_ms", 0.0
            ),
            "ai_service_available": self.ai_service is not None,
