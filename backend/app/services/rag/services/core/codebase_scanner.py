...
class CodebaseScanner:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.excluded_dirs = self.config.get("excluded_dirs", {
            ...
            'logs', 'tmp', 'temp', '.cache', '.parcel-cache'
        })
    ...
    async def scan_codebase(
        ...
        if root_path is None:
            root_path = os.getenv("RAG_CONTINUOUS_INDEXING_WATCH_ROOT", "/home/kade/runeset/reynard")
        ...
        try:
            for root, dirs, files in os.walk(base_path):
                ...
                # Filter directories
                dirs[:] = [d for d in dirs if self._should_scan_directory(root_path_obj / d)]
