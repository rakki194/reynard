...
class ProviderRegistry:
    ...
    async def initialize_all_providers(self, configs: Dict[ProviderType, Dict[str, Any]]) -> bool:
    ...
    def _load_default_configs(self) -> Dict[ProviderType, Dict[str, Any]]:
        ...
        return {
            ...
            ProviderType.VLLM: {
                ...
                "gpu_memory_utilization": float(os.getenv("VLLM_GPU_MEMORY_UTIL", "0.9")),
            },
            ProviderType.SGLANG: {
                "enabled": os.getenv("SGLANG_ENABLED", "false").lower() == "true",
                "base_url": os.getenv("SGLANG_BASE_URL", "http://localhost:30000"),
                "default_model": os.getenv("SGLANG_DEFAULT_MODEL", "llama-3-8b-instruct"),
                "timeout_seconds": int(os.getenv("SGLANG_TIMEOUT", "300")),
                "max_concurrent_requests": int(os.getenv("SGLANG_MAX_CONCURRENT", "10")),
            ...
            ProviderType.LLAMACPP: {
                ...
                "max_concurrent_requests": int(os.getenv("LLAMACPP_MAX_CONCURRENT", "5")),
        ...
        try:
            ...
            for field in required_fields:
                if field not in config:
                    logger.error(f"Missing required field '{field}' for {provider_type}")
                    return False
