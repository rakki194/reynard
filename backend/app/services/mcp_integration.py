...
class MCPIntegration:
    ...
    async def _ensure_initialized(self):
        ...
        try:
            ...
            mcp_server_path = (
                Path(__file__).parent.parent.parent.parent / "services" / "mcp-server"
            )
            ...
            self._tool_config_service = ToolConfigService(
            ...
            count = self._tool_discovery.import_and_register_tools(
                'tools/development/git/git_tool.py'
            )
    ...
    async def list_tools(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for tool_name in all_tools:
                ...
                if tool_metadata and await self._tool_registry.is_tool_enabled(
                    tool_name
                ):
                    tool_def = {
                        "name": tool_name,
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            all_tools = self._tool_registry.list_all_tools()
            enabled_tools = [
                t for t in all_tools if await self._tool_registry.is_tool_enabled(t)
            ]
