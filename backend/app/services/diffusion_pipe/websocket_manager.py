...
class WebSocketManager:
    ...
    def __init__(self):
        ...
        self.training_connections: Dict[str, Set[str]] = (
            {}
        )  # training_id -> connection_ids
        self.connection_counter = 0

    async def connect(
        self, websocket: WebSocket, training_id: Optional[str] = None
    ) -> str:
        ...
        logger.info(
            f"WebSocket connection established: {connection_id} (training: {training_id})"
        )
    ...
    def disconnect(self, connection_id: str):
        ...
        if (
            ...
            and connection.training_id in self.training_connections
        ):
    ...
    async def send_training_status_update(
        self, training_id: str, status: TrainingStatus
    ):
    ...
    async def send_training_log(
        self, training_id: str, log_line: str, level: str = "info"
    ):
