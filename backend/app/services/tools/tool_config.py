...
This provides a single source of truth for tool definitions and configurations.
"""
...
class ToolConfigManager:
    ...
    def __init__(self, config_path: str = "tool_config.json"):
        ...
        self._config: Optional[ToolConfiguration] = None
    ...
    def _create_default_config(self) -> ToolConfiguration:
        """Create default tool configuration with all available tools."""
        tools = {
            # Agent Tools
