...
class AudioProcessor:
    ...
    async def _convert_to_ogg(self, input_path: Path, output_path: Path, quality: str):
        ...
        quality_args = self._compression_levels.get(quality, self._compression_levels["high"])
    ...
    async def concatenate_audio(self, input_paths: list[Path], output_path: Path) -> Path:
