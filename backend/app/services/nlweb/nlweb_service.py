...
class NLWebService:
    ...
    def __init__(self, configuration: Optional[NLWebConfiguration] = None):
        ...
        self.last_ok_timestamp: Optional[datetime] = None
    ...
    async def suggest_tools(self, request: NLWebSuggestionRequest) -> NLWebSuggestionResponse:
        ...
        try:
            ...
            if self.rollback_enabled:
                logger.warning("NLWeb service is in rollback mode - suggestions disabled")
    ...
    async def get_tools(self, category: Optional[str] = None, tags: Optional[List[str]] = None) -> List[NLWebTool]:
    ...
    async def enable_rollback(self, request: NLWebRollbackRequest) -> NLWebRollbackResponse:
        ...
        try:
            ...
            logger.warning(f"NLWeb rollback {'enabled' if request.enable else 'disabled'}: {request.reason}")
    ...
    async def get_verification_checklist(self) -> NLWebVerificationResponse:
        ...
        try:
            ...
            checks.append(NLWebVerificationCheck(
            ...
            if self.configuration.performance_monitoring_enabled:
                ...
                checks.append(NLWebVerificationCheck(
                    ...
                    status="pass" if performance_stats.p95_processing_time_ms <= 1500 else "fail",
                ...
                checks.append(NLWebVerificationCheck(
                    ...
                    status="pass" if performance_stats.cache_hit_rate >= 20 else "fail",
                ...
                checks.append(NLWebVerificationCheck(
                    ...
                    status="pass" if performance_stats.total_requests >= 10 else "warn",
    ...
    async def _register_default_tools(self):
        ...
        try:
            ...
            # Register tools
            tools = [git_status_tool, git_log_tool, list_files_tool, read_file_tool, generate_captions_tool]
