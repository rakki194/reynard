...
class ThreadPoolExecutorManager:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            async with self._lock:
                ...
                logger.info(f"Thread pool executor initialized with {self._config.max_workers} workers")
                return True
    ...
    def _update_stats(self, execution_time: float, success: bool):
        ...
        if total_tasks > 0:
            self._stats.average_execution_time = self._stats.total_execution_time / total_tasks
