...
from .lazy_loading_types import ExportType, ExportValidationLevel, ExportValidationError
...
class LazyLoadingValidator:
    ...
    def validate_export(
        ...
        if validation_level in [ExportValidationLevel.BASIC, ExportValidationLevel.STRICT, ExportValidationLevel.COMPREHENSIVE]:
        ...
        if validation_level in [ExportValidationLevel.STRICT, ExportValidationLevel.COMPREHENSIVE]:
