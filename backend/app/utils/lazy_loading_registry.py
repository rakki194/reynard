...
def get_lazy_export(package_name: str) -> Optional[LazyPackageExport]:
    """
...
ml_packages = {
    ...
    "transformers": create_lazy_export("transformers", "transformers", ExportType.MODULE),
...
class LazyLoadingSystem:
    ...
    def get_export(self, package_name: str) -> Optional[LazyPackageExport]:
        """Get a lazy export by package name."""
    ...
    def get_system_stats(self) -> Dict[str, any]:
        ...
        loaded_exports = sum(1 for export in self._exports.values() if export.is_loaded())
...
_lazy_loading_system: Optional[LazyLoadingSystem] = None
