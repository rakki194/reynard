...
class GenderComponent(Component):
    ...
    def __init__(self, profile: GenderProfile) -> None:
        ...
        self.expression_confidence: float = 1.0  # Confidence in gender expression (0.0 to 1.0)
        ...
        self.social_comfort: float = 1.0  # Comfort with gender expression in social settings (0.0 to 1.0)
        self.transition_stage: Optional[str] = None  # Current transition stage if applicable
