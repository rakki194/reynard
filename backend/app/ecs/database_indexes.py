...
class ECSDatabaseIndexes:
        ...
        with SessionLocal() as session:
            for index in self.indexes:
                try:
                    ...
                    logger.info(f"Created index {index['name']} on {index['table']}({', '.join(index['columns'])})")
    ...
    def optimize_database(self) -> dict:
        ...
        # Tables to optimize
        tables = [
            'agents', 'agent_traits', 'agent_relationships', 
            'agent_interactions', 'agent_positions', 'agent_memories',
            'naming_spirits', 'naming_components', 'naming_config'
        ]
