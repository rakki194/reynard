...
"""
    ...
    def test_parser_initialization_with_existing_parser(self, temp_changelog):
        ...
        with patch('legacy_tracking.unified_parser.ChangelogParser') as mock_parser_class:
    ...
    def test_parse_success_advisor_8_activities_with_existing_parser(self, temp_changelog):
        ...
        with patch('legacy_tracking.unified_parser.ChangelogParser') as mock_parser_class:
            ...
            assert activities[0].description == "Success-Advisor-8 feature implementation"
    ...
    def test_parse_success_advisor_8_activities_fallback(self, temp_changelog):
        ...
        with patch('legacy_tracking.unified_parser.ChangelogParser', None):
            ...
            assert all("Success-Advisor-8" in activity.description for activity in activities)
    ...
    def test_classify_activity_type(self, temp_changelog):
        ...
        assert parser._classify_activity_type("Quality assurance improvements") == "other"
