...
class Agent(Base):
    ...
    interactions_sent = relationship(
        "AgentInteraction",
...
class PersonalityTrait(Base):
    ...
    __table_args__ = (
        UniqueConstraint("agent_id", "trait_name", name="uq_agent_personality_trait"),
    )
...
class PhysicalTrait(Base):
    ...
    __table_args__ = (
        UniqueConstraint("agent_id", "trait_name", name="uq_agent_physical_trait"),
    )
...
class AbilityTrait(Base):
    ...
    __table_args__ = (
        UniqueConstraint("agent_id", "trait_name", name="uq_agent_ability_trait"),
    )
...
class AgentSpecialization(Base):
    ...
    __table_args__ = (
        UniqueConstraint("agent_id", "specialization", name="uq_agent_specialization"),
    )
...
class PerformanceMetric(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"<PerformanceMetric(name='{self.metric_name}', value={self.metric_value})>"
        )
