...
from .middleware import memory_profiler, performance_tracker
...
async def get_endpoint_details(endpoint: str):
    ...
    try:
        ...
        if recent_metrics:
            ...
            stats_details = {
                ...
                "response_time_stats": {
                    ...
                    "std_dev_ms": (
                        round(statistics.stdev(response_times) * 1000, 2)
            ...
            for metric in recent_metrics:
                ...
                stats_details["error_analysis"]["status_codes"][status_code] = (
                    stats_details["error_analysis"]["status_codes"].get(status_code, 0)
                    + 1
                )
        else:
            stats_details = {
        ...
        result = {**stats, **stats_details, "timestamp": datetime.now().isoformat()}
        ...
        return JSONResponse(
            content={
                ...
                "recommendations": (
                    ...
                    if critical_bottlenecks > 0 or high_bottlenecks > 0
                    else [
