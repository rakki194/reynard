...
class PerformanceTracker:
    ...
    def start_request(self, request_id: str, endpoint: str, method: str) -> PerformanceMetrics:
    ...
    def add_async_task(self, task_name: str, duration: float, 
...
class PerformanceMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        ...
        try:
            ...
            # End tracking
            performance_tracker.end_request(request_id, metrics.status_code, metrics.error_message)
...
def track_db_query(query: str, parameters: Optional[Dict[str, Any]] = None,
                  rows_affected: Optional[int] = None):
        ...
        if asyncio.iscoroutinefunction(func):
            async def async_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    duration = time.time() - start_time
                    performance_tracker.add_db_query(query, duration, parameters, rows_affected)
                    return result
                except Exception as e:
                    duration = time.time() - start_time
...
class MemoryProfiler:
    ...
    def get_memory_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_memory_percent": sum(percent_values) / len(percent_values) if percent_values else 0,
