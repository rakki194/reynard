...
class PrivacyControls:
    ...
    def grant_consent(self, 
        ...
        # Log privacy event
        self._log_privacy_event("consent_granted", {
            "consent_type": consent_type.value,
            "method": consent_method,
            "version": consent_version
        })
    ...
    def revoke_consent(self, consent_type: ConsentType):
        ...
        if consent_type in self.consents:
            ...
            if consent_record.is_active():
                ...
                # Log privacy event
                self._log_privacy_event("consent_revoked", {
                    "consent_type": consent_type.value
                })
    ...
    def get_active_consents(self) -> List[ConsentType]:
        ...
        return [consent_type for consent_type, record in self.consents.items() 
                if record.is_active()]
    ...
    def set_data_right(self, right: DataRight, enabled: bool):
        ...
        # Log privacy event
        self._log_privacy_event("data_right_updated", {
            "right": right.value,
            "enabled": enabled
        })
    ...
    def set_anonymization_level(self, level: PrivacyLevel):
        ...
        # Log privacy event
        self._log_privacy_event("anonymization_level_changed", {
            "old_level": self.anonymization_level.value,
    ...
    def set_data_retention(self, days: int, auto_deletion: bool = False):
        ...
        # Log privacy event
        self._log_privacy_event("retention_updated", {
            "retention_days": days,
    ...
    def get_privacy_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_consents": [consent.value for consent in self.get_active_consents()],
            "data_rights": {right.value: enabled for right, enabled in self.data_rights.items()},
            "compliance": {
