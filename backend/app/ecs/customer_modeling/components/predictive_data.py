...
class PredictiveData:
    ...
    def is_high_value_customer(self) -> bool:
        ...
        return (self.value_tier in [ValueTier.HIGH, ValueTier.PREMIUM] and
                self.lifetime_value > 5000 and
                self.retention_score() > 0.7)
    
    def is_at_risk_customer(self) -> bool:
        """Check if customer is at risk of churning."""
        return (self.churn_probability > 0.6 or
