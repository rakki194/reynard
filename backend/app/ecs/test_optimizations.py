...
from .validation import (
    ...
    ValidatedAgentCreateRequest, validate_endpoint_inputs
)
from .redis_cache import get_ecs_cache, cache_naming_spirits
...
async def test_input_validation():
    ...
    print(f"   Invalid spirits rejected: {invalid_spirit_count}/{len(invalid_spirits)} ✅")
...
async def main():
    ...
    total_score = index_score + validation_score + cache_score + monitoring_score + integration_score
