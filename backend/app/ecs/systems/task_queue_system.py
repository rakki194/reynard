...
class TaskQueueSystem(System):
    ...
    def _find_related_systems(self) -> None:
        ...
        for system in self.world.systems:
            if hasattr(system, '__class__') and 'Interaction' in system.__class__.__name__:
    ...
    async def _handle_validation_task(self, parameters: dict[str, Any]) -> Any:
        ...
        if validation_type == "basic":
            ...
            return {"valid": is_valid, "message": f"Email validation: {'passed' if is_valid else 'failed'}"}
        else:
    ...
    def get_system_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "task_manager_stats": self.task_manager.get_queue_statistics() if self.initialized else {},
            "related_systems": {
