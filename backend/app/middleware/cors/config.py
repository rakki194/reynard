...
class CORSConfig(BaseModel):
    ...
    max_age: int = Field(
        default=3600, description="Maximum age for preflight requests in seconds"
    )
    ...
    strict_origin_validation: bool = Field(
        default=True, description="Enable strict origin validation"
    )
    ...
    def validate_environment(cls, v):
        ...
        valid_envs = ['development', 'staging', 'production', 'testing', 'e2e-testing']
