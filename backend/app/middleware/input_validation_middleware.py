...
class InputValidationMiddleware(BaseHTTPMiddleware):
    ...
    def _validate_dict_recursive(self, data: Union[Dict, list, str, Any], field_prefix: str):
        ...
        if isinstance(data, dict):
            ...
            if any(auth_field in field_prefix.lower() for auth_field in ["username", "email", "password"]):
