...
class SecurityHeadersMiddleware(BaseMiddleware):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.config = config
        self.environment = kwargs.get('environment', os.getenv('ENVIRONMENT', 'development'))
    ...
    def _add_security_headers(self, request: Request, response: Response) -> None:
        ...
        self.logger.debug(f"Added security headers to {request.method} {request.url.path}")
...
def setup_security_headers_middleware(
    ...
    **config_kwargs
    ...
    Args:
        ...
        **config_kwargs: Additional configuration parameters
    """
    security_middleware = create_security_headers_middleware(app, environment, **config_kwargs)
    ...
    logger.info(f"Security headers middleware setup complete for {environment} environment")
