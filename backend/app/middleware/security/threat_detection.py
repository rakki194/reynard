...
class ThreatDetectionMiddleware(BaseMiddleware):
    ...
    def __init__(self, app: Callable, name: str = "threat_detection", **kwargs):
    ...
    def _log_threat(self, request: Request, threat_level: int) -> None:
        ...
        threat_types = {1: 'LOW', 2: 'MEDIUM', 3: 'HIGH', 4: 'CRITICAL', 5: 'SEVERE'}
    ...
    def _add_threat_headers(
        self, request: Request, response: Response, threat_level: int
    ) -> None:
...
def create_threat_detection_middleware(
    app: Callable, enabled: bool = True, **kwargs
