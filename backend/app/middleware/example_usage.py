...
def example_custom_config():
    ...
    setup_middleware(app, environment="development", rate_limit=50, rate_window=30)
...
def example_production_setup():
    ...
    setup_middleware(app, environment="production", rate_limit=100, rate_window=60)
...
def example_testing_setup():
    ...
    setup_middleware(app, environment="testing", rate_limit=1000, rate_window=60)
