...
class MCPAuthService:
    ...
    def _initialize_default_clients(self):
        ...
        default_clients = [
            MCPClient(
                ...
                permissions=["rag:query", "rag:stats", "rag:config", "embed:text", "mcp:admin"]
            ),
            MCPClient(
            ...
            MCPClient(
                ...
                permissions=["rag:query", "rag:stats", "embed:text", "rag:ingest", "mcp:admin"]
            )
        ]
    ...
    def generate_mcp_token(self, client_id: str, additional_permissions: List[str] = None) -> str:
        """
        ...
        logger.info(f"Generated MCP token for client '{client_id}' with {len(permissions)} permissions")
        return token
    ...
    def check_permission(self, token_data: MCPTokenData, required_permission: str) -> bool:
        """
