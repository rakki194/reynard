...
class CoquiBackend(TTSBackend):
    ...
    def __init__(self):
        ...
        self._available_voices = [
            {"name": "default", "language": "en", "gender": "female", "description": "Default voice"},
            {"name": "male", "language": "en", "gender": "male", "description": "Male voice"},
            {"name": "female", "language": "en", "gender": "female", "description": "Female voice"},
        ]
        self._supported_languages = ["en", "es", "fr", "de", "it", "pt", "ru", "zh", "ja", "ko"]
