...
class ModelCoordinator:
    ...
    def should_load_model(self, generator_name: str, *, is_batch: bool, batch_size: int = 0) -> bool:
    ...
    async def get_or_load_model(self, generator_name: str) -> Optional[CaptionGenerator]:
