...
def upgrade() -> None:
    ...
    ssh_key_type_enum = postgresql.ENUM(
        'rsa', 'ed25519', 'ecdsa', 'dsa', name='sshkeytype', create_type=False
    )
    ...
    op.create_index(
        op.f('ix_ssh_keys_fingerprint'), 'ssh_keys', ['fingerprint'], unique=False
    )
    op.create_index(
        op.f('ix_ssh_keys_is_primary'), 'ssh_keys', ['is_primary'], unique=False
    )
    op.create_index(
        op.f('ix_ssh_keys_is_revoked'), 'ssh_keys', ['is_revoked'], unique=False
    )
    op.create_index(op.f('ix_ssh_keys_key_id'), 'ssh_keys', ['key_id'], unique=False)
    op.create_index(
        op.f('ix_ssh_keys_public_key_hash'),
        'ssh_keys',
        ['public_key_hash'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_ssh_key_access_logs_key_id'),
        'ssh_key_access_logs',
        ['key_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_ssh_key_access_logs_operation'),
        'ssh_key_access_logs',
        ['operation'],
        unique=False,
    )
    op.create_index(
        op.f('ix_ssh_key_access_logs_success'),
        'ssh_key_access_logs',
        ['success'],
        unique=False,
    )
    op.create_index(
        op.f('ix_ssh_key_access_logs_user_id'),
        'ssh_key_access_logs',
        ['user_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_ssh_key_rotation_logs_new_key_id'),
        'ssh_key_rotation_logs',
        ['new_key_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_ssh_key_rotation_logs_old_key_id'),
        'ssh_key_rotation_logs',
        ['old_key_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_ssh_key_rotation_logs_user_id'),
        'ssh_key_rotation_logs',
        ['user_id'],
        unique=False,
    )
