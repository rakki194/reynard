...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_pgp_keys_fingerprint'), 'pgp_keys', ['fingerprint'], unique=False)
    op.create_index(op.f('ix_pgp_keys_is_primary'), 'pgp_keys', ['is_primary'], unique=False)
    op.create_index(op.f('ix_pgp_keys_is_revoked'), 'pgp_keys', ['is_revoked'], unique=False)
    op.create_index(op.f('ix_pgp_keys_key_id'), 'pgp_keys', ['key_id'], unique=False)
    op.create_index(op.f('ix_pgp_keys_short_fingerprint'), 'pgp_keys', ['short_fingerprint'], unique=False)
    ...
    op.create_index(op.f('ix_pgp_key_access_logs_key_id'), 'pgp_key_access_logs', ['key_id'], unique=False)
    op.create_index(op.f('ix_pgp_key_access_logs_operation'), 'pgp_key_access_logs', ['operation'], unique=False)
    op.create_index(op.f('ix_pgp_key_access_logs_success'), 'pgp_key_access_logs', ['success'], unique=False)
    op.create_index(op.f('ix_pgp_key_access_logs_user_id'), 'pgp_key_access_logs', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_pgp_key_rotation_logs_new_key_id'), 'pgp_key_rotation_logs', ['new_key_id'], unique=False)
    op.create_index(op.f('ix_pgp_key_rotation_logs_old_key_id'), 'pgp_key_rotation_logs', ['old_key_id'], unique=False)
    op.create_index(op.f('ix_pgp_key_rotation_logs_user_id'), 'pgp_key_rotation_logs', ['user_id'], unique=False)
