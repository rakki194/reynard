...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_tool_configuration_id'), 'tool_configuration', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_tool_config_history_id'), 'tool_config_history', ['id'], unique=False)
    ...
    op.create_table('note_collaborations',
    sa.Column('id', sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Column('user_metadata', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
