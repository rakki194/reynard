...
def upgrade() -> None:
    ...
    naming_components = sa.table('naming_components',
    ...
    naming_config = sa.table('naming_config',
        sa.column('id', sa.UUID),
    ...
    components_data = [
        {
            ...
            'enabled': True,
            'weight': 1.0,
            'component_metadata': {'style': 'foundation', 'description': 'Strategic, intellectual suffixes'},
            'created_at': now,
            'updated_at': now
        },
        {
            ...
            'enabled': True,
            'weight': 1.0,
            'component_metadata': {'style': 'exo', 'description': 'Combat/technical operational names'},
            'created_at': now,
            'updated_at': now
        },
        {
            ...
            'enabled': True,
            'weight': 1.0,
            'component_metadata': {'style': 'hybrid', 'description': 'Mythological/historical references'},
            'created_at': now,
            'updated_at': now
        }
    ]
    ...
    config_data = [
        ...
        },
        {
            ...
            'config_value': {'fox': [3, 7, 13, 21, 34, 55, 89], 'wolf': [8, 16, 24, 32, 40, 48, 56]},
