...
def upgrade() -> None:
    ...
    op.create_table('ability_traits',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_table('agent_domain_expertise',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('agent_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['agent_id'], ['agents.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('agent_id', 'specialization', name='uq_agent_specialization')
    )
    op.create_table('agent_workflow_preferences',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('agent_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['agent_id'], ['agents.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('agent_id', 'preference_name', name='uq_agent_workflow_preference')
    )
    ...
    sa.ForeignKeyConstraint(['agent_id'], ['agents.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('agent_id', 'trait_name', name='uq_agent_personality_trait')
    )
    op.create_table('physical_traits',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('agent_id', sa.UUID(), nullable=False),
    sa.Column('trait_name', sa.String(length=100), nullable=False),
    sa.Column('trait_value', sa.Float(), nullable=False),
