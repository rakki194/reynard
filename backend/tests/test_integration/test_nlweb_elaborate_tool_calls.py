...
from app.services.nlweb.models import NLWebContext, NLWebSuggestionRequest
from app.services.ollama.models import OllamaAssistantParams, OllamaChatParams
...
class TestElaborateNLWebToolCalls:
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "analysis_type": {
                                ...
                                "items": {
                                    "type": "string",
                                    "enum": ["complexity", "patterns", "quality", "security", "performance"]
                                },
                                "description": "Types of analysis to perform"
                            },
                            "language": {
                                "type": "string",
                                "enum": ["python", "javascript", "typescript", "java", "cpp", "auto"],
                                "default": "auto",
                        ...
                        "properties": {
                            ...
                            "filters": {
                                ...
                                "properties": {
                                    ...
                                    "site": {"type": "string", "description": "Specific site to search within"},
                                    "exclude_sites": {
                                        "type": "array",
                                        "items": {"type": "string"},
                            ...
                            "operations": {
                                ...
                                "items": {
                                    ...
                                    "properties": {
                                        "type": {
                                            "type": "string",
                                            "enum": ["filter", "aggregate", "transform", "analyze", "visualize"]
                                        },
                                        "parameters": {
                                            "type": "object",
    ...
    def test_elaborate_tool_suggestion_workflow(self, client, auth_headers, elaborate_tools):
    ...
    @pytest.mark.asyncio
    async def test_elaborate_ollama_tool_calling_workflow(self, async_client, auth_headers, elaborate_tools):
    ...
    def test_multi_tool_workflow_suggestion(self, client, auth_headers, elaborate_tools):
        ...
        with patch('app.api.nlweb.endpoints.get_nlweb_service') as mock_service:
            ...
            mock_workflow_suggestions = [
                {
                    "tool": {
                        ...
                        "examples": ["search for latest Python best practices", "find security vulnerabilities in web apps"]
                    },
                    "score": 92.0,
                    "parameters": {
                ...
                },
                {
                    "tool": {
                        ...
                        "method": "POST",
                        "parameters": elaborate_tools[1]["function"]["parameters"],
                        "examples": ["analyze code complexity and quality", "find security vulnerabilities"]
                    },
                    "score": 89.0,
                    "parameters": {
                ...
                },
                {
                    "tool": {
                        ...
                        "examples": ["analyze security scan results", "process code quality metrics"]
                    },
                    "score": 85.0,
                    "parameters": {
            ...
            request_data = {
                ...
                "context": {
                    ...
                    "security_concerns": ["authentication", "data_validation", "injection_attacks"],
    ...
    @pytest.mark.asyncio
    async def test_streaming_elaborate_tool_execution(self, async_client, auth_headers, elaborate_tools):
        ...
        with patch('app.api.ollama.endpoints.get_ollama_service') as mock_service:
            ...
            mock_ollama_service.chat_stream.return_value = mock_streaming_tool_execution()
            mock_service.return_value = mock_ollama_service
            ...
            request_data = {
                ...
                "context": {
                    "current_path": "/home/user/project",
                    "data_file": "data.csv",
                    "analysis_requirements": ["statistical_summary", "data_transformation", "methodology_research"],
                    "user_preferences": {
                        "show_progress": True,
    ...
    def test_error_handling_in_elaborate_tool_calls(self, client, auth_headers, elaborate_tools):
