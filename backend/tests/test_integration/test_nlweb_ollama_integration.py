...
class TestNLWebOllamaIntegration:
    ...
    def test_ollama_chat_with_nlweb_tools(self, client: TestClient, access_token):
        ...
        with (
            ...
            mock_ollama.chat_stream.return_value = mock_chat_stream(
                OllamaChatParams(
    ...
    def test_ollama_assistant_with_nlweb_integration(
        ...
        with (
            ...
            mock_ollama.assistant_stream.return_value = mock_assistant_stream(
    ...
    async def test_nlweb_verification_with_ollama_check(
        ...
        with (
            ...
            mock_nlweb.get_verification_checklist.return_value = (
                mock_verification_response
            )
            mock_nlweb_service.return_value = mock_nlweb
            ...
            ollama_check = next(
                (
                    ...
                    if check["name"] == "ollama_integration"
                ),
                None,
            )
            ...
            models_check = next(
                (check for check in data["checks"] if check["name"] == "ollama_models"),
                None,
            )
    ...
    def test_error_handling_ollama_unavailable(self, client: TestClient, access_token):
        ...
        with (
            ...
            request_data = {
                ...
                "context": {
                    "current_path": "/home/user",
                    "user_preferences": {"preferred_llm": "ollama"},
                },
            }
