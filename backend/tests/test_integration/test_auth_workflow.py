...
class TestCompleteAuthWorkflow:
    ...
    def test_multiple_user_registration_and_login(self, client: TestClient, clean_databases):
    ...
    def test_concurrent_user_operations(self, client: TestClient, clean_databases):
        ...
        # Check results
        assert len(results) == 5  # All users should be successfully registered and logged in
