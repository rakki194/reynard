...
class TestNLWebPerformance:
    ...
    @pytest.mark.asyncio
    async def test_ask_endpoint_streaming_performance(self, async_client: AsyncClient, access_token):
        ...
        with patch('app.api.nlweb.endpoints.get_nlweb_service') as mock_service:
            ...
            for i in range(100):
                ...
                if i % 10 == 0 and i > 0:
                    ...
                    assert avg_time < 0.5  # Average response time should stay under 500ms
