...
class TestGlobalExecutor:
    ...
    def test_get_global_executor_creates_new_instance(self):
        ...
        with patch('app.utils.executor.ThreadPoolExecutorManager') as mock_manager_class:
    ...
    async def test_execute_in_thread_pool_success(self):
        ...
        with patch('app.utils.executor.get_global_executor', return_value=mock_executor):
            def test_func(x, y):
                return x + y
    ...
    async def test_execute_in_thread_pool_with_kwargs(self):
        ...
        with patch('app.utils.executor.get_global_executor', return_value=mock_executor):
            ...
            assert result == "test_result"
            mock_executor.execute.assert_called_once_with(test_func, 1, 2, timeout=10.0, z=3)
