...
class TestCORSMiddleware:
    ...
    async def test_dispatch_preflight_request(self):
        ...
        # Mock validator
        middleware.validator.validate_preflight_request = AsyncMock(return_value=(True, None))
    ...
    async def test_dispatch_actual_request(self):
        ...
        # Mock validator
        middleware.validator.validate_actual_request = AsyncMock(return_value=(True, None))
    ...
    def test_is_origin_allowed(self):
        ...
        middleware.validator.validate_origin.assert_called_once_with("http://localhost:3000")
    ...
    def test_get_allowed_origins(self):
        ...
        # Mock config method
        middleware.config.get_effective_origins = Mock(return_value=["http://localhost:3000"])
    ...
    def test_get_validation_summary(self):
        ...
        request = Mock(spec=Request)
        middleware.validator.get_validation_summary = Mock(return_value={"test": "summary"})
