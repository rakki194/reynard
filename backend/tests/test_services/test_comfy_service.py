...
from app.services.comfy.models import (
    ComfyQueueRequest,
    ComfyQueueResponse,
    ComfyStatusResponse
)
...
class TestComfyService:
    ...
    @patch('app.services.comfy.comfy_service.httpx.AsyncClient')
    async def test_get_workflow_templates_http_version_not_supported(self, mock_client_class):
    ...
    @patch('app.services.comfy.comfy_service.httpx.AsyncClient')
    async def test_get_workflow_templates_variant_also_negotiates(self, mock_client_class):
    ...
    @patch('app.services.comfy.comfy_service.httpx.AsyncClient')
    async def test_get_workflow_templates_network_authentication_required(self, mock_client_class):
