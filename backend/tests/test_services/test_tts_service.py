...
class TestTTSService:
    ...
    @patch('app.services.tts.tts_service.httpx.AsyncClient')
    async def test_synthesize_speech_http_version_not_supported(self, mock_client_class):
    ...
    @patch('app.services.tts.tts_service.httpx.AsyncClient')
    async def test_synthesize_speech_network_authentication_required(self, mock_client_class):
    ...
    @patch('app.services.tts.tts_service.httpx.AsyncClient')
    async def test_get_available_voices_http_version_not_supported(self, mock_client_class):
    ...
    @patch('app.services.tts.tts_service.httpx.AsyncClient')
    async def test_get_available_voices_variant_also_negotiates(self, mock_client_class):
    ...
    @patch('app.services.tts.tts_service.httpx.AsyncClient')
    async def test_get_available_voices_network_authentication_required(self, mock_client_class):
...
class TestAudioProcessor:
    ...
    def test_convert_format_success(self):
        ...
        # Convert format
        result = self.processor.convert_format(audio_data, from_format="wav", to_format="mp3")
    ...
    def test_convert_format_same_format(self):
        ...
        # Convert format
        result = self.processor.convert_format(audio_data, from_format="wav", to_format="wav")
    ...
    def test_convert_format_empty_data(self):
        ...
        audio_data = b""
        with pytest.raises(ValueError):
            self.processor.convert_format(audio_data, from_format="wav", to_format="mp3")
    ...
    def test_convert_format_invalid_from_format(self):
        ...
        audio_data = b"fake audio data"
        with pytest.raises(ValueError):
            self.processor.convert_format(audio_data, from_format="invalid", to_format="mp3")
    ...
    def test_convert_format_invalid_to_format(self):
        ...
        audio_data = b"fake audio data"
        with pytest.raises(ValueError):
            self.processor.convert_format(audio_data, from_format="wav", to_format="invalid")
    ...
    def test_convert_format_unsupported_conversion(self):
        ...
        audio_data = b"fake audio data"
        with pytest.raises(ValueError):
            self.processor.convert_format(audio_data, from_format="wav", to_format="flac")
