...
class TestDocumentIndexerFileIndexingIntegration:
    ...
    async def document_indexer(self, document_indexer_config):
        ...
        return indexer, mock_vector_store, mock_embedding_service, file_indexing_service
...
""",
    ...
    async def test_document_indexer_chunking_with_file_indexing(
        ...
        payload = {"path": test_file, "content": content, "file_type": ".py"}
    ...
    async def test_document_indexer_error_handling(self, document_indexer):
        ...
        payload = {"path": "/non/existent/file.py", "content": None, "file_type": ".py"}
    ...
    async def test_document_indexer_language_detection(
        ...
        payload = {"path": python_file, "content": content, "file_type": ".py"}
        chunks = await indexer._chunk_document(payload)
        ...
        payload = {"path": markdown_file, "content": content, "file_type": ".md"}
        chunks = await indexer._chunk_document(payload)
