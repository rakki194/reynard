...
def main():
    ...
    if args.type == "all":
        exit_codes.append(runner.run_all_tests(
            verbose=args.verbose,
            coverage=args.coverage,
            parallel=args.parallel,
        ))
    elif args.type == "pgp":
        exit_codes.append(runner.run_pgp_tests(
            verbose=args.verbose,
            coverage=args.coverage,
            parallel=args.parallel,
        ))
    elif args.type == "ssh":
        exit_codes.append(runner.run_ssh_tests(
            verbose=args.verbose,
            coverage=args.coverage,
            parallel=args.parallel,
        ))
        ...
        exit_codes.append(runner.run_integration_tests(
            verbose=args.verbose,
            coverage=args.coverage,
        ))
    elif args.type == "models":
        exit_codes.append(runner.run_model_tests(
            verbose=args.verbose,
            coverage=args.coverage,
        ))
    elif args.type == "services":
        exit_codes.append(runner.run_service_tests(
            verbose=args.verbose,
            coverage=args.coverage,
        ))
