...
class TestHtmlTagPatterns:
    ...
    def test_html_tag_obfuscation(self):
        ...
        test_cases = [
            ...
            ("<script\r>alert('XSS')</script>", True), # Carriage return before closing bracket
        ]
...
class TestCombinedXssPatterns:
    ...
    def test_complex_xss_attacks(self):
        ...
        test_cases = [
            ...
            ("<iframe onload=alert('XSS') src='javascript:alert(\\'XSS\\')'></iframe>", True),
            ("<div style='expression(alert(\\'XSS\\'))' onclick=alert('XSS')>content</div>", True),
        ]
    ...
    def test_pattern_performance(self):
        ...
        matches = any(re.search(pattern, large_text, re.IGNORECASE) 
                     for pattern in XSS_PATTERNS)
    ...
    def test_real_world_xss_examples(self):
        ...
        for attack, should_match in real_attacks:
            matches = any(re.search(pattern, attack, re.IGNORECASE) 
                         for pattern in XSS_PATTERNS)
    ...
    def test_false_positives(self):
        ...
        legitimate_content = [
            ...
            ("<html><head><title>Page</title></head><body>Content</body></html>", False),
        ]
        
        for content, should_match in legitimate_content:
            matches = any(re.search(pattern, content, re.IGNORECASE) 
                         for pattern in XSS_PATTERNS)
