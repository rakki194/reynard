...
class TestEmailAttachmentModel:
    ...
    def test_email_attachment_creation(self):
        ...
        attachment = EmailAttachmentModel(
            file_path="/path/to/file.pdf", filename="document.pdf"
        )
    ...
    def test_email_attachment_optional_filename(self):
        ...
        attachment = EmailAttachmentModel(file_path="/path/to/file.pdf")
...
class TestCaptionSchemas:
    ...
    def test_caption_request_optional_config(self):
        ...
        request = CaptionRequest(
            image_path="/path/to/image.jpg", generator_name="florence2"
        )
    ...
    def test_caption_response_optional_fields(self):
        ...
        response = CaptionResponse(caption="A simple caption")
...
class TestAgentEmailSchemas:
    ...
    def test_agent_email_stats_defaults(self):
        ...
        stats = AgentEmailStats(agent_id="test-agent-001")
    ...
    def test_agent_email_message_validation(self):
        ...
        # Valid message
        message = AgentEmailMessage(subject="Test Subject", body="Test body content")
        assert message.subject == "Test Subject"

        # Invalid - empty subject
        with pytest.raises(ValidationError):
            AgentEmailMessage(subject="", body="Test body content")  # Empty subject

        # Invalid - subject too long
        with pytest.raises(ValidationError):
            AgentEmailMessage(subject="x" * 201, body="Test body content")  # Too long

        # Invalid - empty body
        with pytest.raises(ValidationError):
            AgentEmailMessage(subject="Test Subject", body="")  # Empty body
    ...
    def test_agent_email_send_request_creation(self):
        ...
        request = AgentEmailSendRequest(
            target_agent_id="target-agent-001", message=message
        )
