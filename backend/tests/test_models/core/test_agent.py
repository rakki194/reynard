...
class TestAgent:
    ...
    def test_agent_unique_constraints(self, session):
        ...
        # Create first agent
        agent1 = Agent(
            agent_id="test-agent-001", name="Test Agent 1", email="test1@example.com"
        )
        session.add(agent1)
        session.commit()
    ...
    def test_agent_optional_fields(self, session):
        ...
        agent = Agent(agent_id="minimal-agent", name="Minimal Agent")
    ...
    def test_agent_system_agent(self, session):
        ...
        agent = Agent(
            agent_id="system-agent-001", name="System Agent", is_system_agent=True
        )
    ...
    def test_agent_inactive(self, session):
        ...
        agent = Agent(
            agent_id="inactive-agent-001", name="Inactive Agent", active=False
        )
