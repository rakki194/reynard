...
class TestEmailAnalyticsService:
    ...
    @pytest.mark.asyncio
    async def test_get_email_metrics_with_data(self, analytics_service, sample_emails_data):
        """Test getting metrics with sample email data."""
        with patch.object(analytics_service, '_get_emails_data', return_value=sample_emails_data):
            metrics = await analytics_service.get_email_metrics()
    ...
    @pytest.mark.asyncio
    async def test_get_email_metrics_with_period_filter(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_get_email_metrics_with_agent_filter(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_get_email_metrics_caching(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_generate_insights_with_data(self, analytics_service, sample_emails_data):
        ...
        with patch.object(analytics_service, '_get_emails_data', return_value=sample_emails_data):
            ...
            for insight in insights:
                ...
                assert insight.insight_type in ['trend', 'anomaly', 'recommendation', 'pattern', 'performance', 'activity']
    ...
    async def test_get_agent_performance_no_data(self, analytics_service):
        ...
        with patch.object(analytics_service, '_get_emails_data', return_value=[]):
            performance = await analytics_service.get_agent_performance('nonexistent_agent')
            assert performance == {}
    ...
    @pytest.mark.asyncio
    async def test_get_email_trends_response_time(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_get_email_trends_agent_activity(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_get_email_trends_invalid_metric(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_analyze_content_patterns(self, analytics_service, sample_emails_data):
    ...
    @pytest.mark.asyncio
    async def test_generate_recommendations(self, analytics_service, sample_emails_data):
        """Test recommendation generation."""
        with patch.object(analytics_service, '_get_emails_data', return_value=sample_emails_data):
            metrics = await analytics_service.get_email_metrics()
            insights = await analytics_service.generate_insights()
            
            recommendations = await analytics_service._generate_recommendations(metrics, insights)
    ...
    async def test_cache_validation(self, analytics_service):
        ...
        analytics_service._cache_expiry["test_key"] = datetime.now() - timedelta(minutes=20)
        assert not analytics_service._is_cache_valid("test_key")
        
        # Test with valid cache
        analytics_service._cache_expiry["test_key"] = datetime.now() + timedelta(minutes=10)
    ...
    async def test_error_handling(self, analytics_service):
        ...
        with patch.object(analytics_service, '_get_emails_data', side_effect=Exception("Test error")):
            metrics = await analytics_service.get_email_metrics()
