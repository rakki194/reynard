...
class TestMultiAccountService:
    ...
    @pytest.mark.asyncio
    async def test_create_account_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_create_account_duplicate_email(self, multi_account_service, sample_account_data):
        ...
        with pytest.raises(ValueError, match="Account with email address already exists"):
            await multi_account_service.create_account(**sample_account_data)
    
    @pytest.mark.asyncio
    async def test_create_account_max_limit_exceeded(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_create_account_primary_set(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_list_accounts_active_only(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_get_account_summary_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_get_system_overview(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_update_account_success(self, multi_account_service, sample_account_data):
        ...
        updated_account = await multi_account_service.update_account(account.account_id, **update_data)
    ...
    async def test_update_account_not_found(self, multi_account_service):
        ...
        with pytest.raises(ValueError, match="Account not found"):
            await multi_account_service.update_account("nonexistent_account_id", display_name="New Name")
    
    @pytest.mark.asyncio
    async def test_delete_account_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_activate_account_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_deactivate_account_success(self, multi_account_service, sample_account_data):
    ...
    async def test_deactivate_account_not_found(self, multi_account_service):
        ...
        result = await multi_account_service.deactivate_account("nonexistent_account_id")
        assert result is False
    
    @pytest.mark.asyncio
    async def test_set_primary_account_success(self, multi_account_service, sample_account_data):
    ...
    async def test_set_primary_account_not_found(self, multi_account_service):
        ...
        result = await multi_account_service.set_primary_account("nonexistent_account_id")
        assert result is False
    
    @pytest.mark.asyncio
    async def test_get_primary_account_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_get_primary_account_none_set(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_track_usage_success(self, multi_account_service, sample_account_data):
    ...
    async def test_track_usage_account_not_found(self, multi_account_service):
        ...
        with pytest.raises(ValueError, match="Account not found"):
            await multi_account_service.track_usage("nonexistent_account_id", usage_data)
    
    @pytest.mark.asyncio
    async def test_get_usage_stats_success(self, multi_account_service, sample_account_data):
    ...
    @pytest.mark.asyncio
    async def test_check_rate_limits_within_limits(self, multi_account_service, sample_account_data):
        ...
        # Check within limits
        result = await multi_account_service.check_rate_limits(account.account_id, "emails_per_hour", 50)
        assert result["allowed"] is True
        assert result["remaining"] == 50
        assert result["reset_time"] is not None
    
    @pytest.mark.asyncio
    async def test_check_rate_limits_exceeded(self, multi_account_service, sample_account_data):
        ...
        result = await multi_account_service.check_rate_limits(account.account_id, "emails_per_hour", 150)
        assert result["allowed"] is False
        assert result["remaining"] == 0
        assert result["reset_time"] is not None
    
    @pytest.mark.asyncio
    async def test_set_rate_limits_success(self, multi_account_service, sample_account_data):
        ...
        result = await multi_account_service.set_rate_limits(account.account_id, rate_limits)
        assert result is True
    ...
    async def test_set_rate_limits_account_not_found(self, multi_account_service):
        ...
        with pytest.raises(ValueError, match="Account not found"):
            await multi_account_service.set_rate_limits("nonexistent_account_id", rate_limits)
    ...
    async def test_error_handling(self, multi_account_service):
        ...
        with patch.object(multi_account_service, '_save_accounts', side_effect=Exception("Save error")):
            # Should not raise exception
            multi_account_service._save_accounts()
        
        with patch.object(multi_account_service, '_save_usage_stats', side_effect=Exception("Save error")):
            # Should not raise exception
            multi_account_service._save_usage_stats()
        
        with patch.object(multi_account_service, '_load_accounts', side_effect=Exception("Load error")):
            # Should handle gracefully
            multi_account_service._load_accounts()
            assert multi_account_service.accounts == {}
        
        with patch.object(multi_account_service, '_load_usage_stats', side_effect=Exception("Load error")):
            # Should handle gracefully
