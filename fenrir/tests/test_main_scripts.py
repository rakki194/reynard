    ...
    *otter curiosity* Test suite for main exploit runner scripts
    ...
    async def test_run_all_exploits_script(self):
        ...
        try:
            ...
            print("    ✅ Run All Exploits script executed successfully")
    ...
    async def test_run_llm_exploits_script(self):
        ...
        try:
            ...
            self.log_test_result(test_result)
            print("    ✅ Run LLM Exploits script executed successfully")
    ...
    async def test_penetration_testing_client(self):
        ...
        try:
            ...
            with patch(
                "penetration_testing_client.PenetrationTestingClient"
            ) as mock_client:
                mock_instance = MagicMock()
            ...
            self.log_test_result(test_result)
            print("    ✅ Penetration Testing Client executed successfully")
