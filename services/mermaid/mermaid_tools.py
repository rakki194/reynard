...
class MermaidTools:
    ...
    def validate_mermaid_diagram(self, diagram_content: str) -> Dict[str, Any]:
        ...
        """
        try:
            is_valid, error_message = self.mermaid_service.validate_diagram(diagram_content)
    ...
    def render_mermaid_to_svg(self, diagram_content: str, output_path: str = None) -> Dict[str, Any]:
        """
    ...
    def render_mermaid_to_png(self, diagram_content: str, output_path: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            if output_path:
                ...
                try:
                    subprocess.Popen(["imv", saved_path], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
