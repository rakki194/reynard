...
class LocalMermaidService:
    ...
    def __init__(self, port: int = 3001, mermaid_ink_path: Optional[str] = None):
        ...
        self.mermaid_ink_path = mermaid_ink_path or "/home/kade/runeset/reynard/third_party/mermaid.ink"
    ...
    def _start_server(self):
        ...
        try:
            ...
            if not Path(self.mermaid_ink_path).exists():
                raise FileNotFoundError(f"Mermaid.ink directory not found: {self.mermaid_ink_path}")
