...
class MermaidRenderer:
    ...
    def _create_mermaid_html(self, diagram: str, theme: str = "default", 
...
"""
    ...
    def _extract_svg_content(self, html_content: str) -> Tuple[bool, str, str]:
        ...
        """
        try:
            success, svg_content, error = self.browser_service.render_html_to_svg_with_wait_sync(
    ...
    def _create_png_from_svg(self, svg_content: str, bg_color: Optional[str] = None) -> Tuple[bool, bytes, str]:
        """
...
"""
    ...
    def render_to_svg(self, diagram: str, theme: str = "default", 
                     bg_color: Optional[str] = None,
                     width: Optional[int] = None,
        ...
        """
        try:
            html_content = self._create_mermaid_html(diagram, theme, bg_color, width, height)
            return self._extract_svg_content(html_content)
        except Exception as e:
            return False, "", f"SVG rendering error: {e}"
    
    def render_to_png(self, diagram: str, theme: str = "default",
                     bg_color: Optional[str] = None,
                     width: Optional[int] = None,
        ...
        try:
            # First render to SVG
            success, svg_content, error = self.render_to_svg(diagram, theme, bg_color, width, height)
            if not success:
                return False, b"", error
    ...
    def save_svg(self, diagram: str, output_path: str, theme: str = "default",
                bg_color: Optional[str] = None,
                width: Optional[int] = None,
                height: Optional[int] = None) -> Tuple[bool, str, str]:
        """
    ...
    def save_png(self, diagram: str, output_path: str, theme: str = "default",
                bg_color: Optional[str] = None,
                width: Optional[int] = None,
                height: Optional[int] = None) -> Tuple[bool, str, str]:
        """
        ...
        """
        try:
            success, png_data, error = self.render_to_png(diagram, theme, bg_color, width, height)
            if not success:
                return False, "", error
