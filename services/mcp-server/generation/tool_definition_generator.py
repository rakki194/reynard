...
from protocol.tool_registry import ToolRegistry, ToolMetadata
...
class ToolDefinitionGenerator:
    ...
    def generate_from_registry(self, tool_registry: ToolRegistry) -> Dict[str, Dict[str, Any]]:
    ...
    def generate_tool_definition(self, tool_metadata: ToolMetadata) -> Dict[str, Any]:
        ...
        if not validation_result.is_valid:
            raise ValueError(f"Generated invalid tool schema for {tool_metadata.name}: {validation_result.errors}")
