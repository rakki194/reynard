...
class MCPAuthMiddleware:
    ...
    def authenticate_request(self, request: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.debug(
                f"Authenticated request for client: {token_payload.get('client_id')}"
            )
    ...
    def authorize_tool_access(
        self, token_payload: Dict[str, Any], tool_name: str
    ) -> bool:
        """
    ...
    def _is_config_tool(self, tool_name: str) -> bool:
        ...
        config_tools = {"reload_config", "get_tool_configs", "get_tool_status"}
    ...
    def create_error_response(
        ...
        response = {
            "jsonrpc": "2.0",
            "error": {"code": -32001, "message": error_message},  # Unauthorized
        }
