    ...
    async def get_available_spirits(self) -> Set[str]:
        ...
        if self._spirits_cache is None:
            try:
                ...
                self._spirits_cache = {"fox", "wolf", "otter", "dragon", "phoenix", "eagle", "lion", "tiger"}
        ...
        if self._styles_cache is None:
            try:
                ...
                if "styles" in enums_data:
                    ...
                    self._styles_cache = {"foundation", "exo", "hybrid", "cyberpunk", "mythological", "scientific"}
    ...
    async def get_all_enums(self) -> Dict[str, Any]:
        ...
        if self._enums_cache is None:
            try:
                ...
                logger.debug(f"Loaded enum data from backend: {list(self._enums_cache.keys())}")
            except Exception as e:
