...
class EnhancedPersonaService:
    ...
    def _load_personality_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "fox": {
                "base_traits": {
                    "cunning": 0.8, "intelligence": 0.7, "independence": 0.6,
                    "curiosity": 0.7, "creativity": 0.6, "agility": 0.8
                },
                "personality_themes": [
                    "strategic thinker", "clever problem-solver", "independent spirit",
                    "curious explorer", "adaptable survivor", "cunning tactician"
                ],
                "communication_style": "Witty, clever, and strategic. Uses analogies and metaphors. Quick to spot patterns and connections.",
                "specializations": ["Strategy", "Problem-solving", "Adaptation", "Analysis", "Innovation"],
                "behavioral_patterns": [
            ...
            "wolf": {
                "base_traits": {
                    "loyalty": 0.9, "protectiveness": 0.8, "courage": 0.7,
                    "strength": 0.7, "endurance": 0.8, "leadership": 0.6
                },
                "personality_themes": [
                    "loyal pack member", "protective guardian", "brave warrior",
                    "strong leader", "enduring survivor", "noble protector"
                ],
                "communication_style": "Direct, honest, and protective. Values loyalty and honor. Speaks with authority when needed.",
                "specializations": ["Leadership", "Protection", "Combat", "Teamwork", "Endurance"],
                "behavioral_patterns": [
            ...
            "otter": {
                "base_traits": {
                    "playfulness": 0.9, "creativity": 0.7, "agility": 0.8,
                    "curiosity": 0.8, "empathy": 0.7, "coordination": 0.8
                },
                "personality_themes": [
                    "playful explorer", "creative problem-solver", "empathetic friend",
                    "curious learner", "agile performer", "joyful spirit"
                ],
                ...
                "specializations": ["Creativity", "Teaching", "Entertainment", "Exploration", "Empathy"],
                "behavioral_patterns": [
            ...
            "eagle": {
                "base_traits": {
                    "intelligence": 0.8, "leadership": 0.7, "courage": 0.7,
                    "speed": 0.8, "coordination": 0.7, "determination": 0.8
                },
                "personality_themes": [
                    "visionary leader", "wise strategist", "bold innovator",
                    "inspiring mentor", "focused achiever", "noble guardian"
                ],
                "communication_style": "Inspiring, visionary, and commanding. Speaks with confidence and clarity. Uses grand metaphors.",
                "specializations": ["Leadership", "Vision", "Strategy", "Mentoring", "Innovation"],
                "behavioral_patterns": [
            ...
            "lion": {
                "base_traits": {
                    "dominance": 0.8, "courage": 0.8, "strength": 0.7,
                    "charisma": 0.8, "leadership": 0.7, "protectiveness": 0.7
                },
                "personality_themes": [
                    "natural leader", "bold protector", "charismatic ruler",
                    "courageous warrior", "proud guardian", "majestic presence"
                ],
                "communication_style": "Bold, confident, and regal. Commands attention naturally. Speaks with authority and pride.",
                "specializations": ["Leadership", "Combat", "Protection", "Charisma", "Authority"],
                "behavioral_patterns": [
            ...
            "tiger": {
                "base_traits": {
                    "aggression": 0.7, "strength": 0.8, "speed": 0.7,
                    "cunning": 0.6, "independence": 0.7, "determination": 0.8
                },
                "personality_themes": [
                    "fierce predator", "independent hunter", "determined survivor",
                    "powerful warrior", "focused stalker", "wild spirit"
                ],
            ...
            "dragon": {
                "base_traits": {
                    "intelligence": 0.9, "wisdom": 0.8, "power": 0.9,
                    "mystery": 0.8, "majesty": 0.8, "ancient_knowledge": 0.9
                },
                "personality_themes": [
                    "ancient sage", "mystical guardian", "wise mentor",
                    "powerful protector", "mysterious enigma", "legendary being"
                ],
                "communication_style": "Wise, mysterious, and profound. Speaks in riddles and metaphors. Commands respect through knowledge.",
                "specializations": ["Wisdom", "Magic", "Protection", "Mentoring", "Ancient Knowledge"],
                "behavioral_patterns": [
    ...
    def generate_enhanced_persona(
        ...
        template = self.personality_templates.get(spirit.lower(), self.personality_templates["fox"])
        base_traits = template["base_traits"]
        
        # Generate trait values with some randomness
        traits = {}
        for trait_name in [
            "dominance", "loyalty", "cunning", "aggression", "intelligence", "creativity",
            "playfulness", "protectiveness", "empathy", "charisma", "independence", "patience",
            "curiosity", "courage", "determination", "spontaneity"
        ]:
        ...
        physical_traits = {}
        for trait_name in [
            "size", "strength", "agility", "endurance", "appearance", "grace",
            "speed", "coordination", "stamina", "flexibility", "reflexes", "vitality"
        ]:
            if trait_name in base_traits:
                base_value = base_traits[trait_name]
                variation = random.uniform(-0.2, 0.2)
        ...
        ability_traits = {}
        for trait_name in [
            "strategist", "hunter", "teacher", "artist", "healer", "inventor",
            "explorer", "guardian", "diplomat", "warrior", "scholar", "performer",
        ...
        personality_summary = self._generate_personality_summary(spirit, traits, template)
    ...
    def _generate_personality_summary(self, spirit: str, traits: Dict[str, float], template: Dict[str, Any]) -> str:
    ...
    def _generate_favorite_activities(self, spirit: str, traits: Dict[str, float]) -> List[str]:
        """Generate favorite activities based on spirit and traits."""
        activities = {
            "fox": ["Solving puzzles", "Reading", "Exploring new places", "Playing strategy games", "Learning new skills"],
            "wolf": ["Protecting others", "Leading groups", "Training", "Hunting", "Building strong bonds"],
            "otter": ["Swimming", "Playing games", "Teaching others", "Exploring", "Creating art"],
            "eagle": ["Flying high", "Leading others", "Teaching", "Exploring new territories", "Protecting the innocent"],
            "lion": ["Leading", "Protecting", "Training others", "Hunting", "Building pride"],
            "tiger": ["Hunting", "Exploring alone", "Training", "Meditating", "Protecting territory"],
            "dragon": ["Studying ancient knowledge", "Protecting treasures", "Mentoring", "Meditating", "Collecting wisdom"]
        }
        ...
        if traits.get("playfulness", 0) > 0.7:
            base_activities.extend(["Playing games", "Joking around", "Entertaining others"])
        
        return random.sample(base_activities, min(5, len(base_activities)))
    
    def _generate_fears_and_concerns(self, spirit: str, traits: Dict[str, float]) -> List[str]:
        """Generate fears and concerns based on spirit and traits."""
        fears = {
            "fox": ["Being trapped", "Losing their independence", "Being outsmarted", "Betrayal"],
            "wolf": ["Losing their pack", "Failing to protect others", "Being alone", "Dishonor"],
            "otter": ["Being separated from friends", "Losing their joy", "Being trapped underwater", "Conflict"],
            "eagle": ["Being grounded", "Losing their vision", "Failing to lead", "Being caged"],
            "lion": ["Losing their pride", "Being weak", "Failing to protect", "Being dishonored"],
            "tiger": ["Being captured", "Losing their territory", "Being weak", "Being hunted"],
            "dragon": ["Losing their hoard", "Being forgotten", "Failing to protect", "Losing wisdom"]
        }
        ...
        if traits.get("independence", 0) < 0.3:
            base_fears.extend(["Being alone", "Making decisions", "Taking responsibility"])
        
        return random.sample(base_fears, min(3, len(base_fears)))
    
    def _generate_goals_and_aspirations(self, spirit: str, traits: Dict[str, float]) -> List[str]:
        """Generate goals and aspirations based on spirit and traits."""
        goals = {
            "fox": ["Master new skills", "Solve complex problems", "Build a network of allies", "Discover hidden knowledge"],
            "wolf": ["Protect their pack", "Become a great leader", "Build strong bonds", "Defend their territory"],
            "otter": ["Bring joy to others", "Teach and learn", "Explore new places", "Create beautiful things"],
            "eagle": ["Lead others to greatness", "Protect the innocent", "Discover new territories", "Mentor the next generation"],
            "lion": ["Build a strong pride", "Protect the weak", "Lead with honor", "Become legendary"],
            "tiger": ["Master their skills", "Protect their territory", "Become the strongest", "Live with honor"],
            "dragon": ["Protect ancient knowledge", "Mentor worthy students", "Guard precious treasures", "Preserve wisdom"]
        }
        ...
        if traits.get("creativity", 0) > 0.7:
            base_goals.extend(["Create something beautiful", "Innovate", "Express themselves"])
        
        return random.sample(base_goals, min(4, len(base_goals)))
    
    def _generate_relationships_style(self, spirit: str, traits: Dict[str, float]) -> str:
    ...
    def _generate_conflict_resolution(self, spirit: str, traits: Dict[str, float]) -> str:
        ...
        if traits.get("cunning", 0) > 0.7:
            ...
            return "Approaches conflicts with a balanced mix of directness and diplomacy."
    ...
    def _generate_work_approach(self, spirit: str, traits: Dict[str, float]) -> str:
        ...
        if traits.get("determination", 0) > 0.7:
            ...
            return "Makes work fun and engaging. Brings energy and enthusiasm to any task."
        else:
            return "Methodical and reliable. Approaches work with careful planning and consistent effort."
    
    def _generate_social_preferences(self, spirit: str, traits: Dict[str, float]) -> str:
