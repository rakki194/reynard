    ...
    def get_tool_status(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if tool_name:
                ...
                is_enabled = self.tool_registry.is_tool_enabled(tool_name) if is_registered else False
                config = self.tool_registry.get_tool_config(tool_name) if is_registered else None
