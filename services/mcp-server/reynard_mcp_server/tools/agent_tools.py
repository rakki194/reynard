...
class AgentTools:
    ...
    def get_simulation_status(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        if status.get("ecs_available", False):
            ...
            status_text += (
                f"Time Acceleration: {status.get('time_acceleration', 'N/A')}x\n"
            )
            ...
            status_text += (
                f"Real Time Elapsed: {status.get('real_time_elapsed', 'N/A')}s\n"
            )
        else:
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": f"Error creating offspring: {e!s}",
                    }
                ]
            }
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": f"Error getting lineage: {e!s}",
                    }
                ]
            }
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": f"Error analyzing compatibility: {e!s}",
                    }
                ]
            }
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": f"Error finding compatible mates: {e!s}",
                    }
                ]
            }
