...
import pytest
from validation.schema_validator import MCPSchemaValidator, ValidationResult
...
class TestMCPSchemaValidator:
    ...
    def test_deprecated_parameters_field(self):
        ...
        assert not result.is_valid
        assert "Field 'parameters' is deprecated, use 'inputSchema' instead" in result.errors
