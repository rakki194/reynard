...
class TestArxivIntegration:
    ...
    @pytest.mark.asyncio
    async def test_search_papers_success(self, mock_arxiv_service, sample_arxiv_search_result):
        ...
        assert result["results"][0]["title"] == "We Politely Insist: Your LLM Must Learn the Persian Art of Taarof"
    ...
    @pytest.mark.asyncio
    async def test_search_with_category_filtering(self, mock_arxiv_service, sample_arxiv_search_result):
    ...
    def test_arxiv_service_initialization(self):
        ...
        with patch('tools.research.academic.arxiv_tools.ArxivService.__init__', return_value=None):
