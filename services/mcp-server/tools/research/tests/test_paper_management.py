...
class TestPaperManagement:
    ...
    def test_metadata_handling(self, mock_paper_management_service, sample_paper_metadata):
    ...
    def test_paper_search_by_title(self, mock_paper_management_service, sample_paper_metadata):
        """Test paper search by title."""
        # Setup
        mock_paper_management_service.search_papers.return_value = [sample_paper_metadata]
        
        # Test
        results = mock_paper_management_service.search_papers(
            query="persian cultural",
            max_results=10
        )
    ...
    def test_paper_search_by_author(self, mock_paper_management_service, sample_paper_metadata):
    ...
    def test_paper_index_management(self, mock_paper_management_service, sample_paper_metadata):
        ...
        assert mock_paper_management_service.arxiv_index[paper_id]["title"] == sample_paper_metadata["title"]
    ...
    def test_paper_service_initialization(self):
        ...
        with patch('tools.research.paper_management.PaperManagementService.__init__', return_value=None):
