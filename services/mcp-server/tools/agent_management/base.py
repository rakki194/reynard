...
class BaseAgentTools:
    ...
    async def generate_agent_name(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        name = await self.agent_manager.generate_name(spirit_str, style_str)
    ...
    async def roll_agent_spirit(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        selected_spirit = await self.agent_manager.roll_agent_spirit(weighted)
    ...
    async def get_spirit_emoji(self, arguments: dict[str, Any]) -> dict[str, Any]:
