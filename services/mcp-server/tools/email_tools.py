...
async def send_agent_email(**kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            return {
                "success": False,
                "error": "Agent email service not available"
            }
        ...
        from backend.app.models.agent_email_models import AgentEmailSendRequest, AgentEmailMessage
...
async def trigger_agent_automated_email(**kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        success = await agent_email_service.process_automated_email(agent_id, event_type, context)
        
        return {
            "success": success,
            "agent_id": agent_id,
            "event_type": event_type,
            "message": "Automated email triggered" if success else "No matching template found"
        }
