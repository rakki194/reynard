...
async def send_agent_email(**kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        from backend.app.models.schemas.agent_schemas import (
            AgentEmailMessage,
...
async def create_agent_email_template(**kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        # Create template
        from backend.app.models.schemas.agent_schemas import AgentEmailTemplate
...
async def setup_agent_email(**kwargs) -> dict[str, Any]:
    ...
    try:
        ...
        # Create config
        from backend.app.models.schemas.agent_schemas import AgentEmailConfig
