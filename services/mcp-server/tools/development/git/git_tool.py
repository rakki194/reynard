...
class GitTool:
    ...
    def _paginate_diff(
        self, diff_content: str, page: int = 1, page_size: int = 1000
    ) -> Dict[str, Any]:
...
async def git_tool_handler(**kwargs) -> dict[str, Any]:
    ...
    if not operation:
        return {"content": [{"type": "text", "text": "❌ Operation is required"}]}
        ...
        if operation == "status":
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Status", result),
                    }
                ]
            }
            ...
            # Get current branch
            current_result = await git_tool._run_command(
            ...
            if current_result["success"] and all_result["success"]:
                ...
                return {
                    "content": [
                        {"type": "text", "text": "❌ Error getting branch info"}
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output(
                            f"Recent Commits ({limit})", result
                        ),
                    }
                ]
            }
            ...
            if result["success"]:
                ...
                return {
                    "content": [
                        {
                            "type": "text",
                            "text": git_tool._format_git_output("Git Diff", result),
                        }
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Add", result),
                    }
                ]
            }
            ...
            if not message:
                return {
                    "content": [
                        {"type": "text", "text": "❌ Commit message is required"}
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Commit", result),
                    }
                ]
            }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Push", result),
                    }
                ]
            }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Pull", result),
                    }
                ]
            }
            ...
            if not branch:
                return {
                    "content": [
                        {
                            "type": "text",
                            "text": "❌ Branch name is required for checkout",
                        }
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Checkout", result),
                    }
                ]
            }
            ...
            if not branch:
                return {
                    "content": [
                        {"type": "text", "text": "❌ Branch name is required for merge"}
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Merge", result),
                    }
                ]
            }
            ...
            if not branch:
                return {
                    "content": [
                        {
                            "type": "text",
                            "text": "❌ Branch name is required for rebase",
                        }
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Rebase", result),
                    }
                ]
            }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Reset", result),
                    }
                ]
            }
            ...
            if action == "list":
                ...
                return {
                    "content": [
                        {"type": "text", "text": f"❌ Unknown stash action: {action}"}
                    ]
                }
                ...
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output(
                            f"Git Stash {action.title()}", result
                        ),
                    }
                ]
            }
            ...
            if action == "list":
                ...
                if not tag_name:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "❌ Tag name is required for create",
                            }
                        ]
                    }
                ...
                if not tag_name:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "❌ Tag name is required for delete",
                            }
                        ]
                    }
                ...
                return {
                    "content": [
                        {"type": "text", "text": f"❌ Unknown tag action: {action}"}
                    ]
                }
            ...
            if action == "list":
                ...
                if not remote_name or not remote_url:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "❌ Remote name and URL are required for add",
                            }
                        ]
                    }
                result = await git_tool._run_command(
                ...
                if not remote_name:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "❌ Remote name is required for remove",
                            }
                        ]
                    }
                result = await git_tool._run_command(
                ...
                if not remote_name:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "❌ Remote name is required for show",
                            }
                        ]
                    }
                result = await git_tool._run_command(
                ...
                return {
                    "content": [
                        {"type": "text", "text": f"❌ Unknown remote action: {action}"}
                    ]
                }
                ...
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output(
                            f"Git Remote {action.title()}", result
                        ),
                    }
                ]
            }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Fetch", result),
                    }
                ]
            }
            ...
            if not url:
                return {
                    "content": [
                        {
                            "type": "text",
                            "text": "❌ Repository URL is required for clone",
                        }
                    ]
                }
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": git_tool._format_git_output("Git Clone", result),
                    }
                ]
            }
