...
class Settings(BaseSettings):
    ...
    # Customer Modeling
    CUSTOMER_MODELING_BATCH_SIZE: int = Field(default=1000, env="CUSTOMER_MODELING_BATCH_SIZE")
    CUSTOMER_MODELING_UPDATE_INTERVAL: int = Field(default=300, env="CUSTOMER_MODELING_UPDATE_INTERVAL")  # 5 minutes
    CUSTOMER_MODELING_CACHE_TTL: int = Field(default=3600, env="CUSTOMER_MODELING_CACHE_TTL")  # 1 hour
    ...
    ANALYTICS_UPDATE_FREQUENCY: int = Field(default=60, env="ANALYTICS_UPDATE_FREQUENCY")  # 1 minute
    
    # Privacy & Compliance
    PRIVACY_LEVEL: str = Field(default="level_2", env="PRIVACY_LEVEL")  # level_1 to level_4
    ...
    MODEL_UPDATE_FREQUENCY: int = Field(default=86400, env="MODEL_UPDATE_FREQUENCY")  # 24 hours
