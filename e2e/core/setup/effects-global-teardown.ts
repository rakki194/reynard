...
async function globalTeardown() {
  ...
  try {
    ...
    // Save final report
    fs.writeFileSync(path.join(resultsDir, "final-report.json"), JSON.stringify(finalReport, null, 2));
...
`;
    ...
    fs.writeFileSync(path.join(resultsDir, "final-report.md"), markdownReport);
