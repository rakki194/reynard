...
export class AuthElementVerification {
   ...
   */
  async verifyElementAttribute(selector: string, attribute: string, expectedValue: string): Promise<void> {
   ...
   */
  async verifyElementCSSProperty(selector: string, property: string, expectedValue: string): Promise<void> {
