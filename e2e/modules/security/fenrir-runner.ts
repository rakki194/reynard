...
# Run the exploit
exploit = ${getExploitClassName(exploitModule)}('${target}')
 ...
 */
function parseExploitResult(stdout: string, exploitModule: string, executionTime: number): PenetrationTestResult {
 ...
 */
function handleExploitError(error: unknown, exploitModule: string, executionTime: number): PenetrationTestResult {
