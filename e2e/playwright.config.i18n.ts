...
import { detectAuthAppPort } from "./utils/port-detector";

export default defineConfig({
  testDir: "./",
  testMatch: [
    "i18n-benchmark.spec.ts",
  ],
  ...
  use: {
    ...
    baseURL:
      ...
      `http://localhost:${detectAuthAppPort()}`,
  ...
  outputDir: "i18n-benchmark-results/",

  /* Global setup and teardown for performance testing */
  globalSetup: "./global-i18n-setup.ts",
  globalTeardown: "./global-i18n-teardown.ts",
});
