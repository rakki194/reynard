...
def get_spirit_metadata():
    ...
    return {
        ...
        "hydra": {
            ...
            "traits": ["multi-headed", "regenerative", "powerful", "serpentine", "mythical"],
            "emoji": "🐍",
            "generation_numbers": [9, 18, 27, 36, 45, 54, 63]
        },
        ...
        "alien": {
            ...
            "traits": ["otherworldly", "advanced", "mysterious", "technological", "cosmic"],
            "emoji": "👽",
            "generation_numbers": [1, 2, 3, 4, 5, 6, 7]
        },
        "void": {
        ...
        "wendigo": {
            ...
            "traits": ["supernatural", "hungry", "transformative", "fearsome", "mythical"],
            "emoji": "👹",
            "generation_numbers": [1, 2, 3, 4, 5, 6, 7]
        },
        "skinwalker": {
            ...
            "traits": ["shape-shifting", "transformative", "supernatural", "mysterious", "powerful"],
            "emoji": "🦅",
            "generation_numbers": [1, 2, 3, 4, 5, 6, 7]
        }
    }
