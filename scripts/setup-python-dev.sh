...
echo -e "  ${YELLOW}npm run python:format${NC}      - Format all Python files"
echo -e "  ${YELLOW}npm run python:lint${NC}        - Lint all Python files"
echo -e "  ${YELLOW}npm run python:check${NC}       - Run all Python checks"
echo ""
