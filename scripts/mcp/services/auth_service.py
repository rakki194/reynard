...
class MCPAuthService:
    ...
    def generate_mcp_token(self, client_id: str, permissions: Optional[List[str]] = None) -> str:
        """
    ...
    def can_manage_tools(self, token_payload: Dict[str, Any]) -> bool:
        ...
        """
        return (self.has_permission(token_payload, "mcp:tools:manage") or 
                self.is_admin(token_payload))
    ...
    def can_execute_tools(self, token_payload: Dict[str, Any]) -> bool:
        ...
        """
        return (self.has_permission(token_payload, "mcp:tools:execute") or 
                self.can_manage_tools(token_payload))
    ...
    def can_read_config(self, token_payload: Dict[str, Any]) -> bool:
        ...
        """
        return (self.has_permission(token_payload, "mcp:config:read") or 
                self.can_manage_tools(token_payload))
    ...
    def can_write_config(self, token_payload: Dict[str, Any]) -> bool:
        ...
        """
        return (self.has_permission(token_payload, "mcp:config:write") or 
                self.is_admin(token_payload))
