#!/usr/bin/env python3
"""
Monolith Detection Tools (Refactored)
======================================
...
🦊 Strategic fox approach: We've outfoxed the monolith by breaking it into
elegant, focused modules that work together like a well-coordinated pack!
"""
...
class MonolithDetectionTools:
    ...
    def call_tool(self, name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        elif name == "analyze_file_complexity":
            return self._analyze_file_complexity(arguments)
        elif name == "get_code_metrics_summary":
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": f"❌ Error detecting monoliths: {str(e)}",
                    }
                ]
            }
