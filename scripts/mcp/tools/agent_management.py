...
agent_naming_path = Path(__file__).parent.parent.parent.parent / "services" / "agent-naming" / "reynard_agent_naming"
    ...
    return {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "spirit": {
                        ...
                        "enum": ["fox", "wolf", "otter", "dragon", "phoenix", "void", "alien", "kraken", "basilisk", "chimera"]
                    },
                    "style": {
                        "type": "string", 
        ...
        "roll_agent_spirit": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "weighted": {"type": "boolean", "description": "Use weighted selection", "default": True}
                }
            }
        },
        "agent_startup_sequence": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "agent_id": {"type": "string", "description": "Agent identifier", "default": "current-session"},
                    "preferred_style": {"type": "string", "description": "Preferred naming style"},
                    "force_spirit": {"type": "string", "description": "Force specific spirit"}
                }
            }
        },
        "get_agent_persona": {
        ...
        "accelerate_time": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "factor": {"type": "number", "description": "Time acceleration factor", "default": 10.0}
                }
            }
        },
        "nudge_time": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "amount": {"type": "number", "description": "Time amount to nudge", "default": 0.1}
                }
            }
        },
        "create_offspring": {
            ...
            "inputSchema": {
                "type": "object",
                "properties": {
                    "parent1_id": {"type": "string", "description": "First parent agent ID"},
                    "parent2_id": {"type": "string", "description": "Second parent agent ID"},
                    "offspring_id": {"type": "string", "description": "Offspring agent ID"}
                },
        ...
        "get_agent_lineage": {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "agent_id": {"type": "string", "description": "Agent identifier"},
                    "depth": {"type": "integer", "description": "Lineage depth", "default": 3}
                },
                "required": ["agent_id"]
            }
        },
