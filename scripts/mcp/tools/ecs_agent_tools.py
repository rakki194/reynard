...
class ECSAgentTools:
    ...
    def __init__(self, data_dir: str | None = None, world: AgentWorld | None = None):
    ...
    def enable_automatic_reproduction(self, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    def get_breeding_statistics(self, arguments: dict[str, Any]) -> dict[str, Any]:
        """Get breeding statistics."""
        try:
            stats = self.world.get_breeding_stats()
    ...
    def get_simulation_status(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            agent_count = len(self.world.get_agent_entities())
            mature_agents = len(self.world.get_mature_agents())
            
            # Get breeding statistics
            breeding_stats = self.world.get_breeding_stats()
            
            status = {
                "world_status": "active",
                "entity_count": entity_count,
                "agent_count": agent_count,
                "mature_agents": mature_agents,
