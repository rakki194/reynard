...
class StandaloneUnionFindDownloader:
    ...
    def __init__(self):
        # Get project root for papers directory
        current_file = Path(__file__)
        project_root = current_file.parent.parent  # scripts -> project root
        self.papers_dir = project_root / "backend" / "data" / "papers"
    ...
    async def _download_single_paper(
        self, paper: Dict[str, Any], arxiv_id: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "path": str(pdf_path), "metadata": metadata}
