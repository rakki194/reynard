...
get_project_root() {
    ...
    local fallback_root="$(dirname "$(dirname "$script_dir")")"
...
export BACKEND_DIR="$(get_backend_dir)"
export E2E_DIR="$(get_e2e_dir)"
export EXAMPLES_DIR="$(get_examples_dir)"
export SERVICES_DIR="$(get_services_dir)"
export SCRIPTS_DIR="$(get_scripts_dir)"
export EXPERIMENTAL_DIR="$(get_experimental_dir)"
export THIRD_PARTY_DIR="$(get_third_party_dir)"
