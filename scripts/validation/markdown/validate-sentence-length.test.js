...
describe("Sentence Length Validation", () => {
  ...
  describe("breakLineIntelligently", () => {
    it("should break at conjunctions with high priority", () => {
      const longLine =
        "This is a very long sentence that contains multiple clauses and should be broken at the conjunction because it makes the most sense for readability.";
    ...
    it("should break at commas when conjunctions are not available", () => {
      const longLine =
        "This is a long sentence, with multiple clauses, that should be broken at commas for better readability.";
    ...
    it("should break at prepositions when other options are not available", () => {
      const longLine =
        "This is a very long sentence that should be broken at prepositions for better readability in technical documentation.";
    ...
    it("should preserve indentation in continuation lines", () => {
      const indentedLine =
        "    This is a very long indented sentence that should be broken while preserving the original indentation.";
  ...
  describe("findOptimalBreakPoints", () => {
    it("should prioritize conjunctions over other break points", () => {
      const line =
        "This is a long sentence and it should be broken at the conjunction because that makes the most sense.";
  ...
  describe("Real-world examples from LLM Exploitation README", () => {
    ...
    it("should handle sentences with multiple conjunctions", () => {
      const multiConjunction =
        "These methods exploit the conversational and adaptive nature of LLMs, making it challenging to enforce static security controls, and effective mitigation demands dynamic context tracking and the deployment of advanced behavioral monitoring to detect and disrupt evolving jailbreak attempts.";
