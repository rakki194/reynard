...
from analyzers import PatternAnalyzer, SentimentAnalyzer, HexacoAnalyzer, EpistemicHumilityAnalyzer, LiwcAnalyzer
...
class TestPatternAnalyzer:
    ...
    def test_analyze_exaggeration(self, analyzer):
        ...
        # Check finding properties
        revolutionary_finding = next(f for f in findings if f.original_text.lower() == "revolutionary")
        assert revolutionary_finding.category == DetectionCategory.EXAGGERATION
        assert revolutionary_finding.severity in [SeverityLevel.HIGH, SeverityLevel.CRITICAL]
