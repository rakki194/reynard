...
from core.models import HumilityFinding, HumilityProfile, DetectionCategory, SeverityLevel, ConfidenceLevel
...
class TestMetricsCalculator:
    ...
    def test_calculate_detection_metrics(self, calculator):
        ...
        metrics = calculator.calculate_detection_metrics(true_findings, predicted_findings)
...
class TestReportGenerator:
    ...
    def test_generate_csv_report(self, generator, sample_profiles):
        ...
        assert "file_path,line_number,category,severity,original_text,suggested_replacement,overall_score" in lines[0]
