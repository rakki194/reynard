...
spec = importlib.util.spec_from_file_location("humility_detector", "humility-detector.py")
...
def test_main_function():
    ...
    with patch('argparse.ArgumentParser') as mock_parser:
        ...
        with patch('core.detector.HumilityDetector') as mock_detector_class:
            ...
            with patch('utils.report_generator.ReportGenerator') as mock_report_gen_class:
